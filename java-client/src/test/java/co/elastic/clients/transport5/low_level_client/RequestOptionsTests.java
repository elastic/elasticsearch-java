...
public class RequestOptionsTests extends RestClientTestCase {
    public void testDefault() {
        ...
        assertEquals(HttpAsyncResponseConsumerFactory.DEFAULT,
            RequestOptions.DEFAULT.getHttpAsyncResponseConsumerFactory());
    ...
    public void testAddHeader() {
        ...
        try {
            options.getHeaders()
                .add(new RequestOptions.ReqHeader(randomAsciiAlphanumOfLengthBetween(5, 10),
                    randomAsciiAlphanumOfLength(3)));
            fail("expected failure");
    ...
    public void testSetRequestBuilder() {
        ...
        assertEquals(options.getRequestConfig().getConnectionRequestTimeout(), Timeout.ofMilliseconds(socketTimeout));
    ...
    private static RequestOptions mutate(RequestOptions options) {
        ...
        switch (mutationType) {
            case 0:
                ...
                return mutant.build();
            case 1:
                mutant.setHttpAsyncResponseConsumerFactory(new HttpAsyncResponseConsumerFactory.BasicAsyncResponseConsumerFactory(5));
                return mutant.build();
            case 2:
