...
import org.elasticsearch.client.RequestOptionsTests;
...
public class RequestTests extends RestClientTestCase {
    ...
    private static Request randomRequest() {
        ...
        if (randomBoolean()) {
            ...
            options.setHttpAsyncResponseConsumerFactory(new HttpAsyncResponseConsumerFactory.BasicAsyncResponseConsumerFactory(1));
            request.setOptions(options);
        }
