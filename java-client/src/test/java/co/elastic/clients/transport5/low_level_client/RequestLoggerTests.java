...
import static org.elasticsearch.client.RestClientTestUtil.canHaveBody;
...
public class RequestLoggerTests extends RestClientTestCase {
    public void testTraceRequest() throws IOException, URISyntaxException, ParseException {
        ...
        boolean hasBody = canHaveBody((HttpUriRequestBase) request) && randomBoolean();
        ...
        if (hasBody) {
            ...
            switch (randomIntBetween(0, 4)) {
                ...
                case 1:
                    ...
                    break;
                case 3:
                    entity = new ByteArrayEntity(requestBody.getBytes(StandardCharsets.UTF_8),
                        ContentType.APPLICATION_JSON);
                    break;
                case 4:
                    // Evil entity without a charset
                    entity = new StringEntity(requestBody, ContentType.create("application/json",
                        (Charset) null));
                    break;
                default:
    ...
    public void testTraceResponse() throws IOException, ParseException {
        ...
        BasicClassicHttpResponse httpResponse = new BasicClassicHttpResponse(statusCode, reasonPhrase);
        ...
        if (hasBody) {
            ...
            switch (randomIntBetween(0, 2)) {
                ...
                case 2:
                    // Evil entity without a charset
                    entity = new StringEntity(responseBody, ContentType.create("application/json",
                        (Charset) null));
                    break;
                default:
                    throw new UnsupportedOperationException();
