...
/*
 * Integration test to check interaction between {@link RestClient} and {@link org.apache.hc.client5.http
...
public class RestClientSingleHostIntegTests extends RestClientTestCase {
    ...
    private RestClient createRestClient(final boolean useAuth, final boolean usePreemptiveAuth,
        ...
        final RestClientBuilder restClientBuilder =
            RestClient.builder(host).setDefaultHeaders(defaultHeaders);
        ...
        if (useAuth) {
            ...
            restClientBuilder.setCustomRestClient(httpclientBuilder.build());
        }
     ...
     * out of the box by {@link org.apache.hc.client5.http.impl.async.HttpAsyncClients}.
