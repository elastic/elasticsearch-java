...
import org.elasticsearch.client.RestClientSingleHostTests;
import org.elasticsearch.client.RestClientTestCase;
import org.elasticsearch.client.RestClientTestUtil;
import org.elasticsearch.client.consumer.BasicAsyncResponseConsumer;
import org.elasticsearch.client.consumer.BufferedByteConsumer;
...
/**
 * Integration test to check interaction between {@link RestClient} and {@link org.apache.hc.client5.http.async.HttpAsyncClient}.
...
public class RestClientMultipleHostsIntegTests extends RestClientTestCase {
    ...
    public void testAsyncRequests() throws Exception {
        ...
        for (TestResponse testResponse : responses) {
            ...
            assertEquals(testResponse.statusCode, response.getStatusCode());
    ...
    public void testNonRetryableException() throws Exception {
        ...
        options.setHttpAsyncResponseConsumerFactory(
            ...
            () -> new BasicAsyncResponseConsumer(new BufferedByteConsumer(10))
        );
