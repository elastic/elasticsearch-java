...
/**
 * Integration test to check interaction between {@link Rest5Client} and {@link org.apache.hc.client5.http.async.HttpAsyncClient}.
...
public class RestClientMultipleHostsIntegTests extends RestClientTestCase {
    ...
    private static Rest5Client buildRestClient(NodeSelector nodeSelector) {
        return buildRestClient(nodeSelector, null);
    }

    private static Rest5Client buildRestClient(NodeSelector nodeSelector, Rest5Client.FailureListener failureListener) {
    ...
    public void testNonRetryableException() throws Exception {
        ...
        Rest5Client client = buildRestClient(NodeSelector.ANY, new Rest5Client.FailureListener() {
            @Override
