...
public class ReadingTest extends ModelTestCase {
    ...
    public void getById() throws Exception {
        ...
        transport.setResult(GetResponse.of(r -> r
            ...
            .seqNo(0L)
            .primaryTerm(0L)
            .source(new co.elastic.clients.documentation.usage.Product("bk-1", "City Bike", 123.0))
        ));

        //tag::get-by-id
        GetResponse<co.elastic.clients.documentation.usage.Product> response = esClient.get(g -> g
            .index("products") // <1>
            .id("bk-1"),
            co.elastic.clients.documentation.usage.Product.class      // <2>
        );
