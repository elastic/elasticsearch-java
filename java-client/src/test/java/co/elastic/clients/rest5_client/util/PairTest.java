...
package clients.rest5_client.util;
...
class PairTest extends ModelTestCase {
    ...
    public void testCondition() {
        ...
        Condition c = Condition.of(b -> b
            .compare(NamedValue.of("foo", Pair.of(ConditionOp.Eq, FieldValue.of("bar"))))
        );

        c = checkJsonRoundtrip(c, json);
