...
package co.elastic.clients.rest5_client.elasticsearch.experiments.api;
...
public class FooRequest implements JsonpSerializable {
  ...
  private final co.elastic.clients.elasticsearch.experiments.api.Bar bar;

  @Nullable
  public co.elastic.clients.elasticsearch.experiments.api.Bar bar() {
    return this.bar;
  }
  ...
  public static class Builder implements ObjectBuilder<FooRequest> {
    ...
    protected co.elastic.clients.elasticsearch.experiments.api.Bar bar;
    ...
    public Builder bar(@Nullable co.elastic.clients.elasticsearch.experiments.api.Bar v) {
      bar = v;
      return this;
    }

    public Builder bar(Function<co.elastic.clients.elasticsearch.experiments.api.Bar.Builder, ObjectBuilder<co.elastic.clients.elasticsearch.experiments.api.Bar>> b) {
      return bar(b.apply(new co.elastic.clients.elasticsearch.experiments.api.Bar.Builder()).build());
    }
