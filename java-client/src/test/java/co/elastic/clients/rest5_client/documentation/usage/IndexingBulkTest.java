...
public class IndexingBulkTest extends ModelTestCase {
    ...
    private List<co.elastic.clients.documentation.usage.Product> fetchProducts() {
        List<co.elastic.clients.documentation.usage.Product> list = new ArrayList<>();
        list.add(new co.elastic.clients.documentation.usage.Product("bk-1", "City Bike", 123.0));
        list.add(new co.elastic.clients.documentation.usage.Product("bk-2", "Mountain Bike", 134.0));
        return list;
    }
    ...
    public void indexBulk() throws Exception {
        ...
        //tag::bulk-objects
        List<co.elastic.clients.documentation.usage.Product> products = fetchProducts();
