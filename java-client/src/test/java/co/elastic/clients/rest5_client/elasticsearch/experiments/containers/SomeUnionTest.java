...
import co.elastic.clients.elasticsearch.experiments.containers.SomeUnion;
import co.elastic.clients.elasticsearch.experiments.containers.UVariantA;
...
public class SomeUnionTest extends ModelTestCase {
    ...
    co.elastic.clients.elasticsearch.experiments.containers.SomeUnion su = new co.elastic.clients.elasticsearch.experiments.containers.SomeUnion.Builder()
        .variantA(a_ -> a_
            .name("a-name")
        ).build();
    ...
    public void testDeserialization() {
        co.elastic.clients.elasticsearch.experiments.containers.SomeUnion u = fromJson(json, co.elastic.clients.elasticsearch.experiments.containers.SomeUnion.class);
    ...
    public void testMissingVariantDeserialization() {
        ...
        JsonParsingException e = assertThrows(JsonParsingException.class, () -> {
            co.elastic.clients.elasticsearch.experiments.containers.SomeUnion c = SomeUnion._DESERIALIZER.deserialize(parser, new JsonbJsonpMapper());
        });
