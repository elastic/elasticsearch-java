...
public class IndexingTest extends ModelTestCase {
    ...
    public void singleDocumentDSL() throws Exception {
        ...
        //tag::single-doc-dsl
        co.elastic.clients.documentation.usage.Product product = new co.elastic.clients.documentation.usage.Product("bk-1", "City bike", 123.0);
    ...
    public void singleDocumentDSLwithOf() throws Exception {
        ...
        IndexRequest<co.elastic.clients.documentation.usage.Product> request = IndexRequest.of(i -> i
            .index("products")
            .id(product.getSku())
            .document(product)
        );
    ...
    public void singleDocumentBuilder() throws Exception {
        ...
        IndexRequest.Builder<co.elastic.clients.documentation.usage.Product> indexReqBuilder = new IndexRequest.Builder<>();
