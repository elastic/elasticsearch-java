...
public class FooOptRequest implements JsonpSerializable {
  ...
  @Nonnull
  public Optional<co.elastic.clients.elasticsearch.experiments.api.Bar> bar() {
  ...
  public static class Builder implements ObjectBuilder<FooOptRequest> {
    ...
    private co.elastic.clients.elasticsearch.experiments.api.Bar bar;
...
//  }
  ...
  public static final Endpoint<FooOptRequest, co.elastic.clients.elasticsearch.experiments.api.FooResponse, ErrorResponse> ENDPOINT =
    new SimpleEndpoint<FooOptRequest, co.elastic.clients.elasticsearch.experiments.api.FooResponse>(
      "foo",
      r -> "POST",
      r -> "/foo",
