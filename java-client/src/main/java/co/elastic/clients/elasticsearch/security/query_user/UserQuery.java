...
// typedef: security.query_user.UserQueryContainer

/**
 *
 * @see <a href=
 *      "../../doc-files/api-spec.html#security.query_user.UserQueryContainer">API
 *      specification</a>
 */
@JsonpDeserializable
public class UserQuery implements OpenTaggedUnion<UserQuery.Kind, Object>, JsonpSerializable {

	/**
	 * {@link UserQuery} variant kinds.
	 * 
	 * @see <a href=
	 *      "../../doc-files/api-spec.html#security.query_user.UserQueryContainer">API
	 *      specification</a>
	...
	public enum Kind implements JsonEnum {
		...
		/** A custom {@code UserQuery} defined by a plugin */
		_Custom(null)
	...
	public UserQuery(UserQueryVariant value) {

		this._kind = ApiTypeHelper.requireNonNull(value._userQueryKind(), this, "<variant kind>");
	...
	/**
	 * Is this a custom {@code UserQuery} defined by a plugin?
	 */
	...
	public static class Builder extends WithJsonObjectBuilderBase<Builder> implements ObjectBuilder<UserQuery> {
		private Kind _kind;
		...
		public ObjectBuilder<UserQuery> ids(IdsQuery v) {
			this._kind = Kind.Ids;
			this._value = v;
			return this;
		}

		public ObjectBuilder<UserQuery> ids(Function<IdsQuery.Builder, ObjectBuilder<IdsQuery>> fn) {
			return this.ids(fn.apply(new IdsQuery.Builder()).build());
		}

		public ObjectBuilder<UserQuery> bool(BoolQuery v) {
			this._kind = Kind.Bool;
			this._value = v;
			return this;
		}

		public ObjectBuilder<UserQuery> bool(Function<BoolQuery.Builder, ObjectBuilder<BoolQuery>> fn) {
			return this.bool(fn.apply(new BoolQuery.Builder()).build());
		}

		public ObjectBuilder<UserQuery> exists(ExistsQuery v) {
			this._kind = Kind.Exists;
			this._value = v;
			return this;
		}

		public ObjectBuilder<UserQuery> exists(Function<ExistsQuery.Builder, ObjectBuilder<ExistsQuery>> fn) {
			return this.exists(fn.apply(new ExistsQuery.Builder()).build());
		}

		public ObjectBuilder<UserQuery> match(MatchQuery v) {
			this._kind = Kind.Match;
			this._value = v;
			return this;
		}

		public ObjectBuilder<UserQuery> match(Function<MatchQuery.Builder, ObjectBuilder<MatchQuery>> fn) {
			return this.match(fn.apply(new MatchQuery.Builder()).build());
		}

		public ObjectBuilder<UserQuery> matchAll(MatchAllQuery v) {
			this._kind = Kind.MatchAll;
			this._value = v;
			return this;
		}

		public ObjectBuilder<UserQuery> matchAll(Function<MatchAllQuery.Builder, ObjectBuilder<MatchAllQuery>> fn) {
			return this.matchAll(fn.apply(new MatchAllQuery.Builder()).build());
		}

		public ObjectBuilder<UserQuery> prefix(PrefixQuery v) {
			this._kind = Kind.Prefix;
			this._value = v;
			return this;
		}

		public ObjectBuilder<UserQuery> prefix(Function<PrefixQuery.Builder, ObjectBuilder<PrefixQuery>> fn) {
			return this.prefix(fn.apply(new PrefixQuery.Builder()).build());
		}

		public ObjectBuilder<UserQuery> range(RangeQuery v) {
			this._kind = Kind.Range;
			this._value = v;
			return this;
		}

		public ObjectBuilder<UserQuery> range(Function<RangeQuery.Builder, ObjectBuilder<RangeQuery>> fn) {
			return this.range(fn.apply(new RangeQuery.Builder()).build());
		}

		public ObjectBuilder<UserQuery> simpleQueryString(SimpleQueryStringQuery v) {
			this._kind = Kind.SimpleQueryString;
			this._value = v;
			return this;
		}

		public ObjectBuilder<UserQuery> simpleQueryString(
		...
		public ObjectBuilder<UserQuery> term(TermQuery v) {
			this._kind = Kind.Term;
			this._value = v;
			return this;
		}

		public ObjectBuilder<UserQuery> term(Function<TermQuery.Builder, ObjectBuilder<TermQuery>> fn) {
			return this.term(fn.apply(new TermQuery.Builder()).build());
		}

		public ObjectBuilder<UserQuery> terms(TermsQuery v) {
			this._kind = Kind.Terms;
			this._value = v;
			return this;
		}

		public ObjectBuilder<UserQuery> terms(Function<TermsQuery.Builder, ObjectBuilder<TermsQuery>> fn) {
			return this.terms(fn.apply(new TermsQuery.Builder()).build());
		}

		public ObjectBuilder<UserQuery> wildcard(WildcardQuery v) {
			this._kind = Kind.Wildcard;
			this._value = v;
			return this;
		}

		public ObjectBuilder<UserQuery> wildcard(Function<WildcardQuery.Builder, ObjectBuilder<WildcardQuery>> fn) {
			return this.wildcard(fn.apply(new WildcardQuery.Builder()).build());
		}

		/**
		 * Define this {@code UserQuery} as a plugin-defined variant.
		 *
		 * @param name
		 *            the plugin-defined identifier
		 * @param data
		 *            the data for this custom {@code UserQuery}. It is converted
		 *            internally to {@link JsonData}.
		 */
		public ObjectBuilder<UserQuery> _custom(String name, Object data) {
	...
	protected static void setupUserQueryDeserializer(ObjectDeserializer<Builder> op) {
	...
	public static final JsonpDeserializer<UserQuery> _DESERIALIZER = ObjectBuilderDeserializer.lazy(Builder::new,
			UserQuery::setupUserQueryDeserializer, Builder::build);
}
