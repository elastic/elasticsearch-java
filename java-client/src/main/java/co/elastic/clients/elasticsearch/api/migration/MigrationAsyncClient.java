 ...
 */
public class MigrationAsyncClient extends ApiClient<MigrationAsyncClient> {

	public MigrationAsyncClient(Transport transport) {
		super(transport, null);
	}

	public MigrationAsyncClient(Transport transport, RequestOptions options) {
	...
	/**
	 * Creates a new {@link #MigrationAsyncClient} with specific request options.
	 */
	@Override
	public MigrationAsyncClient withRequestOptions(@Nullable RequestOptions options) {
		return new MigrationAsyncClient(transport, options);
	}
	 ...
	 */
	public MigrationAsyncClient withRequestOptions(Function<RequestOptions.Builder, RequestOptions.Builder> fn) {
