 ...
 */
public class SecurityApiClient extends ApiClient<SecurityApiClient> {

	public SecurityApiClient(Transport transport) {
		super(transport, null);
	}

	public SecurityApiClient(Transport transport, RequestOptions options) {
	...
	/**
	 * Creates a new {@link #SecurityApiClient} with specific request options.
	 */
	@Override
	public SecurityApiClient withRequestOptions(@Nullable RequestOptions options) {
		return new SecurityApiClient(transport, options);
	}
	 ...
	 */
	public SecurityApiClient withRequestOptions(Function<RequestOptions.Builder, RequestOptions.Builder> fn) {
