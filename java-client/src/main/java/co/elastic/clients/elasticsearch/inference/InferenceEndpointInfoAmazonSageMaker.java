...
// typedef: inference._types.InferenceEndpointInfoAmazonSageMaker

/**
 *
 * @see <a href=
 *      "../doc-files/api-spec.html#inference._types.InferenceEndpointInfoAmazonSageMaker">API
 *      specification</a>
 */

public abstract class InferenceEndpointInfoAmazonSageMaker extends InferenceEndpoint {
	...
	protected InferenceEndpointInfoAmazonSageMaker(AbstractBuilder<?> builder) {
		super(builder);
	...
	public abstract static class AbstractBuilder<BuilderT extends AbstractBuilder<BuilderT>>
		 ...
		 * API name: {@code task_type}
		 */
		public final BuilderT taskType(TaskTypeAmazonSageMaker value) {
			this.taskType = value;
			return self();
		}
	...
	// ---------------------------------------------------------------------------------------------
	protected static <BuilderT extends AbstractBuilder<BuilderT>> void setupInferenceEndpointInfoAmazonSageMakerDeserializer(
		...
		op.add(AbstractBuilder::taskType, TaskTypeAmazonSageMaker._DESERIALIZER, "task_type");
