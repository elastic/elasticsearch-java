...
// typedef: security.clone_api_key.Response

/**
 *
 * @see <a href="../doc-files/api-spec.html#security.clone_api_key.Response">API
 *      specification</a>
 */
@JsonpDeserializable
public class CloneApiKeyResponse implements JsonpSerializable {
	...
	private CloneApiKeyResponse(Builder builder) {
	...
	public static CloneApiKeyResponse of(Function<Builder, ObjectBuilder<CloneApiKeyResponse>> fn) {
	...
	/**
	 * Builder for {@link CloneApiKeyResponse}.
	 */

	public static class Builder extends WithJsonObjectBuilderBase<Builder>
			implements
				ObjectBuilder<CloneApiKeyResponse> {
		...
		/**
		 * Builds a {@link CloneApiKeyResponse}.
		 *
		 * @throws NullPointerException
		 *             if some of the required fields are null.
		 */
		public CloneApiKeyResponse build() {
			_checkSingleUse();

			return new CloneApiKeyResponse(this);
		}
	}
	...
	/**
	 * Json deserializer for {@link CloneApiKeyResponse}
	 */
	public static final JsonpDeserializer<CloneApiKeyResponse> _DESERIALIZER = ObjectBuilderDeserializer
			.lazy(Builder::new, CloneApiKeyResponse::setupCloneApiKeyResponseDeserializer);
