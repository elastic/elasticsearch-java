...
/**
 * Builders for {@link Operation} variants.
 */
public class OperationBuilders {
	...
	/**
	 * Creates a builder for the {@link IndexOperation index} {@code Operation}
	 * variant.
	 */
	...
	/**
	 * Creates a builder for the {@link CreateOperation create} {@code Operation}
	 * variant.
	 */
	...
	/**
	 * Creates a builder for the {@link UpdateOperation update} {@code Operation}
	 * variant.
	 */
	...
	/**
	 * Creates a builder for the {@link DeleteOperation delete} {@code Operation}
	 * variant.
	 */
