...
// typedef: _types.aggregations.CartesianCentroidAggregate

/**
 *
 * @see <a href=
 *      "../../doc-files/api-spec.html#_types.aggregations.CartesianCentroidAggregate">API
 *      specification</a>
 */
@JsonpDeserializable
public class CartesianCentroidAggregate extends AggregateBase implements AggregateVariant {
	...
	/**
	 * Builder for {@link CartesianCentroidAggregate}.
	 */

	public static class Builder extends AggregateBase.AbstractBuilder<Builder>
			implements
				ObjectBuilder<CartesianCentroidAggregate> {
		private Long count;
		...
		/**
		 * Builds a {@link CartesianCentroidAggregate}.
		 *
	...
	/**
	 * Json deserializer for {@link CartesianCentroidAggregate}
	 */
	public static final JsonpDeserializer<CartesianCentroidAggregate> _DESERIALIZER = ObjectBuilderDeserializer
			.lazy(Builder::new, CartesianCentroidAggregate::setupCartesianCentroidAggregateDeserializer);

	protected static void setupCartesianCentroidAggregateDeserializer(
			ObjectDeserializer<CartesianCentroidAggregate.Builder> op) {
