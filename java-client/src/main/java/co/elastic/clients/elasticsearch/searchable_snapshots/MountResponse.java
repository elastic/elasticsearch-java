...
public final class MountResponse implements ToJsonp {
	...
	/**
	 * Json parser for MountResponse
	 */
	public static final JsonpValueParser<MountResponse> JSONP_PARSER = JsonpObjectBuilderParser
			.createForObject(Builder::new, MountResponse::setupMountResponseParser);

	protected static void setupMountResponseParser(DelegatingJsonpValueParser<MountResponse.Builder> op) {

		op.add(Builder::snapshot, MountedSnapshot.JSONP_PARSER, "snapshot");
