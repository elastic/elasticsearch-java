 ...
 *
 * @see <a href=
 *      "../../doc-files/api-spec.html#_types.analysis.FinnishAnalyzer">API
 *      specification</a>
 */
@JsonpDeserializable
public class FinnishAnalyzer implements AnalyzerVariant, JsonpSerializable {
	...
	public static class Builder extends WithJsonObjectBuilderBase<Builder> implements ObjectBuilder<FinnishAnalyzer> {
		@Nullable
		...
		private Builder(FinnishAnalyzer instance) {
	 ...
	 */
	public static final JsonpDeserializer<FinnishAnalyzer> _DESERIALIZER = ObjectBuilderDeserializer.lazy(Builder::new,
			FinnishAnalyzer::setupFinnishAnalyzerDeserializer);

	protected static void setupFinnishAnalyzerDeserializer(ObjectDeserializer<FinnishAnalyzer.Builder> op) {
