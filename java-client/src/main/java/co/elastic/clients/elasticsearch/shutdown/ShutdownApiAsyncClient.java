 ...
 */
public class ShutdownApiAsyncClient extends ApiClient<ShutdownApiAsyncClient> {

	public ShutdownApiAsyncClient(Transport transport) {
		super(transport, null);
	}

	public ShutdownApiAsyncClient(Transport transport, RequestOptions options) {
	...
	/**
	 * Creates a new {@link #ShutdownApiAsyncClient} with specific request options.
	 */
	@Override
	public ShutdownApiAsyncClient withRequestOptions(@Nullable RequestOptions options) {
		return new ShutdownApiAsyncClient(transport, options);
	}
	 ...
	 */
	public ShutdownApiAsyncClient withRequestOptions(Function<RequestOptions.Builder, RequestOptions.Builder> fn) {
