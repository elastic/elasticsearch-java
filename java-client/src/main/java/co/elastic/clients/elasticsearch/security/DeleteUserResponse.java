 ...
 *
 * @see <a href=
 *      "https://github.com/elastic/elasticsearch-specification/tree/bd953a3fc/specification/security/delete_user/SecurityDeleteUserResponse.ts#L20-L22">API
 *      specification</a>
 */
@JsonpDeserializable
public class DeleteUserResponse implements JsonpSerializable {
	...
	public static final JsonpDeserializer<DeleteUserResponse> _DESERIALIZER = ObjectBuilderDeserializer
			.lazy(Builder::new, DeleteUserResponse::setupDeleteUserResponseDeserializer);
