 ...
 *
 * @see <a href=
 *      "../../doc-files/api-spec.html#indices.recovery.RecoveryStatus">API
 *      specification</a>
 */
@JsonpDeserializable
public class RecoveryStatus implements JsonpSerializable {
	...
	public static class Builder extends WithJsonObjectBuilderBase<Builder> implements ObjectBuilder<RecoveryStatus> {
