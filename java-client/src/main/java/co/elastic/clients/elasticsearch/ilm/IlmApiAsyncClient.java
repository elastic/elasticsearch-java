 ...
 */
public class IlmApiAsyncClient extends ApiClient<IlmApiAsyncClient> {

	public IlmApiAsyncClient(Transport transport) {
		super(transport, null);
	}

	public IlmApiAsyncClient(Transport transport, RequestOptions options) {
	...
	/**
	 * Creates a new {@link #IlmApiAsyncClient} with specific request options.
	 */
	@Override
	public IlmApiAsyncClient withRequestOptions(@Nullable RequestOptions options) {
		return new IlmApiAsyncClient(transport, options);
	}
	 ...
	 */
	public IlmApiAsyncClient withRequestOptions(Function<RequestOptions.Builder, RequestOptions.Builder> fn) {
