...
// typedef: inference.put_cohere.CohereTaskSettings

/**
 *
 * @see <a href=
 *      "../../doc-files/api-spec.html#inference.put_cohere.CohereTaskSettings">API
 *      specification</a>
 */
@JsonpDeserializable
public class CohereTaskSettings implements JsonpSerializable {
	...
	@Nullable
	private final TruncateType truncate;
	 ...
	 */
	@Nullable
	public final TruncateType truncate() {
	...
	public static class Builder extends WithJsonObjectBuilderBase<Builder>
		 ...
		 * API name: {@code input_type}
		 */
		public final Builder inputType(@Nullable InputType value) {
		 ...
		 * API name: {@code truncate}
		 */
		public final Builder truncate(@Nullable TruncateType value) {
			this.truncate = value;
			return this;
		}
	...
	protected static void setupCohereTaskSettingsDeserializer(ObjectDeserializer<CohereTaskSettings.Builder> op) {
		...
		op.add(Builder::inputType, InputType._DESERIALIZER, "input_type");
		...
		op.add(Builder::truncate, TruncateType._DESERIALIZER, "truncate");
