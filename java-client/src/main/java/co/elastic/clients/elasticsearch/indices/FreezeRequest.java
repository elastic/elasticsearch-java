...
public class FreezeRequest extends RequestBase {
	@Nullable
	...
	private FreezeRequest(Builder builder) {
	...
	public static FreezeRequest of(Function<Builder, ObjectBuilder<FreezeRequest>> fn) {
