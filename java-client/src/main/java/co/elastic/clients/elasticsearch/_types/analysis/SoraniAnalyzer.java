 ...
 *
 * @see <a href=
 *      "../../doc-files/api-spec.html#_types.analysis.SoraniAnalyzer">API
 *      specification</a>
 */
@JsonpDeserializable
public class SoraniAnalyzer implements AnalyzerVariant, JsonpSerializable {
	...
	public static class Builder extends WithJsonObjectBuilderBase<Builder> implements ObjectBuilder<SoraniAnalyzer> {
		@Nullable
		...
		private Builder(SoraniAnalyzer instance) {
	 ...
	 */
	public static final JsonpDeserializer<SoraniAnalyzer> _DESERIALIZER = ObjectBuilderDeserializer.lazy(Builder::new,
			SoraniAnalyzer::setupSoraniAnalyzerDeserializer);

	protected static void setupSoraniAnalyzerDeserializer(ObjectDeserializer<SoraniAnalyzer.Builder> op) {
