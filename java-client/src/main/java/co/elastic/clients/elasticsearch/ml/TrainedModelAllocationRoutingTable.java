 ...
 *
 * @see <a href=
 *      "https://github.com/elastic/elasticsearch-specification/tree/bd953a3fc/specification/ml/_types/TrainedModel.ts#L211-L221">API
 *      specification</a>
 */
@JsonpDeserializable
public class TrainedModelAllocationRoutingTable implements JsonpSerializable {
	...
	public static class Builder extends ObjectBuilderBase implements ObjectBuilder<TrainedModelAllocationRoutingTable> {
