...
public final class PutFilterResponse implements ToJsonp {
	...
	protected PutFilterResponse(Builder builder) {
	...
	/**
	 * Json parser for PutFilterResponse
	 */
	public static final JsonpValueParser<PutFilterResponse> JSONP_PARSER = JsonpObjectBuilderParser
			.createForObject(Builder::new, PutFilterResponse::setupPutFilterResponseParser);

	protected static void setupPutFilterResponseParser(DelegatingJsonpValueParser<PutFilterResponse.Builder> op) {
