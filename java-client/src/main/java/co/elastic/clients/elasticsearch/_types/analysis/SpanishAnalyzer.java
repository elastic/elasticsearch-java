 ...
 *
 * @see <a href=
 *      "../../doc-files/api-spec.html#_types.analysis.SpanishAnalyzer">API
 *      specification</a>
 */
@JsonpDeserializable
public class SpanishAnalyzer implements AnalyzerVariant, JsonpSerializable {
	...
	public static class Builder extends WithJsonObjectBuilderBase<Builder> implements ObjectBuilder<SpanishAnalyzer> {
		@Nullable
		...
		private Builder(SpanishAnalyzer instance) {
	 ...
	 */
	public static final JsonpDeserializer<SpanishAnalyzer> _DESERIALIZER = ObjectBuilderDeserializer.lazy(Builder::new,
			SpanishAnalyzer::setupSpanishAnalyzerDeserializer);

	protected static void setupSpanishAnalyzerDeserializer(ObjectDeserializer<SpanishAnalyzer.Builder> op) {
