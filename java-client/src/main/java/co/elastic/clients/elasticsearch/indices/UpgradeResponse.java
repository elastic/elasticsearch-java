...
public final class UpgradeResponse implements ToJsonp {
	...
	/**
	 * Json parser for UpgradeResponse
	 */
	public static final JsonpValueParser<UpgradeResponse> JSONP_PARSER = JsonpObjectBuilderParser
			.createForObject(Builder::new, UpgradeResponse::setupUpgradeResponseParser);

	protected static void setupUpgradeResponseParser(DelegatingJsonpValueParser<UpgradeResponse.Builder> op) {
