...
public final class TrainedModelConfigInput implements ToJsonp {
	...
	/**
	 * Json parser for TrainedModelConfigInput
	 */
	public static final JsonpValueParser<TrainedModelConfigInput> JSONP_PARSER = JsonpObjectBuilderParser
			.createForObject(Builder::new, TrainedModelConfigInput::setupTrainedModelConfigInputParser);

	protected static void setupTrainedModelConfigInputParser(
			DelegatingJsonpValueParser<TrainedModelConfigInput.Builder> op) {

		op.add(Builder::fieldNames, JsonpValueParser.arrayParser(JsonpValueParser.stringParser()), "field_names");
