 ...
 */
public class IngestApiAsyncClient extends ApiClient<IngestApiAsyncClient> {

	public IngestApiAsyncClient(Transport transport) {
		super(transport, null);
	}

	public IngestApiAsyncClient(Transport transport, RequestOptions options) {
	...
	/**
	 * Creates a new {@link #IngestApiAsyncClient} with specific request options.
	 */
	@Override
	public IngestApiAsyncClient withRequestOptions(@Nullable RequestOptions options) {
		return new IngestApiAsyncClient(transport, options);
	}
	 ...
	 */
	public IngestApiAsyncClient withRequestOptions(Function<RequestOptions.Builder, RequestOptions.Builder> fn) {
