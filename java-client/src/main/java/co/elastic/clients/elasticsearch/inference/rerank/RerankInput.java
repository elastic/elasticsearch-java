...
// typedef: inference.rerank.RerankInput

/**
 * The documents to rank for the <code>rerank</code> task. Either a string, an
 * array of strings, an object, or an array of objects. The object form
 * additionally allows specifying non-text inputs, such as images. <blockquote>
 * <p>
 * info Only the <code>elastic</code> service currently supports non-text inputs
 * for the <code>rerank</code> task.
 * </p>
 * </blockquote>
 *
 * @see <a href="../../doc-files/api-spec.html#inference.rerank.RerankInput">API
 *      specification</a>
 */
@JsonpDeserializable
public class RerankInput implements TaggedUnion<RerankInput.Kind, Object>, JsonpSerializable {
	...
	private RerankInput(Kind kind, Object value) {
		this._kind = kind;
		this._value = value;
	}

	private RerankInput(Builder builder) {
	...
	public static RerankInput of(Function<Builder, ObjectBuilder<RerankInput>> fn) {
	 ...
	 */
	public List<RerankInputObject> object() {
		...
		if (_value instanceof JsonpSerializable) {
			...
			switch (_kind) {
				case Object :
					...
					for (RerankInputObject item0 : ((List<RerankInputObject>) this._value)) {
	...
	public static class Builder extends ObjectBuilderBase implements ObjectBuilder<RerankInput> {
		private Kind _kind;
		private Object _value;

		public ObjectBuilder<RerankInput> object(List<RerankInputObject> v) {
			this._kind = Kind.Object;
			this._value = v;
			return this;
		}

		public ObjectBuilder<RerankInput> string(List<String> v) {
			this._kind = Kind.String;
			this._value = v;
			return this;
		}

		public RerankInput build() {
			_checkSingleUse();
			return new RerankInput(this);
		}
	...
	public static final JsonpDeserializer<RerankInput> _DESERIALIZER = JsonpDeserializer
