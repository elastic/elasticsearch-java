...
public final class FlushSyncedRequest extends RequestBase {
	...
	protected FlushSyncedRequest(Builder builder) {
	 ...
	 */
	public static final Endpoint<FlushSyncedRequest, FlushSyncedResponse, ElasticsearchError> ENDPOINT = new Endpoint.Simple<>(
			// Request method
			request -> {
				return "POST";
			...
			}, Endpoint.Simple.emptyMap(), false, FlushSyncedResponse.DESERIALIZER);
}
