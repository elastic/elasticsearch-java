...
// typedef: inference.put_deepseek.Request
 ...
 * 
 * @see <a href="../doc-files/api-spec.html#inference.put_deepseek.Request">API
 *      specification</a>
 */
@JsonpDeserializable
public class PutDeepseekRequest extends RequestBase implements JsonpSerializable {
	 ...
	 * <p>
	 * API name: {@code deepseek_inference_id}
	 */
	 ...
	 * specific to the <code>deepseek</code> service.
	 * <p>
	...
	/**
	 * Builder for {@link PutDeepseekRequest}.
	 */
	...
	public static class Builder extends RequestBase.AbstractBuilder<Builder>
		...
		public final Builder serviceSettings(
				Function<DeepSeekServiceSettings.Builder, ObjectBuilder<DeepSeekServiceSettings>> fn) {
		...
		/**
		 * Builds a {@link PutDeepseekRequest}.
		 *
	...
	/**
	 * Json deserializer for {@link PutDeepseekRequest}
	 */
	public static final JsonpDeserializer<PutDeepseekRequest> _DESERIALIZER = ObjectBuilderDeserializer
			.lazy(Builder::new, PutDeepseekRequest::setupPutDeepseekRequestDeserializer);
	...
	/**
	 * Endpoint "{@code inference.put_deepseek}".
	 */
	public static final Endpoint<PutDeepseekRequest, PutDeepseekResponse, ErrorResponse> _ENDPOINT = new SimpleEndpoint<>(
			"es/inference.put_deepseek",
			...
			// Request path
			request -> {
				final int _deepseekInferenceId = 1 << 0;
				final int _taskType = 1 << 1;

				int propsSet = 0;

				propsSet |= _deepseekInferenceId;
				propsSet |= _taskType;

				if (propsSet == (_taskType | _deepseekInferenceId)) {
