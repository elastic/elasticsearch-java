...
public class IlmIndicatorDetails implements JsonpSerializable {
	...
	private IlmIndicatorDetails(Builder builder) {
		...
		this.ilmStatus = ApiTypeHelper.requireNonNullWithDefault(builder.ilmStatus, this, "ilmStatus",
				this.ilmStatus());
		this.policies = ApiTypeHelper.requireNonNullWithDefault(builder.policies, this, "policies", this.policies());
		this.stagnatingIndices = ApiTypeHelper.requireNonNullWithDefault(builder.stagnatingIndices, this,
				"stagnatingIndices", this.stagnatingIndices());
