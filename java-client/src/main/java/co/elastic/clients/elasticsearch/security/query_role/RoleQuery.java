 ...
 *
 * @see <a href=
 *      "../../doc-files/api-spec.html#security.query_role.RoleQueryContainer">API
 *      specification</a>
 */
@JsonpDeserializable
public class RoleQuery implements OpenTaggedUnion<RoleQuery.Kind, Object>, JsonpSerializable {
	...
	public static class Builder extends WithJsonObjectBuilderBase<Builder> implements ObjectBuilder<RoleQuery> {
		...
		public ObjectBuilder<RoleQuery> simpleQueryString(
	...
	public static final JsonpDeserializer<RoleQuery> _DESERIALIZER = ObjectBuilderDeserializer.lazy(Builder::new,
