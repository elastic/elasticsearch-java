 ...
 * 
 * @see <a href=
 *      "https://github.com/elastic/elasticsearch-specification/tree/bd953a3fc/specification/watcher/start/WatcherStartRequest.ts#L22-L27">API
 *      specification</a>
 */
...
public class StartWatcherRequest extends RequestBase {
	...
	/**
	 * Singleton instance for {@link StartWatcherRequest}.
	 */
	public static final StartWatcherRequest _INSTANCE = new StartWatcherRequest();
