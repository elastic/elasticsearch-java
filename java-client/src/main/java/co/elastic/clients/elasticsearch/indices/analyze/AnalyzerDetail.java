...
public final class AnalyzerDetail implements ToJsonp {
	...
	/**
	 * Json parser for AnalyzerDetail
	 */
	public static final JsonpValueParser<AnalyzerDetail> JSONP_PARSER = JsonpObjectBuilderParser
			.createForObject(Builder::new, AnalyzerDetail::setupAnalyzerDetailParser);

	protected static void setupAnalyzerDetailParser(DelegatingJsonpValueParser<AnalyzerDetail.Builder> op) {
