...
public class ElasticsearchEsqlClient extends ApiClient<ElasticsearchTransport, ElasticsearchEsqlClient> {
	 ...
	 * 
	 * @see <a href=
	 *      "https://www.elastic.co/docs/api/doc/elasticsearch/v9/operation-esql-get-query">Documentation
	 *      on elastic.co</a>
	 */
	 ...
	 * 
	 * @see <a href=
	 *      "https://www.elastic.co/docs/api/doc/elasticsearch/v9/operation-esql-list-queries">Documentation
	 *      on elastic.co</a>
	 */
