...
public final class PhraseSuggestHighlight implements ToJsonp {
	...
	/**
	 * Json parser for PhraseSuggestHighlight
	 */
	public static final JsonpValueParser<PhraseSuggestHighlight> JSONP_PARSER = JsonpObjectBuilderParser
			.createForObject(Builder::new, PhraseSuggestHighlight::setupPhraseSuggestHighlightParser);

	protected static void setupPhraseSuggestHighlightParser(
			DelegatingJsonpValueParser<PhraseSuggestHighlight.Builder> op) {

		op.add(Builder::postTag, JsonpValueParser.stringParser(), "post_tag");
		op.add(Builder::preTag, JsonpValueParser.stringParser(), "pre_tag");
