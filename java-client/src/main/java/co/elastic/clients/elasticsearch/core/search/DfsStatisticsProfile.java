...
// typedef: _global.search._types.DfsStatisticsProfile

/**
 *
 * @see <a href=
 *      "../../doc-files/api-spec.html#_global.search._types.DfsStatisticsProfile">API
 *      specification</a>
 */
@JsonpDeserializable
public class DfsStatisticsProfile implements JsonpSerializable {
	...
	private final DfsStatisticsBreakdown breakdown;

	private final Map<String, JsonData> debug;

	private final List<DfsStatisticsProfile> children;

	// ---------------------------------------------------------------------------------------------

	private DfsStatisticsProfile(Builder builder) {
	...
	public static DfsStatisticsProfile of(Function<Builder, ObjectBuilder<DfsStatisticsProfile>> fn) {
	 ...
	 */
	public final DfsStatisticsBreakdown breakdown() {
	 ...
	 */
	public final List<DfsStatisticsProfile> children() {
	...
	protected void serializeInternal(JsonGenerator generator, JsonpMapper mapper) {
		...
		if (ApiTypeHelper.isDefined(this.children)) {
			...
			for (DfsStatisticsProfile item0 : this.children) {
	...
	/**
	 * Builder for {@link DfsStatisticsProfile}.
	 */
	...
	public static class Builder extends WithJsonObjectBuilderBase<Builder>
		...
		private DfsStatisticsBreakdown breakdown;

		@Nullable
		private Map<String, JsonData> debug;

		@Nullable
		private List<DfsStatisticsProfile> children;

		public Builder() {
		}
		private Builder(DfsStatisticsProfile instance) {
		 ...
		 * Required - API name: {@code breakdown}
		 */
		public final Builder breakdown(DfsStatisticsBreakdown value) {
		...
		public final Builder breakdown(
				Function<DfsStatisticsBreakdown.Builder, ObjectBuilder<DfsStatisticsBreakdown>> fn) {
			return this.breakdown(fn.apply(new DfsStatisticsBreakdown.Builder()).build());
		}
		 ...
		 */
		public final Builder children(List<DfsStatisticsProfile> list) {
		 ...
		 */
		public final Builder children(DfsStatisticsProfile value, DfsStatisticsProfile... values) {
		 ...
		 */
		public final Builder children(Function<DfsStatisticsProfile.Builder, ObjectBuilder<DfsStatisticsProfile>> fn) {
			return children(fn.apply(new DfsStatisticsProfile.Builder()).build());
		}
		...
		/**
		 * Builds a {@link DfsStatisticsProfile}.
		 *
		 * @throws NullPointerException
		 *             if some of the required fields are null.
		 */
		public DfsStatisticsProfile build() {
			_checkSingleUse();

			return new DfsStatisticsProfile(this);
		}
	}
	...
	/**
	 * Json deserializer for {@link DfsStatisticsProfile}
	 */
	public static final JsonpDeserializer<DfsStatisticsProfile> _DESERIALIZER = ObjectBuilderDeserializer
			.lazy(Builder::new, DfsStatisticsProfile::setupDfsStatisticsProfileDeserializer);
	...
	protected static void setupDfsStatisticsProfileDeserializer(ObjectDeserializer<DfsStatisticsProfile.Builder> op) {
		...
		op.add(Builder::breakdown, DfsStatisticsBreakdown._DESERIALIZER, "breakdown");
		op.add(Builder::debug, JsonpDeserializer.stringMapDeserializer(JsonData._DESERIALIZER), "debug");
		op.add(Builder::children, JsonpDeserializer.arrayDeserializer(DfsStatisticsProfile._DESERIALIZER), "children");
