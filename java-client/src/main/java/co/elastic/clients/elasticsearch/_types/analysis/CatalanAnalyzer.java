 ...
 *
 * @see <a href=
 *      "../../doc-files/api-spec.html#_types.analysis.CatalanAnalyzer">API
 *      specification</a>
 */
@JsonpDeserializable
public class CatalanAnalyzer implements AnalyzerVariant, JsonpSerializable {
	...
	public static class Builder extends WithJsonObjectBuilderBase<Builder> implements ObjectBuilder<CatalanAnalyzer> {
		@Nullable
		...
		private Builder(CatalanAnalyzer instance) {
	 ...
	 */
	public static final JsonpDeserializer<CatalanAnalyzer> _DESERIALIZER = ObjectBuilderDeserializer.lazy(Builder::new,
			CatalanAnalyzer::setupCatalanAnalyzerDeserializer);

	protected static void setupCatalanAnalyzerDeserializer(ObjectDeserializer<CatalanAnalyzer.Builder> op) {
