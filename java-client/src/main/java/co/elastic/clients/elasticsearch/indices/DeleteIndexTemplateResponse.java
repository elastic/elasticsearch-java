...
public final class DeleteIndexTemplateResponse extends AcknowledgedResponseBase {
	...
	/**
	 * Json parser for DeleteIndexTemplateResponse
	 */
	public static final JsonpValueParser<DeleteIndexTemplateResponse> JSONP_PARSER = JsonpObjectBuilderParser
			.createForObject(Builder::new, DeleteIndexTemplateResponse::setupDeleteIndexTemplateResponseParser);

	protected static void setupDeleteIndexTemplateResponseParser(
			DelegatingJsonpValueParser<DeleteIndexTemplateResponse.Builder> op) {
