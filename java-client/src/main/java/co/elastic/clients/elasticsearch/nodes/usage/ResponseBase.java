...
/**
 *
 * @see <a href="../../doc-files/api-spec.html#nodes.usage.ResponseBase">API
 *      specification</a>
 */
...
public abstract class ResponseBase extends NodesResponseBase {
	...
	public abstract static class AbstractBuilder<BuilderT extends AbstractBuilder<BuilderT>>
		 ...
		 */
		public final BuilderT nodes(Map<String, NodeUsage> map) {
		 ...
		 */
		public final BuilderT nodes(String key, NodeUsage value) {
		 ...
		 */
		public final BuilderT nodes(String key, Function<NodeUsage.Builder, ObjectBuilder<NodeUsage>> fn) {
	...
	protected static <BuilderT extends AbstractBuilder<BuilderT>> void setupResponseBaseDeserializer(
		...
		op.add(AbstractBuilder::nodes, JsonpDeserializer.stringMapDeserializer(NodeUsage._DESERIALIZER), "nodes");
