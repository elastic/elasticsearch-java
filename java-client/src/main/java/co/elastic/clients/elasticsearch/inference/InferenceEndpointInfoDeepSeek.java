...
// typedef: inference._types.InferenceEndpointInfoDeepSeek

/**
 *
 * @see <a href=
 *      "../doc-files/api-spec.html#inference._types.InferenceEndpointInfoDeepSeek">API
 *      specification</a>
 */

public abstract class InferenceEndpointInfoDeepSeek extends InferenceEndpoint {
	...
	protected InferenceEndpointInfoDeepSeek(AbstractBuilder<?> builder) {
		super(builder);
	...
	// ---------------------------------------------------------------------------------------------
	protected static <BuilderT extends AbstractBuilder<BuilderT>> void setupInferenceEndpointInfoDeepSeekDeserializer(
		...
		op.add(AbstractBuilder::taskType, TaskTypeDeepSeek._DESERIALIZER, "task_type");
