 ...
 *
 * @see <a href=
 *      "../../doc-files/api-spec.html#_types.analysis.RomanianAnalyzer">API
 *      specification</a>
 */
@JsonpDeserializable
public class RomanianAnalyzer implements AnalyzerVariant, JsonpSerializable {
	...
	public static class Builder extends WithJsonObjectBuilderBase<Builder> implements ObjectBuilder<RomanianAnalyzer> {
		@Nullable
		...
		private Builder(RomanianAnalyzer instance) {
	 ...
	 */
	public static final JsonpDeserializer<RomanianAnalyzer> _DESERIALIZER = ObjectBuilderDeserializer.lazy(Builder::new,
			RomanianAnalyzer::setupRomanianAnalyzerDeserializer);

	protected static void setupRomanianAnalyzerDeserializer(ObjectDeserializer<RomanianAnalyzer.Builder> op) {
