...
// typedef: snapshot._types.SourceOnlyRepositorySettingsForReadOnlyUrl

/**
 *
 * @see <a href=
 *      "../doc-files/api-spec.html#snapshot._types.SourceOnlyRepositorySettingsForReadOnlyUrl">API
 *      specification</a>
 */
@JsonpDeserializable
public class SourceOnlyRepositorySettingsForReadOnlyUrl
	...
	private SourceOnlyRepositorySettingsForReadOnlyUrl(Builder builder) {
	...
	public static SourceOnlyRepositorySettingsForReadOnlyUrl of(
			Function<Builder, ObjectBuilder<SourceOnlyRepositorySettingsForReadOnlyUrl>> fn) {
	...
	public SourceOnlyRepositorySettings.Kind _sourceOnlyRepositorySettingsKind() {
		return SourceOnlyRepositorySettings.Kind.Url;
	}
	...
	protected void serializeInternal(JsonGenerator generator, JsonpMapper mapper) {
		...
		generator.write("delegate_type", "url");
	...
	/**
	 * Builder for {@link SourceOnlyRepositorySettingsForReadOnlyUrl}.
	 */

	public static class Builder extends WithJsonObjectBuilderBase<Builder>
			implements
				ObjectBuilder<SourceOnlyRepositorySettingsForReadOnlyUrl> {
		@Nullable
		...
		private Builder(SourceOnlyRepositorySettingsForReadOnlyUrl instance) {
		...
		/**
		 * Builds a {@link SourceOnlyRepositorySettingsForReadOnlyUrl}.
		 *
		 * @throws NullPointerException
		 *             if some of the required fields are null.
		 */
		public SourceOnlyRepositorySettingsForReadOnlyUrl build() {
			_checkSingleUse();

			return new SourceOnlyRepositorySettingsForReadOnlyUrl(this);
		}
	}
	...
	/**
	 * Json deserializer for {@link SourceOnlyRepositorySettingsForReadOnlyUrl}
	 */
	public static final JsonpDeserializer<SourceOnlyRepositorySettingsForReadOnlyUrl> _DESERIALIZER = ObjectBuilderDeserializer
			.lazy(Builder::new,
					SourceOnlyRepositorySettingsForReadOnlyUrl::setupSourceOnlyRepositorySettingsForReadOnlyUrlDeserializer);

	protected static void setupSourceOnlyRepositorySettingsForReadOnlyUrlDeserializer(
			ObjectDeserializer<SourceOnlyRepositorySettingsForReadOnlyUrl.Builder> op) {
