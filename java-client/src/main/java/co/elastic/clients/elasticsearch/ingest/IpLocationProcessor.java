...
// typedef: ingest._types.IpLocationProcessor

/**
 *
 * @see <a href=
 *      "../doc-files/api-spec.html#ingest._types.IpLocationProcessor">API
 *      specification</a>
 */
@JsonpDeserializable
public class IpLocationProcessor extends ProcessorBase implements ProcessorVariant {
	@Nullable
	...
	private IpLocationProcessor(Builder builder) {
		super(builder);
	...
	public static IpLocationProcessor of(Function<Builder, ObjectBuilder<IpLocationProcessor>> fn) {
	...
	public Processor.Kind _processorKind() {
		return Processor.Kind.IpLocation;
	}
	...
	/**
	 * If <code>true</code>, only the first found IP location data will be returned,
	...
	/**
	 * Builder for {@link IpLocationProcessor}.
	 */
	...
	public static class Builder extends ProcessorBase.AbstractBuilder<Builder>
		...
		/**
		 * Builds a {@link IpLocationProcessor}.
		 *
		...
		public IpLocationProcessor build() {
			...
			return new IpLocationProcessor(this);
		}
	}
	...
	/**
	 * Json deserializer for {@link IpLocationProcessor}
	 */
	public static final JsonpDeserializer<IpLocationProcessor> _DESERIALIZER = ObjectBuilderDeserializer
			.lazy(Builder::new, IpLocationProcessor::setupIpLocationProcessorDeserializer);
