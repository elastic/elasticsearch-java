...
public final class CloseShardResult implements ToJsonp {
	...
	/**
	 * Json parser for CloseShardResult
	 */
	public static final JsonpValueParser<CloseShardResult> JSONP_PARSER = JsonpObjectBuilderParser
			.createForObject(Builder::new, CloseShardResult::setupCloseShardResultParser);

	protected static void setupCloseShardResultParser(DelegatingJsonpValueParser<CloseShardResult.Builder> op) {
