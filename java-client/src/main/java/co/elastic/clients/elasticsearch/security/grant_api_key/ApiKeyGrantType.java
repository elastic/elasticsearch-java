 ...
 *
 * @see <a href=
 *      "https://github.com/elastic/elasticsearch-specification/tree/bd953a3fc/specification/security/grant_api_key/types.ts#L31-L34">API
 *      specification</a>
 */
@JsonpDeserializable
public enum ApiKeyGrantType implements JsonEnum {
	...
	ApiKeyGrantType(String jsonValue) {
