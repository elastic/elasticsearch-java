 ...
 *
 * @see <a href=
 *      "../../doc-files/api-spec.html#_types.analysis.WordDelimiterTokenFilter">API
 *      specification</a>
 */
@JsonpDeserializable
public class WordDelimiterTokenFilter extends WordDelimiterTokenFilterBase implements TokenFilterDefinitionVariant {
	// ---------------------------------------------------------------------------------------------
