...
public final class DataframeAnalyticsStatsOutlierDetection implements ToJsonp {
	...
	/**
	 * Json parser for DataframeAnalyticsStatsOutlierDetection
	 */
	public static final JsonpValueParser<DataframeAnalyticsStatsOutlierDetection> JSONP_PARSER = JsonpObjectBuilderParser
			.createForObject(Builder::new,
					DataframeAnalyticsStatsOutlierDetection::setupDataframeAnalyticsStatsOutlierDetectionParser);

	protected static void setupDataframeAnalyticsStatsOutlierDetectionParser(
			DelegatingJsonpValueParser<DataframeAnalyticsStatsOutlierDetection.Builder> op) {

		op.add(Builder::parameters, OutlierDetectionParameters.JSONP_PARSER, "parameters");
