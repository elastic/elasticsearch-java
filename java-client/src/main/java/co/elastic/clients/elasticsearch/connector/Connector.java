...
public class Connector implements JsonpSerializable {
	...
	public abstract static class AbstractBuilder<BuilderT extends AbstractBuilder<BuilderT>>
		 ...
		 */
		public final BuilderT syncCursor(Map<String, JsonData> map) {
		 ...
		 */
		public final BuilderT syncCursor(String key, JsonData value) {
	...
	protected static <BuilderT extends AbstractBuilder<BuilderT>> void setupConnectorDeserializer(
		...
		op.add(AbstractBuilder::syncCursor, JsonpDeserializer.stringMapDeserializer(JsonData._DESERIALIZER),
				"sync_cursor");
