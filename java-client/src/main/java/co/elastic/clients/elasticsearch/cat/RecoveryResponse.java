...
public class RecoveryResponse implements JsonpSerializable {
	...
	public static class Builder extends ObjectBuilderBase implements ObjectBuilder<RecoveryResponse> {
		...
		public final Builder valueBody(
				Function<ListBuilder<RecoveryRecord, RecoveryRecord.Builder>, ObjectBuilder<List<RecoveryRecord>>> fn) {
			return valueBody(fn.apply(new ListBuilder<>(RecoveryRecord.Builder::new)).build());
		}
