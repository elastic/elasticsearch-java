 ...
 *
 * @see <a href=
 *      "../../doc-files/api-spec.html#_types.analysis.EstonianAnalyzer">API
 *      specification</a>
 */
@JsonpDeserializable
public class EstonianAnalyzer implements AnalyzerVariant, JsonpSerializable {
	...
	public static class Builder extends WithJsonObjectBuilderBase<Builder> implements ObjectBuilder<EstonianAnalyzer> {
		@Nullable
		...
		private Builder(EstonianAnalyzer instance) {
	 ...
	 */
	public static final JsonpDeserializer<EstonianAnalyzer> _DESERIALIZER = ObjectBuilderDeserializer.lazy(Builder::new,
			EstonianAnalyzer::setupEstonianAnalyzerDeserializer);

	protected static void setupEstonianAnalyzerDeserializer(ObjectDeserializer<EstonianAnalyzer.Builder> op) {
