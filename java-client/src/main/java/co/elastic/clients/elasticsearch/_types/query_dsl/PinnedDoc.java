...
@JsonpDeserializable
public final class PinnedDoc implements JsonpSerializable {
	...
	public PinnedDoc(Builder builder) {
	...
	public PinnedDoc(Function<Builder, Builder> fn) {
	 ...
	 */
	public static class Builder implements ObjectBuilder<PinnedDoc> {
		private String id;
