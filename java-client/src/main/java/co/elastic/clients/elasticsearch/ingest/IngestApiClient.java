 ...
 */
public class IngestApiClient extends ApiClient<IngestApiClient> {

	public IngestApiClient(Transport transport) {
		super(transport, null);
	}

	public IngestApiClient(Transport transport, RequestOptions options) {
	...
	/**
	 * Creates a new {@link #IngestApiClient} with specific request options.
	 */
	@Override
	public IngestApiClient withRequestOptions(@Nullable RequestOptions options) {
		return new IngestApiClient(transport, options);
	}
	 ...
	 */
	public IngestApiClient withRequestOptions(Function<RequestOptions.Builder, RequestOptions.Builder> fn) {
