 ...
 */
public class SecurityApiAsyncClient extends ApiClient<SecurityApiAsyncClient> {

	public SecurityApiAsyncClient(Transport transport) {
		super(transport, null);
	}

	public SecurityApiAsyncClient(Transport transport, RequestOptions options) {
	...
	/**
	 * Creates a new {@link #SecurityApiAsyncClient} with specific request options.
	 */
	@Override
	public SecurityApiAsyncClient withRequestOptions(@Nullable RequestOptions options) {
		return new SecurityApiAsyncClient(transport, options);
	}
	 ...
	 */
	public SecurityApiAsyncClient withRequestOptions(Function<RequestOptions.Builder, RequestOptions.Builder> fn) {
