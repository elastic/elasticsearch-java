...
public class TemplatesRequest extends CatRequestBase {
	...
	public static class Builder extends CatRequestBase.AbstractBuilder<Builder>
		...
		private Builder(TemplatesRequest instance) {
		 ...
		 */
		public final Builder h(CatTemplatesColumn value, CatTemplatesColumn... values) {
			this.h = _listAdd(this.h, value.jsonValue(),
					Arrays.stream(values).map(CatTemplatesColumn::jsonValue).toArray(String[]::new));
			return this;
		}
