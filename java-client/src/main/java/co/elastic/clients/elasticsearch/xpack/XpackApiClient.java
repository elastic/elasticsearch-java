 ...
 */
public class XpackApiClient extends ApiClient<XpackApiClient> {

	public XpackApiClient(Transport transport) {
		super(transport, null);
	}

	public XpackApiClient(Transport transport, RequestOptions options) {
	...
	/**
	 * Creates a new {@link #XpackApiClient} with specific request options.
	 */
	@Override
	public XpackApiClient withRequestOptions(@Nullable RequestOptions options) {
		return new XpackApiClient(transport, options);
	}
	 ...
	 */
	public XpackApiClient withRequestOptions(Function<RequestOptions.Builder, RequestOptions.Builder> fn) {
