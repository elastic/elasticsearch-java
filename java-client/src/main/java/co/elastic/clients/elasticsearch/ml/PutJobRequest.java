...
public final class PutJobRequest extends RequestBase implements ToJsonp {
	...
	/**
	 * Json parser for PutJobRequest
	 */
	public static final JsonpValueParser<PutJobRequest> JSONP_PARSER = JsonpObjectBuilderParser
			.createForObject(Builder::new, PutJobRequest::setupPutJobRequestParser);

	protected static void setupPutJobRequestParser(DelegatingJsonpValueParser<PutJobRequest.Builder> op) {
	...
	public static final Endpoint<PutJobRequest, PutJobResponse, ElasticsearchError> ENDPOINT = new Endpoint.Simple<>(
			...
			}, Endpoint.Simple.emptyMap(), true, PutJobResponse.JSONP_PARSER);
}
