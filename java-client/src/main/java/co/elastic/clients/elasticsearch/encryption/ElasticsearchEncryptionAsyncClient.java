 ...
 */
public class ElasticsearchEncryptionAsyncClient
		extends
			ApiClient<ElasticsearchTransport, ElasticsearchEncryptionAsyncClient> {

	public ElasticsearchEncryptionAsyncClient(ElasticsearchTransport transport) {
	...
	public ElasticsearchEncryptionAsyncClient withTransportOptions(@Nullable TransportOptions transportOptions) {
		return new ElasticsearchEncryptionAsyncClient(this.transport, transportOptions);
	}
	...
	public final CompletableFuture<ResetResponse> reset(
			Function<ResetRequest.Builder, ObjectBuilder<ResetRequest>> fn) {
