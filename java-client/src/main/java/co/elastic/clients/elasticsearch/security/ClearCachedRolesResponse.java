...
public final class ClearCachedRolesResponse implements ToJsonp {
	...
	/**
	 * Json parser for ClearCachedRolesResponse
	 */
	public static final JsonpValueParser<ClearCachedRolesResponse> JSONP_PARSER = JsonpObjectBuilderParser
			.createForObject(Builder::new, ClearCachedRolesResponse::setupClearCachedRolesResponseParser);

	protected static void setupClearCachedRolesResponseParser(
			DelegatingJsonpValueParser<ClearCachedRolesResponse.Builder> op) {
