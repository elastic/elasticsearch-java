...
public final class ShardStoreWrapper implements ToJsonp {
	...
	/**
	 * Json parser for ShardStoreWrapper
	 */
	public static final JsonpValueParser<ShardStoreWrapper> JSONP_PARSER = JsonpObjectBuilderParser
			.createForObject(Builder::new, ShardStoreWrapper::setupShardStoreWrapperParser);

	protected static void setupShardStoreWrapperParser(DelegatingJsonpValueParser<ShardStoreWrapper.Builder> op) {

		op.add(Builder::stores, JsonpValueParser.arrayParser(ShardStore.JSONP_PARSER), "stores");
