 ...
 */
@JsonpDeserializable
public class UpdateServiceTypeRequest extends RequestBase implements JsonpSerializable {
	...
	/**
	 * Builder for {@link UpdateServiceTypeRequest}.
	 */

	public static class Builder extends RequestBase.AbstractBuilder<Builder>
			implements
				ObjectBuilder<UpdateServiceTypeRequest> {
		...
		/**
		 * Builds a {@link UpdateServiceTypeRequest}.
		 *
	...
	/**
	 * Json deserializer for {@link UpdateServiceTypeRequest}
	 */
	public static final JsonpDeserializer<UpdateServiceTypeRequest> _DESERIALIZER = ObjectBuilderDeserializer
			.lazy(Builder::new, UpdateServiceTypeRequest::setupUpdateServiceTypeRequestDeserializer);

	protected static void setupUpdateServiceTypeRequestDeserializer(
			ObjectDeserializer<UpdateServiceTypeRequest.Builder> op) {
	...
	/**
	 * Endpoint "{@code connector.update_service_type}".
	 */
	public static final Endpoint<UpdateServiceTypeRequest, UpdateServiceTypeResponse, ErrorResponse> _ENDPOINT = new SimpleEndpoint<>(
			"es/connector.update_service_type",
			...
			}, SimpleEndpoint.emptyMap(), true, UpdateServiceTypeResponse._DESERIALIZER);
}
