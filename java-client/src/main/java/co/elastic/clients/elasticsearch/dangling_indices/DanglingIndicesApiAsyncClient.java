 ...
 */
public class DanglingIndicesApiAsyncClient extends ApiClient<DanglingIndicesApiAsyncClient> {

	public DanglingIndicesApiAsyncClient(Transport transport) {
		super(transport, null);
	}

	public DanglingIndicesApiAsyncClient(Transport transport, RequestOptions options) {
	...
	/**
	 * Creates a new {@link #DanglingIndicesApiAsyncClient} with specific request
	 * options.
	 */
	@Override
	public DanglingIndicesApiAsyncClient withRequestOptions(@Nullable RequestOptions options) {
		return new DanglingIndicesApiAsyncClient(transport, options);
	}
	 ...
	 */
	public DanglingIndicesApiAsyncClient withRequestOptions(
