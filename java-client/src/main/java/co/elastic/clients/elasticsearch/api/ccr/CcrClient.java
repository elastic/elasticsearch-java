 ...
 */
public class CcrClient extends ApiClient<CcrClient> {

	public CcrClient(Transport transport) {
		super(transport, null);
	}

	public CcrClient(Transport transport, RequestOptions options) {
	...
	/**
	 * Creates a new {@link #CcrClient} with specific request options.
	 */
	@Override
	public CcrClient withRequestOptions(@Nullable RequestOptions options) {
		return new CcrClient(transport, options);
	}

	/**
	 * Creates a new {@link #CcrClient} with specific request options, inheriting
	 * existing options.
	 *
	 * @param fn
	 ...
	 */
	public CcrClient withRequestOptions(Function<RequestOptions.Builder, RequestOptions.Builder> fn) {
