...
public final class StopWatcherRequest extends RequestBase {
	 ...
	 */
	public static final Endpoint<StopWatcherRequest, StopWatcherResponse, ElasticsearchError> ENDPOINT = new SimpleEndpoint<>(
			// Request method
			request -> {
				return "POST";
