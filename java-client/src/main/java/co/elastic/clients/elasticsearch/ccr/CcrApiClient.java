 ...
 */
public class CcrApiClient extends ApiClient<CcrApiClient> {

	public CcrApiClient(Transport transport) {
		super(transport, null);
	}

	public CcrApiClient(Transport transport, RequestOptions options) {
	...
	public DeleteAutoFollowPatternResponse deleteAutoFollowPattern(DeleteAutoFollowPatternRequest request)
			throws IOException {
		return this.transport.performRequest(request, DeleteAutoFollowPatternRequest.ENDPOINT, this.requestOptions);
	}
	...
	public FollowInfoResponse followInfo(FollowInfoRequest request) throws IOException {
		return this.transport.performRequest(request, FollowInfoRequest.ENDPOINT, this.requestOptions);
	}
	...
	public GetAutoFollowPatternResponse getAutoFollowPattern(GetAutoFollowPatternRequest request) throws IOException {
		return this.transport.performRequest(request, GetAutoFollowPatternRequest.ENDPOINT, this.requestOptions);
	}
	...
	public PauseAutoFollowPatternResponse pauseAutoFollowPattern(PauseAutoFollowPatternRequest request)
			throws IOException {
		return this.transport.performRequest(request, PauseAutoFollowPatternRequest.ENDPOINT, this.requestOptions);
	}
	...
	public PutAutoFollowPatternResponse putAutoFollowPattern(PutAutoFollowPatternRequest request) throws IOException {
		return this.transport.performRequest(request, PutAutoFollowPatternRequest.ENDPOINT, this.requestOptions);
	}
	...
	public ResumeAutoFollowPatternResponse resumeAutoFollowPattern(ResumeAutoFollowPatternRequest request)
			throws IOException {
		return this.transport.performRequest(request, ResumeAutoFollowPatternRequest.ENDPOINT, this.requestOptions);
	}
	...
	/**
	 * Creates a new {@link #CcrApiClient} with specific request options.
	 */
	@Override
	public CcrApiClient withRequestOptions(@Nullable RequestOptions options) {
		return new CcrApiClient(transport, options);
	}

	/**
	 * Creates a new {@link #CcrApiClient} with specific request options, inheriting
	 * existing options.
	 *
	 * @param fn
	 ...
	 */
	public CcrApiClient withRequestOptions(Function<RequestOptions.Builder, RequestOptions.Builder> fn) {
