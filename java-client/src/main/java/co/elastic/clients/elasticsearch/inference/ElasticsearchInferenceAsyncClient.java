...
public class ElasticsearchInferenceAsyncClient
	...
	public final CompletableFuture<EmbeddingResponse> embedding(
			Function<EmbeddingRequest.Builder, ObjectBuilder<EmbeddingRequest>> fn) {
	...
	public CompletableFuture<PutContextualaiResponse> putContextualai(PutContextualaiRequest request) {
		@SuppressWarnings("unchecked")
	...
	public final CompletableFuture<PutContextualaiResponse> putContextualai(
