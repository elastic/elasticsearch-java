...
public final class GetModelSnapshotsRequest extends RequestBase implements ToJsonp {
	...
	/**
	 * Json parser for GetModelSnapshotsRequest
	 */
	public static final JsonpValueParser<GetModelSnapshotsRequest> JSONP_PARSER = JsonpObjectBuilderParser
			.createForObject(Builder::new, GetModelSnapshotsRequest::setupGetModelSnapshotsRequestParser);

	protected static void setupGetModelSnapshotsRequestParser(
			DelegatingJsonpValueParser<GetModelSnapshotsRequest.Builder> op) {

		op.add(Builder::start, JsonpValueParser.jsonValueParser(), "start");
		op.add(Builder::end, JsonpValueParser.jsonValueParser(), "end");
	...
	public static final Endpoint<GetModelSnapshotsRequest, GetModelSnapshotsResponse, ElasticsearchError> ENDPOINT = new Endpoint.Simple<>(
			...
			}, Endpoint.Simple.emptyMap(), true, GetModelSnapshotsResponse.JSONP_PARSER);
}
