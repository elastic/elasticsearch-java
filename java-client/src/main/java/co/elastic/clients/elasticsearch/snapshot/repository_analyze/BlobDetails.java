...
public class BlobDetails implements JsonpSerializable {
	...
	private BlobDetails(Builder builder) {
		...
		this.overwritten = ApiTypeHelper.requireNonNullWithDefault(builder.overwritten, this, "overwritten",
				this.overwritten());
		this.readEarly = ApiTypeHelper.requireNonNullWithDefault(builder.readEarly, this, "readEarly",
				this.readEarly());
		this.readEnd = ApiTypeHelper.requireNonNullWithDefault(builder.readEnd, this, "readEnd", this.readEnd());
		this.readStart = ApiTypeHelper.requireNonNullWithDefault(builder.readStart, this, "readStart",
				this.readStart());
		...
		this.sizeBytes = ApiTypeHelper.requireNonNullWithDefault(builder.sizeBytes, this, "sizeBytes",
				this.sizeBytes());
