...
public final class RuntimeFieldsType implements ToJsonp {
	...
	/**
	 * Json parser for RuntimeFieldsType
	 */
	public static final JsonpValueParser<RuntimeFieldsType> JSONP_PARSER = JsonpObjectBuilderParser
			.createForObject(Builder::new, RuntimeFieldsType::setupRuntimeFieldsTypeParser);

	protected static void setupRuntimeFieldsTypeParser(DelegatingJsonpValueParser<RuntimeFieldsType.Builder> op) {
