...
public final class ShrinkRequest extends RequestBase implements ToJsonp {
	...
	/**
	 * Json parser for ShrinkRequest
	 */
	public static final JsonpValueParser<ShrinkRequest> JSONP_PARSER = JsonpObjectBuilderParser
			.createForObject(Builder::new, ShrinkRequest::setupShrinkRequestParser);

	protected static void setupShrinkRequestParser(DelegatingJsonpValueParser<ShrinkRequest.Builder> op) {
	...
	public static final Endpoint<ShrinkRequest, ShrinkResponse, ElasticsearchError> ENDPOINT = new Endpoint.Simple<>(
			...
			}, Endpoint.Simple.emptyMap(), true, ShrinkResponse.JSONP_PARSER);
}
