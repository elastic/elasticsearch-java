...
public class SyncJobGetRequest extends RequestBase {
	...
	public static SyncJobGetRequest of(Function<Builder, ObjectBuilder<SyncJobGetRequest>> fn) {
	...
	/**
	 * Builder for {@link SyncJobGetRequest}.
	 */
	...
	public static class Builder extends RequestBase.AbstractBuilder<Builder>
		...
		/**
		 * Builds a {@link SyncJobGetRequest}.
		 *
		 * @throws NullPointerException
		 *             if some of the required fields are null.
		 */
		public SyncJobGetRequest build() {
			_checkSingleUse();

			return new SyncJobGetRequest(this);
		}
	}
	...
	/**
	 * Endpoint "{@code connector.sync_job_get}".
	 */
	public static final Endpoint<SyncJobGetRequest, SyncJobGetResponse, ErrorResponse> _ENDPOINT = new SimpleEndpoint<>(
			"es/connector.sync_job_get",
			...
			}, SimpleEndpoint.emptyMap(), false, SyncJobGetResponse._DESERIALIZER);
}
