 ...
 *
 * @see <a href=
 *      "../../doc-files/api-spec.html#nodes.info.NodeInfoIngestInfo">API
 *      specification</a>
 */
@JsonpDeserializable
public class NodeInfoIngestInfo implements JsonpSerializable {
	...
	public static class Builder extends WithJsonObjectBuilderBase<Builder>
			implements
				ObjectBuilder<NodeInfoIngestInfo> {
		private NodeInfoIngestDownloader downloader;

		public Builder() {
		}
		private Builder(NodeInfoIngestInfo instance) {
			this.downloader = instance.downloader;
