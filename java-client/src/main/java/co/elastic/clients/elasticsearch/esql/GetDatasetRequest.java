...
public class GetDatasetRequest extends RequestBase {
	@Nullable
	...
	public static GetDatasetRequest of(Function<Builder, ObjectBuilder<GetDatasetRequest>> fn) {
	...
	/**
	 * A comma-separated list of dataset names or wildcard patterns. Omit to return
	 * all datasets.
	 * <p>
	 * API name: {@code name}
	 */
	...
	/**
	 * Builder for {@link GetDatasetRequest}.
	 */

	public static class Builder extends RequestBase.AbstractBuilder<Builder>
			implements
				ObjectBuilder<GetDatasetRequest> {
		@Nullable
		...
		private Builder(GetDatasetRequest instance) {
		...
		/**
		 * Builds a {@link GetDatasetRequest}.
		 *
	...
	/**
	 * Endpoint "{@code esql.get_dataset}".
	 */
	public static final Endpoint<GetDatasetRequest, GetDatasetResponse, ErrorResponse> _ENDPOINT = new SimpleEndpoint<>(
			"es/esql.get_dataset",
			...
			}, SimpleEndpoint.emptyMap(), false, GetDatasetResponse._DESERIALIZER);
}
