 ...
 *
 * @see <a href=
 *      "../../doc-files/api-spec.html#_types.analysis.GalicianAnalyzer">API
 *      specification</a>
 */
@JsonpDeserializable
public class GalicianAnalyzer implements AnalyzerVariant, JsonpSerializable {
	...
	public static class Builder extends WithJsonObjectBuilderBase<Builder> implements ObjectBuilder<GalicianAnalyzer> {
		@Nullable
		...
		private Builder(GalicianAnalyzer instance) {
	 ...
	 */
	public static final JsonpDeserializer<GalicianAnalyzer> _DESERIALIZER = ObjectBuilderDeserializer.lazy(Builder::new,
			GalicianAnalyzer::setupGalicianAnalyzerDeserializer);

	protected static void setupGalicianAnalyzerDeserializer(ObjectDeserializer<GalicianAnalyzer.Builder> op) {
