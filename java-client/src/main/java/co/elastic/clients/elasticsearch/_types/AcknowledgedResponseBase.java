...
public abstract class AcknowledgedResponseBase implements ToJsonp {
	...
	// ---------------------------------------------------------------------------------------------
	protected static <BuilderT extends AbstractBuilder<BuilderT>> void setupAcknowledgedResponseBaseParser(
			DelegatingJsonpValueParser<BuilderT> op) {

		op.add(AbstractBuilder::acknowledged, JsonpValueParser.booleanParser(), "acknowledged");
