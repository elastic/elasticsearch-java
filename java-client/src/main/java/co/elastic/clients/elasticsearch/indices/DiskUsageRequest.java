...
public final class DiskUsageRequest extends RequestBase {
	 ...
	 */
	public static final Endpoint<DiskUsageRequest, DiskUsageResponse, ElasticsearchError> ENDPOINT = new Endpoint.Simple<>(
			// Request method
			request -> {
				return "POST";
			...
			}, Endpoint.Simple.emptyMap(), false, DiskUsageResponse._DESERIALIZER);
}
