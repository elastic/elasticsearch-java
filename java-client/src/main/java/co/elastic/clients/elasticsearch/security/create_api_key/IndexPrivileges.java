 ...
 *
 * @see <a href=
 *      "../../doc-files/api-spec.html#security.create_api_key.IndexPrivileges">API
 *      specification</a>
 */
@JsonpDeserializable
public class IndexPrivileges implements JsonpSerializable {
	...
	public static class Builder extends WithJsonObjectBuilderBase<Builder> implements ObjectBuilder<IndexPrivileges> {
