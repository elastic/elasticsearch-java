...
// typedef: inference.put_voyageai.Response

/**
 *
 * @see <a href="../doc-files/api-spec.html#inference.put_voyageai.Response">API
 *      specification</a>
 */
@JsonpDeserializable
public class PutVoyageaiResponse extends InferenceEndpointInfo {
	...
	public static PutVoyageaiResponse of(Function<Builder, ObjectBuilder<PutVoyageaiResponse>> fn) {
	...
	public static class Builder extends InferenceEndpointInfo.AbstractBuilder<Builder>
		...
		/**
		 * Builds a {@link PutVoyageaiResponse}.
		 *
		 * @throws NullPointerException
		 *             if some of the required fields are null.
		 */
		public PutVoyageaiResponse build() {
			_checkSingleUse();

			return new PutVoyageaiResponse(this);
		}
	}
	...
	/**
	 * Json deserializer for {@link PutVoyageaiResponse}
	 */
	public static final JsonpDeserializer<PutVoyageaiResponse> _DESERIALIZER = ObjectBuilderDeserializer
