 ...
 *
 * @see <a href=
 *      "https://github.com/elastic/elasticsearch-specification/tree/bd953a3fc/specification/watcher/_types/Execution.ts#L48-L57">API
 *      specification</a>
 */
@JsonpDeserializable
public enum ExecutionPhase implements JsonEnum {
	...
	ExecutionPhase(String jsonValue) {
