 ...
 * 
 * @see <a href=
 *      "https://github.com/elastic/elasticsearch-specification/tree/bd953a3fc/specification/enrich/stats/EnrichStatsRequest.ts#L22-L27">API
 *      specification</a>
 */
...
public class EnrichStatsRequest extends RequestBase {
	...
	/**
	 * Singleton instance for {@link EnrichStatsRequest}.
	 */
