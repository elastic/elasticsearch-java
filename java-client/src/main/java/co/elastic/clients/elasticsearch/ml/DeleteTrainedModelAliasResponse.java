...
public final class DeleteTrainedModelAliasResponse extends AcknowledgedResponseBase {
	...
	/**
	 * Json parser for DeleteTrainedModelAliasResponse
	 */
	public static final JsonpValueParser<DeleteTrainedModelAliasResponse> JSONP_PARSER = JsonpObjectBuilderParser
			.createForObject(Builder::new, DeleteTrainedModelAliasResponse::setupDeleteTrainedModelAliasResponseParser);

	protected static void setupDeleteTrainedModelAliasResponseParser(
			DelegatingJsonpValueParser<DeleteTrainedModelAliasResponse.Builder> op) {
