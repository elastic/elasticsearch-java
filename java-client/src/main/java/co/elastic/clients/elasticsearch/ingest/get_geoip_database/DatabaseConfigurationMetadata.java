...
// typedef: ingest.get_geoip_database.DatabaseConfigurationMetadata

/**
 *
 * @see <a href=
 *      "../../doc-files/api-spec.html#ingest.get_geoip_database.DatabaseConfigurationMetadata">API
 *      specification</a>
 */
@JsonpDeserializable
public class DatabaseConfigurationMetadata implements JsonpSerializable {
	...
	private DatabaseConfigurationMetadata(Builder builder) {
		...
		this.modifiedDateMillis = ApiTypeHelper.requireNonNullWithDefault(builder.modifiedDateMillis, this,
				"modifiedDateMillis", this.modifiedDateMillis());
