...
// typedef: snapshot._types.SourceOnlyRepositorySettingsForGcs

/**
 *
 * @see <a href=
 *      "../doc-files/api-spec.html#snapshot._types.SourceOnlyRepositorySettingsForGcs">API
 *      specification</a>
 */
@JsonpDeserializable
public class SourceOnlyRepositorySettingsForGcs implements SourceOnlyRepositorySettingsVariant, JsonpSerializable {
	...
	private SourceOnlyRepositorySettingsForGcs(Builder builder) {
	...
	public static SourceOnlyRepositorySettingsForGcs of(
			Function<Builder, ObjectBuilder<SourceOnlyRepositorySettingsForGcs>> fn) {
	...
	public SourceOnlyRepositorySettings.Kind _sourceOnlyRepositorySettingsKind() {
		return SourceOnlyRepositorySettings.Kind.Gcs;
	}
	...
	protected void serializeInternal(JsonGenerator generator, JsonpMapper mapper) {
		...
		generator.write("delegate_type", "gcs");
	...
	/**
	 * Builder for {@link SourceOnlyRepositorySettingsForGcs}.
	 */

	public static class Builder extends WithJsonObjectBuilderBase<Builder>
			implements
				ObjectBuilder<SourceOnlyRepositorySettingsForGcs> {
		...
		private Builder(SourceOnlyRepositorySettingsForGcs instance) {
		...
		/**
		 * Builds a {@link SourceOnlyRepositorySettingsForGcs}.
		 *
		 * @throws NullPointerException
		 *             if some of the required fields are null.
		 */
		public SourceOnlyRepositorySettingsForGcs build() {
			_checkSingleUse();

			return new SourceOnlyRepositorySettingsForGcs(this);
		}
	}
	...
	/**
	 * Json deserializer for {@link SourceOnlyRepositorySettingsForGcs}
	 */
	public static final JsonpDeserializer<SourceOnlyRepositorySettingsForGcs> _DESERIALIZER = ObjectBuilderDeserializer
			.lazy(Builder::new,
					SourceOnlyRepositorySettingsForGcs::setupSourceOnlyRepositorySettingsForGcsDeserializer);

	protected static void setupSourceOnlyRepositorySettingsForGcsDeserializer(
			ObjectDeserializer<SourceOnlyRepositorySettingsForGcs.Builder> op) {
