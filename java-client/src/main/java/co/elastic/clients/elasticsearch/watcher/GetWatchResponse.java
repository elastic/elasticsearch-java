...
public final class GetWatchResponse implements ToJsonp {
	...
	/**
	 * Json parser for GetWatchResponse
	 */
	public static final JsonpValueParser<GetWatchResponse> JSONP_PARSER = JsonpObjectBuilderParser
			.createForObject(Builder::new, GetWatchResponse::setupGetWatchResponseParser);

	protected static void setupGetWatchResponseParser(DelegatingJsonpValueParser<GetWatchResponse.Builder> op) {
