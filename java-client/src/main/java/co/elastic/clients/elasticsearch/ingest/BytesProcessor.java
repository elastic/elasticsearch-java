...
public final class BytesProcessor extends ProcessorBase {
	...
	/**
	 * Json parser for BytesProcessor
	 */
	public static final JsonpValueParser<BytesProcessor> JSONP_PARSER = JsonpObjectBuilderParser
			.createForObject(Builder::new, BytesProcessor::setupBytesProcessorParser);

	protected static void setupBytesProcessorParser(DelegatingJsonpValueParser<BytesProcessor.Builder> op) {
