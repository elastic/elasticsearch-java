 ...
 */
public class MonitoringClient extends ApiClient<MonitoringClient> {

	public MonitoringClient(Transport transport) {
		super(transport, null);
	}

	public MonitoringClient(Transport transport, RequestOptions options) {
	...
	/**
	 * Creates a new {@link #MonitoringClient} with specific request options.
	 */
	@Override
	public MonitoringClient withRequestOptions(@Nullable RequestOptions options) {
		return new MonitoringClient(transport, options);
	}
	 ...
	 */
	public MonitoringClient withRequestOptions(Function<RequestOptions.Builder, RequestOptions.Builder> fn) {
