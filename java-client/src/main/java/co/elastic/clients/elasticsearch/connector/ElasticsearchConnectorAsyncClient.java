...
public class ElasticsearchConnectorAsyncClient
	...
	public CompletableFuture<LastSyncResponse> lastSync(LastSyncRequest request) {
		@SuppressWarnings("unchecked")
	...
	public final CompletableFuture<LastSyncResponse> lastSync(
			Function<LastSyncRequest.Builder, ObjectBuilder<LastSyncRequest>> fn) {
