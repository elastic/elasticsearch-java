 ...
 */
public class SearchableSnapshotsApiAsyncClient extends ApiClient<SearchableSnapshotsApiAsyncClient> {

	public SearchableSnapshotsApiAsyncClient(Transport transport) {
		super(transport, null);
	}

	public SearchableSnapshotsApiAsyncClient(Transport transport, RequestOptions options) {
	...
	/**
	 * Creates a new {@link #SearchableSnapshotsApiAsyncClient} with specific
	 * request options.
	 */
	@Override
	public SearchableSnapshotsApiAsyncClient withRequestOptions(@Nullable RequestOptions options) {
		return new SearchableSnapshotsApiAsyncClient(transport, options);
	}

	/**
	 * Creates a new {@link #SearchableSnapshotsApiAsyncClient} with specific
	 * request options, inheriting existing options.
	 *
	 * @param fn
	 *            a function taking an options builder initialized with the current
	 *            request options, or initialized with default values.
	 */
	public SearchableSnapshotsApiAsyncClient withRequestOptions(
