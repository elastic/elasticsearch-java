...
// typedef: indices._types.IndexTemplateWithRollover

/**
 *
 * @see <a href=
 *      "../doc-files/api-spec.html#indices._types.IndexTemplateWithRollover">API
 *      specification</a>
 */
@JsonpDeserializable
public class IndexTemplateWithRollover implements JsonpSerializable {
	@Nullable
	private final IndexTemplateSummaryWithRollover template;
	...
	private IndexTemplateWithRollover(Builder builder) {
	...
	public static IndexTemplateWithRollover of(Function<Builder, ObjectBuilder<IndexTemplateWithRollover>> fn) {
	 ...
	 */
	@Nullable
	public final IndexTemplateSummaryWithRollover template() {
	...
	/**
	 * Builder for {@link IndexTemplateWithRollover}.
	 */

	public static class Builder extends WithJsonObjectBuilderBase<Builder>
			implements
				ObjectBuilder<IndexTemplateWithRollover> {
		@Nullable
		private IndexTemplateSummaryWithRollover template;
		...
		private Builder(IndexTemplateWithRollover instance) {
		 ...
		 * API name: {@code template}
		 */
		public final Builder template(@Nullable IndexTemplateSummaryWithRollover value) {
			this.template = value;
			return this;
		}
		...
		public final Builder template(
				Function<IndexTemplateSummaryWithRollover.Builder, ObjectBuilder<IndexTemplateSummaryWithRollover>> fn) {
			return this.template(fn.apply(new IndexTemplateSummaryWithRollover.Builder()).build());
		}
		...
		/**
		 * Builds a {@link IndexTemplateWithRollover}.
		 *
		 * @throws NullPointerException
		 *             if some of the required fields are null.
		 */
		public IndexTemplateWithRollover build() {
			_checkSingleUse();

			return new IndexTemplateWithRollover(this);
		}
	}
	...
	/**
	 * Json deserializer for {@link IndexTemplateWithRollover}
	 */
	public static final JsonpDeserializer<IndexTemplateWithRollover> _DESERIALIZER = ObjectBuilderDeserializer
			.lazy(Builder::new, IndexTemplateWithRollover::setupIndexTemplateWithRolloverDeserializer);

	protected static void setupIndexTemplateWithRolloverDeserializer(
			ObjectDeserializer<IndexTemplateWithRollover.Builder> op) {

		op.add(Builder::template, IndexTemplateSummaryWithRollover._DESERIALIZER, "template");
