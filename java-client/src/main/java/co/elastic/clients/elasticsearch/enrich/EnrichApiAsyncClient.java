 ...
 */
public class EnrichApiAsyncClient extends ApiClient<EnrichApiAsyncClient> {

	public EnrichApiAsyncClient(Transport transport) {
		super(transport, null);
	}

	public EnrichApiAsyncClient(Transport transport, RequestOptions options) {
	...
	/**
	 * Creates a new {@link #EnrichApiAsyncClient} with specific request options.
	 */
	@Override
	public EnrichApiAsyncClient withRequestOptions(@Nullable RequestOptions options) {
		return new EnrichApiAsyncClient(transport, options);
	}
	 ...
	 */
	public EnrichApiAsyncClient withRequestOptions(Function<RequestOptions.Builder, RequestOptions.Builder> fn) {
