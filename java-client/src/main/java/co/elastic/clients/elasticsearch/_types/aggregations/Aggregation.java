...
public abstract class Aggregation implements ToJsonp {
	...
	// ---------------------------------------------------------------------------------------------
	protected static <BuilderT extends AbstractBuilder<BuilderT>> void setupAggregationParser(
			DelegatingJsonpValueParser<BuilderT> op) {

		op.add(AbstractBuilder::meta, JsonpValueParser.stringMapParser(JsonpValueParser.jsonValueParser()), "meta");
