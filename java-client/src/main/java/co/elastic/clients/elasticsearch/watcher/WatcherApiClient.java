 ...
 */
public class WatcherApiClient extends ApiClient<WatcherApiClient> {

	public WatcherApiClient(Transport transport) {
		super(transport, null);
	}

	public WatcherApiClient(Transport transport, RequestOptions options) {
	...
	/**
	 * Creates a new {@link #WatcherApiClient} with specific request options.
	 */
	@Override
	public WatcherApiClient withRequestOptions(@Nullable RequestOptions options) {
		return new WatcherApiClient(transport, options);
	}
	 ...
	 */
	public WatcherApiClient withRequestOptions(Function<RequestOptions.Builder, RequestOptions.Builder> fn) {
