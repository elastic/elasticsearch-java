...
public final class SizeField implements ToJsonp {
	...
	/**
	 * Json parser for SizeField
	 */
	public static final JsonpValueParser<SizeField> JSONP_PARSER = JsonpObjectBuilderParser
			.createForObject(Builder::new, SizeField::setupSizeFieldParser);

	protected static void setupSizeFieldParser(DelegatingJsonpValueParser<SizeField.Builder> op) {
