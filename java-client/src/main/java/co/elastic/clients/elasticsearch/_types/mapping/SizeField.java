...
/**
 *
 * @see <a href="../../doc-files/api-spec.html#_types.mapping.SizeField">API
 *      specification</a>
 */
@JsonpDeserializable
public class SizeField implements JsonpSerializable {
	...
	public static class Builder extends WithJsonObjectBuilderBase<Builder> implements ObjectBuilder<SizeField> {
		private Boolean enabled;

		public Builder() {
		}
		private Builder(SizeField instance) {
