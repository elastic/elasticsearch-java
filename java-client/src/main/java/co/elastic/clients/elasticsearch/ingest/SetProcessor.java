...
public final class SetProcessor extends ProcessorBase {
	...
	/**
	 * Json parser for SetProcessor
	 */
	public static final JsonpValueParser<SetProcessor> JSONP_PARSER = JsonpObjectBuilderParser
			.createForObject(Builder::new, SetProcessor::setupSetProcessorParser);

	protected static void setupSetProcessorParser(DelegatingJsonpValueParser<SetProcessor.Builder> op) {
