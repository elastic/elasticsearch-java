...
// typedef: migration.deprecation_info.Response
public final class DeprecationInfoResponse implements ToJsonp {
	...
	protected DeprecationInfoResponse(Builder builder) {
	...
	/**
	 * Builder for {@link DeprecationInfoResponse}.
	 */
	public static class Builder implements ObjectBuilder<DeprecationInfoResponse> {
		...
		/**
		 * Builds a {@link DeprecationInfoResponse}.
		 *
		 * @throws NullPointerException
		 *             if some of the required fields are null.
		 */
		public DeprecationInfoResponse build() {

			return new DeprecationInfoResponse(this);
		}
	}
