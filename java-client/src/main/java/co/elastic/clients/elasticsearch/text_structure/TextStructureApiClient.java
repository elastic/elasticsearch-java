 ...
 */
public class TextStructureApiClient extends ApiClient<TextStructureApiClient> {

	public TextStructureApiClient(Transport transport) {
		super(transport, null);
	}

	public TextStructureApiClient(Transport transport, RequestOptions options) {
	...
	/**
	 * Creates a new {@link #TextStructureApiClient} with specific request options.
	 */
	@Override
	public TextStructureApiClient withRequestOptions(@Nullable RequestOptions options) {
		return new TextStructureApiClient(transport, options);
	}
	 ...
	 */
	public TextStructureApiClient withRequestOptions(Function<RequestOptions.Builder, RequestOptions.Builder> fn) {
