 ...
 */
public class IlmApiClient extends ApiClient<IlmApiClient> {

	public IlmApiClient(Transport transport) {
		super(transport, null);
	}

	public IlmApiClient(Transport transport, RequestOptions options) {
	...
	/**
	 * Creates a new {@link #IlmApiClient} with specific request options.
	 */
	@Override
	public IlmApiClient withRequestOptions(@Nullable RequestOptions options) {
		return new IlmApiClient(transport, options);
	}

	/**
	 * Creates a new {@link #IlmApiClient} with specific request options, inheriting
	 * existing options.
	 *
	 * @param fn
	 ...
	 */
	public IlmApiClient withRequestOptions(Function<RequestOptions.Builder, RequestOptions.Builder> fn) {
