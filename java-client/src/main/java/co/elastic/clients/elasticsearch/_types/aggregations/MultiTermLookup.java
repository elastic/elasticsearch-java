...
public final class MultiTermLookup implements ToJsonp {
	...
	/**
	 * Json parser for MultiTermLookup
	 */
	public static final JsonpValueParser<MultiTermLookup> JSONP_PARSER = JsonpObjectBuilderParser
			.createForObject(Builder::new, MultiTermLookup::setupMultiTermLookupParser);

	protected static void setupMultiTermLookupParser(DelegatingJsonpValueParser<MultiTermLookup.Builder> op) {
