...
public final class DataframeEvaluationClassificationMetricsAucRoc implements ToJsonp {
	...
	/**
	 * Json parser for DataframeEvaluationClassificationMetricsAucRoc
	 */
	public static final JsonpValueParser<DataframeEvaluationClassificationMetricsAucRoc> JSONP_PARSER = JsonpObjectBuilderParser
			.createForObject(Builder::new,
					DataframeEvaluationClassificationMetricsAucRoc::setupDataframeEvaluationClassificationMetricsAucRocParser);

	protected static void setupDataframeEvaluationClassificationMetricsAucRocParser(
			DelegatingJsonpValueParser<DataframeEvaluationClassificationMetricsAucRoc.Builder> op) {

		op.add(Builder::className, JsonpValueParser.stringParser(), "class_name");
		op.add(Builder::includeCurve, JsonpValueParser.booleanParser(), "include_curve");
