...
public final class ApplicationPrivilegesCheck implements ToJsonp {
	...
	/**
	 * Json parser for ApplicationPrivilegesCheck
	 */
	public static final JsonpValueParser<ApplicationPrivilegesCheck> JSONP_PARSER = JsonpObjectBuilderParser
			.createForObject(Builder::new, ApplicationPrivilegesCheck::setupApplicationPrivilegesCheckParser);

	protected static void setupApplicationPrivilegesCheckParser(
			DelegatingJsonpValueParser<ApplicationPrivilegesCheck.Builder> op) {
