...
// typedef: inference.put_mistral.Response

/**
 *
 * @see <a href="../doc-files/api-spec.html#inference.put_mistral.Response">API
 *      specification</a>
 */
@JsonpDeserializable
public class PutMistralResponse extends InferenceEndpointInfo {
	...
	public static PutMistralResponse of(Function<Builder, ObjectBuilder<PutMistralResponse>> fn) {
	...
	public static class Builder extends InferenceEndpointInfo.AbstractBuilder<Builder>
		...
		/**
		 * Builds a {@link PutMistralResponse}.
		 *
		 * @throws NullPointerException
		 *             if some of the required fields are null.
		 */
		public PutMistralResponse build() {
			_checkSingleUse();
	...
	/**
	 * Json deserializer for {@link PutMistralResponse}
	 */
	public static final JsonpDeserializer<PutMistralResponse> _DESERIALIZER = ObjectBuilderDeserializer
