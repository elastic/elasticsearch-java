 ...
 *
 * @see <a href=
 *      "https://github.com/elastic/elasticsearch-specification/tree/bd953a3fc/specification/ccr/follow_info/types.ts#L30-L33">API
 *      specification</a>
 */
@JsonpDeserializable
public enum FollowerIndexStatus implements JsonEnum {
	...
	FollowerIndexStatus(String jsonValue) {
