 ...
 * 
 * @see <a href="../doc-files/api-spec.html#_types.KnnEmbeddingInput">API
 *      specification</a>
 */
@JsonpDeserializable
public class KnnEmbeddingInput implements TaggedUnion<KnnEmbeddingInput.Kind, Object>, JsonpSerializable {
	...
	public static KnnEmbeddingInput of(Function<Builder, ObjectBuilder<KnnEmbeddingInput>> fn) {
	 ...
	 */
	public List<InferenceString> object() {
		...
		if (_value instanceof JsonpSerializable) {
			...
			switch (_kind) {
				case Object :
					...
					for (InferenceString item0 : ((List<InferenceString>) this._value)) {
	...
	public static class Builder extends ObjectBuilderBase implements ObjectBuilder<KnnEmbeddingInput> {
		private Kind _kind;
		private Object _value;

		public ObjectBuilder<KnnEmbeddingInput> object(List<InferenceString> v) {
			this._kind = Kind.Object;
			this._value = v;
			return this;
		}

		public ObjectBuilder<KnnEmbeddingInput> string(String v) {
	...
	private static JsonpDeserializer<KnnEmbeddingInput> buildKnnEmbeddingInputDeserializer() {
		return new UnionDeserializer.Builder<KnnEmbeddingInput, Kind, Object>(KnnEmbeddingInput::new, false)
	...
	public static final JsonpDeserializer<KnnEmbeddingInput> _DESERIALIZER = JsonpDeserializer
