...
public final class GetCategoriesRequest extends RequestBase implements ToJsonp {
	...
	/**
	 * Json parser for GetCategoriesRequest
	 */
	public static final JsonpValueParser<GetCategoriesRequest> JSONP_PARSER = JsonpObjectBuilderParser
			.createForObject(Builder::new, GetCategoriesRequest::setupGetCategoriesRequestParser);

	protected static void setupGetCategoriesRequestParser(DelegatingJsonpValueParser<GetCategoriesRequest.Builder> op) {
	...
	public static final Endpoint<GetCategoriesRequest, GetCategoriesResponse, ElasticsearchError> ENDPOINT = new Endpoint.Simple<>(
			...
			}, Endpoint.Simple.emptyMap(), true, GetCategoriesResponse.JSONP_PARSER);
}
