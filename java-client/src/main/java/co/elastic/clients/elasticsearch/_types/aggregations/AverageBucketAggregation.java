...
public final class AverageBucketAggregation extends PipelineAggregationBase {
	// ---------------------------------------------------------------------------------------------
	 ...
	 */
	public static final JsonpDeserializer<AverageBucketAggregation> DESERIALIZER = ObjectBuilderDeserializer
			.createForObject(Builder::new, AverageBucketAggregation::setupAverageBucketAggregationDeserializer);
