...
public class ElasticsearchEnrichClient extends ApiClient<ElasticsearchTransport, ElasticsearchEnrichClient> {
	 ...
	 * 
	 * @see <a href=
	 *      "https://www.elastic.co/guide/en/elasticsearch/reference/8.17/execute-enrich-policy-api.html">Documentation
	 *      on elastic.co</a>
	 */
	 ...
	 * 
	 * @see <a href=
	 *      "https://www.elastic.co/guide/en/elasticsearch/reference/8.17/put-enrich-policy-api.html">Documentation
	 *      on elastic.co</a>
	 */
