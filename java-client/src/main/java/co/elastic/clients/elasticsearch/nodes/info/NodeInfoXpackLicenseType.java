 ...
 *
 * @see <a href=
 *      "../../doc-files/api-spec.html#nodes.info.NodeInfoXpackLicenseType">API
 *      specification</a>
 */
@JsonpDeserializable
public class NodeInfoXpackLicenseType implements JsonpSerializable {
	...
	public static class Builder extends WithJsonObjectBuilderBase<Builder>
			implements
				ObjectBuilder<NodeInfoXpackLicenseType> {
		private String type;

		public Builder() {
		}
		private Builder(NodeInfoXpackLicenseType instance) {
