 ...
 *
 * @see <a href=
 *      "../../doc-files/api-spec.html#_types.analysis.BasqueAnalyzer">API
 *      specification</a>
 */
@JsonpDeserializable
public class BasqueAnalyzer implements AnalyzerVariant, JsonpSerializable {
	...
	public static class Builder extends WithJsonObjectBuilderBase<Builder> implements ObjectBuilder<BasqueAnalyzer> {
		@Nullable
		...
		private Builder(BasqueAnalyzer instance) {
	 ...
	 */
	public static final JsonpDeserializer<BasqueAnalyzer> _DESERIALIZER = ObjectBuilderDeserializer.lazy(Builder::new,
