 ...
 *
 * @see <a href=
 *      "../../doc-files/api-spec.html#cluster.reroute.CommandAllocatePrimaryAction">API
 *      specification</a>
 */
@JsonpDeserializable
public class CommandAllocatePrimaryAction implements JsonpSerializable {
	...
	private CommandAllocatePrimaryAction(Builder builder) {
		...
		this.acceptDataLoss = ApiTypeHelper.requireNonNullWithDefault(builder.acceptDataLoss, this, "acceptDataLoss",
				this.acceptDataLoss());
