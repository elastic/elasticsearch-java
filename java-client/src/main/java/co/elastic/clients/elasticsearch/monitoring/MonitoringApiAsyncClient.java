 ...
 */
public class MonitoringApiAsyncClient extends ApiClient<MonitoringApiAsyncClient> {

	public MonitoringApiAsyncClient(Transport transport) {
		super(transport, null);
	}

	public MonitoringApiAsyncClient(Transport transport, RequestOptions options) {
	...
	/**
	 * Creates a new {@link #MonitoringApiAsyncClient} with specific request
	 * options.
	 */
	@Override
	public MonitoringApiAsyncClient withRequestOptions(@Nullable RequestOptions options) {
		return new MonitoringApiAsyncClient(transport, options);
	}
	 ...
	 */
	public MonitoringApiAsyncClient withRequestOptions(Function<RequestOptions.Builder, RequestOptions.Builder> fn) {
