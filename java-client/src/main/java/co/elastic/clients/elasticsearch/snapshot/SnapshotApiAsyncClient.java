 ...
 */
public class SnapshotApiAsyncClient extends ApiClient<SnapshotApiAsyncClient> {

	public SnapshotApiAsyncClient(Transport transport) {
		super(transport, null);
	}

	public SnapshotApiAsyncClient(Transport transport, RequestOptions options) {
	...
	/**
	 * Creates a new {@link #SnapshotApiAsyncClient} with specific request options.
	 */
	@Override
	public SnapshotApiAsyncClient withRequestOptions(@Nullable RequestOptions options) {
		return new SnapshotApiAsyncClient(transport, options);
	}
	 ...
	 */
	public SnapshotApiAsyncClient withRequestOptions(Function<RequestOptions.Builder, RequestOptions.Builder> fn) {
