 ...
 */
public class SlmApiClient extends ApiClient<SlmApiClient> {

	public SlmApiClient(Transport transport) {
		super(transport, null);
	}

	public SlmApiClient(Transport transport, RequestOptions options) {
	...
	/**
	 * Creates a new {@link #SlmApiClient} with specific request options.
	 */
	@Override
	public SlmApiClient withRequestOptions(@Nullable RequestOptions options) {
		return new SlmApiClient(transport, options);
	}

	/**
	 * Creates a new {@link #SlmApiClient} with specific request options, inheriting
	 * existing options.
	 *
	 * @param fn
	 ...
	 */
	public SlmApiClient withRequestOptions(Function<RequestOptions.Builder, RequestOptions.Builder> fn) {
