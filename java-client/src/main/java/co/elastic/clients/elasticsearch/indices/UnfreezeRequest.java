...
public final class UnfreezeRequest extends RequestBase {
	 ...
	 */
	public static final Endpoint<UnfreezeRequest, UnfreezeResponse, ElasticsearchError> ENDPOINT = new Endpoint.Simple<>(
			// Request method
			request -> {
				return "POST";
			...
			}, Endpoint.Simple.emptyMap(), false, UnfreezeResponse._DESERIALIZER);
}
