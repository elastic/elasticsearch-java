...
public final class DatafeedStats implements ToJsonp {
	...
	/**
	 * Json parser for DatafeedStats
	 */
	public static final JsonpValueParser<DatafeedStats> JSONP_PARSER = JsonpObjectBuilderParser
			.createForObject(Builder::new, DatafeedStats::setupDatafeedStatsParser);

	protected static void setupDatafeedStatsParser(DelegatingJsonpValueParser<DatafeedStats.Builder> op) {
		...
		op.add(Builder::timingStats, DatafeedTimingStats.JSONP_PARSER, "timing_stats");
