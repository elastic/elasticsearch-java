 ...
 */
public class MigrationApiAsyncClient extends ApiClient<MigrationApiAsyncClient> {

	public MigrationApiAsyncClient(Transport transport) {
		super(transport, null);
	}

	public MigrationApiAsyncClient(Transport transport, RequestOptions options) {
	...
	/**
	 * Creates a new {@link #MigrationApiAsyncClient} with specific request options.
	 */
	@Override
	public MigrationApiAsyncClient withRequestOptions(@Nullable RequestOptions options) {
		return new MigrationApiAsyncClient(transport, options);
	}
	 ...
	 */
	public MigrationApiAsyncClient withRequestOptions(Function<RequestOptions.Builder, RequestOptions.Builder> fn) {
