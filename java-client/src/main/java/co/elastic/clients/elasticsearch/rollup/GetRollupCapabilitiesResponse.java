...
// typedef: rollup.get_rollup_capabilities.Response
public final class GetRollupCapabilitiesResponse extends AdditionalProperties<String, RollupCapabilities> {
	// ---------------------------------------------------------------------------------------------

	protected GetRollupCapabilitiesResponse(Builder builder) {
		super(builder);
	...
	public static class Builder extends AdditionalProperties.AbstractBuilder<String, RollupCapabilities, Builder>
		...
		/**
		 * Builds a {@link GetRollupCapabilitiesResponse}.
		 *
		 * @throws NullPointerException
		 *             if some of the required fields are null.
		 */
		public GetRollupCapabilitiesResponse build() {
			super.tKeySerializer(null);
			super.tValueSerializer(null);

			return new GetRollupCapabilitiesResponse(this);
		}
	}
