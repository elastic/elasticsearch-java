...
package co.elastic.clients.elasticsearch.inference.put_jinaai;
...
// typedef: inference.put_jinaai.JinaAITaskSettings

/**
 *
 * @see <a href=
 *      "../../doc-files/api-spec.html#inference.put_jinaai.JinaAITaskSettings">API
 *      specification</a>
 */
@JsonpDeserializable
public class JinaAITaskSettings implements JsonpSerializable {
	...
	@Nullable
	private final TextEmbeddingTask task;
	 ...
	 */
	@Nullable
	public final TextEmbeddingTask task() {
		return this.task;
	}
	...
	public static class Builder extends WithJsonObjectBuilderBase<Builder>
		...
		@Nullable
		private TextEmbeddingTask task;
		 ...
		 * API name: {@code task}
		 */
		public final Builder task(@Nullable TextEmbeddingTask value) {
			this.task = value;
			return this;
		}
	...
	protected static void setupJinaAITaskSettingsDeserializer(ObjectDeserializer<JinaAITaskSettings.Builder> op) {
		...
		op.add(Builder::task, TextEmbeddingTask._DESERIALIZER, "task");
