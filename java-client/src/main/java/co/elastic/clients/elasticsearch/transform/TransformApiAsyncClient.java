 ...
 */
public class TransformApiAsyncClient extends ApiClient<TransformApiAsyncClient> {

	public TransformApiAsyncClient(Transport transport) {
		super(transport, null);
	}

	public TransformApiAsyncClient(Transport transport, RequestOptions options) {
	...
	/**
	 * Creates a new {@link #TransformApiAsyncClient} with specific request options.
	 */
	@Override
	public TransformApiAsyncClient withRequestOptions(@Nullable RequestOptions options) {
		return new TransformApiAsyncClient(transport, options);
	}
	 ...
	 */
	public TransformApiAsyncClient withRequestOptions(Function<RequestOptions.Builder, RequestOptions.Builder> fn) {
