...
public final class DataframeEvaluationRegression implements ToJsonp {
	...
	/**
	 * Json parser for DataframeEvaluationRegression
	 */
	public static final JsonpValueParser<DataframeEvaluationRegression> JSONP_PARSER = JsonpObjectBuilderParser
			.createForObject(Builder::new, DataframeEvaluationRegression::setupDataframeEvaluationRegressionParser);

	protected static void setupDataframeEvaluationRegressionParser(
			DelegatingJsonpValueParser<DataframeEvaluationRegression.Builder> op) {
		...
		op.add(Builder::metrics, DataframeEvaluationRegressionMetrics.JSONP_PARSER, "metrics");
