 ...
 */
public class ClusterApiAsyncClient extends ApiClient<ClusterApiAsyncClient> {

	public ClusterApiAsyncClient(Transport transport) {
		super(transport, null);
	}

	public ClusterApiAsyncClient(Transport transport, RequestOptions options) {
	...
	public CompletableFuture<RemoteInfoResponse> remoteInfo() throws IOException {
		return this.transport.performRequestAsync(RemoteInfoRequest.INSTANCE, RemoteInfoRequest.ENDPOINT,
				this.requestOptions);
	}
	...
	/**
	 * Creates a new {@link #ClusterApiAsyncClient} with specific request options.
	 */
	@Override
	public ClusterApiAsyncClient withRequestOptions(@Nullable RequestOptions options) {
		return new ClusterApiAsyncClient(transport, options);
	}
	 ...
	 */
	public ClusterApiAsyncClient withRequestOptions(Function<RequestOptions.Builder, RequestOptions.Builder> fn) {
