...
public final class ExplainDataFrameAnalyticsResponse implements ToJsonp {
	...
	/**
	 * Json parser for ExplainDataFrameAnalyticsResponse
	 */
	public static final JsonpValueParser<ExplainDataFrameAnalyticsResponse> JSONP_PARSER = JsonpObjectBuilderParser
			.createForObject(Builder::new,
					ExplainDataFrameAnalyticsResponse::setupExplainDataFrameAnalyticsResponseParser);

	protected static void setupExplainDataFrameAnalyticsResponseParser(
			DelegatingJsonpValueParser<ExplainDataFrameAnalyticsResponse.Builder> op) {

		op.add(Builder::fieldSelection, JsonpValueParser.arrayParser(DataframeAnalyticsFieldSelection.JSONP_PARSER),
				"field_selection");
		op.add(Builder::memoryEstimation, DataframeAnalyticsMemoryEstimation.JSONP_PARSER, "memory_estimation");
