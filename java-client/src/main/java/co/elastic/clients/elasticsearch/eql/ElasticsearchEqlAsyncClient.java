...
public class ElasticsearchEqlAsyncClient extends ApiClient<ElasticsearchTransport, ElasticsearchEqlAsyncClient> {
	 ...
	 * 
	 * @see <a href=
	 *      "https://www.elastic.co/docs/api/doc/elasticsearch/v9/operation-eql-delete">Documentation
	 *      on elastic.co</a>
	 */
	 ...
	 * 
	 * @see <a href=
	 *      "https://www.elastic.co/docs/api/doc/elasticsearch/v9/operation-eql-get">Documentation
	 *      on elastic.co</a>
	 */
	 ...
	 * 
	 * @see <a href=
	 *      "https://www.elastic.co/docs/api/doc/elasticsearch/v9/operation-eql-get-status">Documentation
	 *      on elastic.co</a>
	 */
	 ...
	 * 
	 * @see <a href=
	 *      "https://www.elastic.co/docs/api/doc/elasticsearch/v9/operation-eql-search">Documentation
	 *      on elastic.co</a>
	 */
