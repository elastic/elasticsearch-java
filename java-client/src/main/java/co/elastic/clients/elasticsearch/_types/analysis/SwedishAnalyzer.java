 ...
 *
 * @see <a href=
 *      "../../doc-files/api-spec.html#_types.analysis.SwedishAnalyzer">API
 *      specification</a>
 */
@JsonpDeserializable
public class SwedishAnalyzer implements AnalyzerVariant, JsonpSerializable {
	...
	public static class Builder extends WithJsonObjectBuilderBase<Builder> implements ObjectBuilder<SwedishAnalyzer> {
		@Nullable
		...
		private Builder(SwedishAnalyzer instance) {
	 ...
	 */
	public static final JsonpDeserializer<SwedishAnalyzer> _DESERIALIZER = ObjectBuilderDeserializer.lazy(Builder::new,
			SwedishAnalyzer::setupSwedishAnalyzerDeserializer);

	protected static void setupSwedishAnalyzerDeserializer(ObjectDeserializer<SwedishAnalyzer.Builder> op) {
