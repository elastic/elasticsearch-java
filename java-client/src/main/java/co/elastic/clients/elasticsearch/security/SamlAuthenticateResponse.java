...
public class SamlAuthenticateResponse implements JsonpSerializable {
	...
	/**
	 * Required - The access token that was generated by Elasticsearch.
	 * <p>
	...
	/**
	 * Required - The amount of time (in seconds) left until the token expires.
	 * <p>
	...
	/**
	 * Required - The refresh token that was generated by Elasticsearch.
	 * <p>
	...
	/**
	 * Required - The name of the realm where the user was authenticated.
	 * <p>
	 * API name: {@code realm}
	 */
