...
// typedef: inference._types.AnthropicServiceSettings

/**
 *
 * @see <a href=
 *      "../doc-files/api-spec.html#inference._types.AnthropicServiceSettings">API
 *      specification</a>
 */
@JsonpDeserializable
public class AnthropicServiceSettings implements JsonpSerializable {
	...
	public static class Builder extends WithJsonObjectBuilderBase<Builder>
		...
		private Builder(AnthropicServiceSettings instance) {
