...
public final class IndicesShardStores implements ToJsonp {
	...
	/**
	 * Json parser for IndicesShardStores
	 */
	public static final JsonpValueParser<IndicesShardStores> JSONP_PARSER = JsonpObjectBuilderParser
			.createForObject(Builder::new, IndicesShardStores::setupIndicesShardStoresParser);

	protected static void setupIndicesShardStoresParser(DelegatingJsonpValueParser<IndicesShardStores.Builder> op) {

		op.add(Builder::shards, JsonpValueParser.stringMapParser(ShardStoreWrapper.JSONP_PARSER), "shards");
