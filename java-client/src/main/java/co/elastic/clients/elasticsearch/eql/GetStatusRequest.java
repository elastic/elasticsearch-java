...
public class GetStatusRequest extends RequestBase {
	...
	private GetStatusRequest(Builder builder) {

		this.id = ModelTypeHelper.requireNonNull(builder.id, this, "id");

	}

	public static GetStatusRequest of(Function<Builder, ObjectBuilder<GetStatusRequest>> fn) {
	...
	/**
	 * Builder for {@link GetStatusRequest}.
	 */
	public static class Builder extends ObjectBuilderBase implements ObjectBuilder<GetStatusRequest> {
		private String id;
		...
		/**
		 * Builds a {@link GetStatusRequest}.
		 *
