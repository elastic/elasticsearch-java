...
// typedef: logstash.pipeline_get.Request
public final class PipelineGetRequest extends RequestBase implements ToJsonp {
	...
	protected PipelineGetRequest(Builder builder) {
	...
	/**
	 * Builder for {@link PipelineGetRequest}.
	 */
	public static class Builder implements ObjectBuilder<PipelineGetRequest> {
		...
		/**
		 * Builds a {@link PipelineGetRequest}.
		 *
		...
		public PipelineGetRequest build() {
			...
			return new PipelineGetRequest(this);
		}
	}
	...
	/**
	 * Json deserializer for PipelineGetRequest
	 */
	public static final JsonpDeserializer<PipelineGetRequest> DESERIALIZER = ObjectBuilderDeserializer
			.createForObject(Builder::new, PipelineGetRequest::setupPipelineGetRequestDeserializer);

	protected static void setupPipelineGetRequestDeserializer(DelegatingDeserializer<PipelineGetRequest.Builder> op) {
	...
	public static final Endpoint<PipelineGetRequest, PipelineGetResponse, ElasticsearchError> ENDPOINT = new Endpoint.Simple<>(
			...
			}, Endpoint.Simple.emptyMap(), true, PipelineGetResponse.DESERIALIZER);
}
