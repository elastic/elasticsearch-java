...
package co.elastic.clients.elasticsearch.inference.put_cohere;
...
// typedef: inference.put_cohere.CohereServiceSettings

/**
 *
 * @see <a href=
 *      "../../doc-files/api-spec.html#inference.put_cohere.CohereServiceSettings">API
 *      specification</a>
 */
@JsonpDeserializable
public class CohereServiceSettings implements JsonpSerializable {
	 ...
	 */
	@Nullable
	public final EmbeddingType embeddingType() {
	 ...
	 */
	@Nullable
	public final SimilarityType similarity() {
	...
	public static class Builder extends WithJsonObjectBuilderBase<Builder>
		 ...
		 * API name: {@code embedding_type}
		 */
		public final Builder embeddingType(@Nullable EmbeddingType value) {
		 ...
		 * API name: {@code similarity}
		 */
		public final Builder similarity(@Nullable SimilarityType value) {
	...
	protected static void setupCohereServiceSettingsDeserializer(ObjectDeserializer<CohereServiceSettings.Builder> op) {
		...
		op.add(Builder::embeddingType, EmbeddingType._DESERIALIZER, "embedding_type");
		op.add(Builder::modelId, JsonpDeserializer.stringDeserializer(), "model_id");
		op.add(Builder::rateLimit, RateLimitSetting._DESERIALIZER, "rate_limit");
		op.add(Builder::similarity, SimilarityType._DESERIALIZER, "similarity");
