 ...
 */
public class RollupApiClient extends ApiClient<RollupApiClient> {

	public RollupApiClient(Transport transport) {
		super(transport, null);
	}

	public RollupApiClient(Transport transport, RequestOptions options) {
	...
	/**
	 * Creates a new {@link #RollupApiClient} with specific request options.
	 */
	@Override
	public RollupApiClient withRequestOptions(@Nullable RequestOptions options) {
		return new RollupApiClient(transport, options);
	}
	 ...
	 */
	public RollupApiClient withRequestOptions(Function<RequestOptions.Builder, RequestOptions.Builder> fn) {
