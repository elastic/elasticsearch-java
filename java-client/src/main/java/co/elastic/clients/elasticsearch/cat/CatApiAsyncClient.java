 ...
 */
public class CatApiAsyncClient extends ApiClient<CatApiAsyncClient> {

	public CatApiAsyncClient(Transport transport) {
		super(transport, null);
	}

	public CatApiAsyncClient(Transport transport, RequestOptions options) {
	...
	/**
	 * Creates a new {@link #CatApiAsyncClient} with specific request options.
	 */
	@Override
	public CatApiAsyncClient withRequestOptions(@Nullable RequestOptions options) {
		return new CatApiAsyncClient(transport, options);
	}
	 ...
	 */
	public CatApiAsyncClient withRequestOptions(Function<RequestOptions.Builder, RequestOptions.Builder> fn) {
