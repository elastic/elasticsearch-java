...
public final class GetAutoscalingCapacityRequest extends RequestBase {
	protected GetAutoscalingCapacityRequest() {
	}
	 ...
	 */
	public static final Endpoint<GetAutoscalingCapacityRequest, GetAutoscalingCapacityResponse, ElasticsearchError> ENDPOINT = new Endpoint.Simple<>(
			// Request method
			request -> {
				return "GET";
