...
public class GoogleVertexAIServiceSettings implements JsonpSerializable {
	...
	/**
	 * Only applicable for the <code>text_embedding</code> task type. Controls the
	 * batch size of chunked inference requests sent to Google Vertex AI.
	 * <p>
	 ...
	 * <p>
	 * To estimate a safe <code>max_batch_size</code> value, you can use it together
	 * with the <code>max_chunk_size</code> parameter using the following formula:
	 * <code>max_batch_size ≈ max_chunk_size × 1.3 × 512 ÷ 20000</code>
	 * <p>
	 * Where:
	 * <ul>
	 * <li><code>1.3</code> is an approximate tokens-per-word ratio</li>
	 * <li><code>512</code> is the maximum number of chunks that can be generated
	 * per document</li>
	 * <li><code>20000</code> is the Google Vertex AI token limit per request</li>
	 * </ul>
	 * <p>
	...
	public static class Builder extends WithJsonObjectBuilderBase<Builder>
		 ...
		 * API name: {@code max_batch_size}
		 */
		public final Builder maxBatchSize(@Nullable Integer value) {
	...
	protected static void setupGoogleVertexAIServiceSettingsDeserializer(
		...
		op.add(Builder::maxBatchSize, JsonpDeserializer.integerDeserializer(), "max_batch_size");
