...
// typedef: ml.post_job_data.Response
public final class PostJobDataResponse implements ToJsonp {
	...
	protected PostJobDataResponse(Builder builder) {
	...
	/**
	 * Builder for {@link PostJobDataResponse}.
	 */
	public static class Builder implements ObjectBuilder<PostJobDataResponse> {
		...
		/**
		 * Builds a {@link PostJobDataResponse}.
		 *
		 * @throws NullPointerException
		 *             if some of the required fields are null.
		 */
		public PostJobDataResponse build() {

			return new PostJobDataResponse(this);
		}
	}
	...
	/**
	 * Json deserializer for PostJobDataResponse
	 */
	public static final JsonpDeserializer<PostJobDataResponse> DESERIALIZER = ObjectBuilderDeserializer
			.createForObject(Builder::new, PostJobDataResponse::setupPostJobDataResponseDeserializer);

	protected static void setupPostJobDataResponseDeserializer(DelegatingDeserializer<PostJobDataResponse.Builder> op) {
