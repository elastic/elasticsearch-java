...
public class ElasticsearchGraphClient extends ApiClient<ElasticsearchTransport, ElasticsearchGraphClient> {
	 ...
	 * to understand the behaviour of this API is to use the Graph UI to explore
	 ...
	 * 
	 * @see <a href=
	 *      "https://www.elastic.co/guide/en/elasticsearch/reference/8.18/graph-explore-api.html">Documentation
	 *      on elastic.co</a>
	 */
