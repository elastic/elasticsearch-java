 ...
 *
 * @see <a href=
 *      "../../doc-files/api-spec.html#_types.analysis.SynonymTokenFilter">API
 *      specification</a>
 */
@JsonpDeserializable
public class SynonymTokenFilter extends SynonymTokenFilterBase implements TokenFilterDefinitionVariant {
	// ---------------------------------------------------------------------------------------------
	...
	public static class Builder extends SynonymTokenFilterBase.AbstractBuilder<Builder>
		...
		private Builder(SynonymTokenFilter instance) {
	...
	protected static void setupSynonymTokenFilterDeserializer(ObjectDeserializer<SynonymTokenFilter.Builder> op) {
		SynonymTokenFilterBase.setupSynonymTokenFilterBaseDeserializer(op);
