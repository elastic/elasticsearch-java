...
// typedef: project.get_many_routing.Response

/**
 *
 * @see <a href=
 *      "../doc-files/api-spec.html#project.get_many_routing.Response">API
 *      specification</a>
 */
@JsonpDeserializable
public class GetManyRoutingResponse implements JsonpSerializable {
	private final Map<String, ProjectRoutingExpression> result;

	// ---------------------------------------------------------------------------------------------

	private GetManyRoutingResponse(Builder builder) {

		this.result = ApiTypeHelper.unmodifiableRequired(builder.result, this, "result");

	}

	public static GetManyRoutingResponse of(Function<Builder, ObjectBuilder<GetManyRoutingResponse>> fn) {
	...
	/**
	 * Builder for {@link GetManyRoutingResponse}.
	 */

	public static class Builder extends WithJsonObjectBuilderBase<Builder>
			implements
				ObjectBuilder<GetManyRoutingResponse> {
		...
		/**
		 * Builds a {@link GetManyRoutingResponse}.
		 *
		 * @throws NullPointerException
		 *             if some of the required fields are null.
		 */
		public GetManyRoutingResponse build() {
			_checkSingleUse();

			return new GetManyRoutingResponse(this);
		}
	}

	public static final JsonpDeserializer<GetManyRoutingResponse> _DESERIALIZER = createGetManyRoutingResponseDeserializer();
	protected static JsonpDeserializer<GetManyRoutingResponse> createGetManyRoutingResponseDeserializer() {
