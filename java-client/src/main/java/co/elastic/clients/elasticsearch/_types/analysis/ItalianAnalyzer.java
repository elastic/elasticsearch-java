 ...
 *
 * @see <a href=
 *      "../../doc-files/api-spec.html#_types.analysis.ItalianAnalyzer">API
 *      specification</a>
 */
@JsonpDeserializable
public class ItalianAnalyzer implements AnalyzerVariant, JsonpSerializable {
	...
	public static class Builder extends WithJsonObjectBuilderBase<Builder> implements ObjectBuilder<ItalianAnalyzer> {
		@Nullable
		...
		private Builder(ItalianAnalyzer instance) {
	 ...
	 */
	public static final JsonpDeserializer<ItalianAnalyzer> _DESERIALIZER = ObjectBuilderDeserializer.lazy(Builder::new,
			ItalianAnalyzer::setupItalianAnalyzerDeserializer);

	protected static void setupItalianAnalyzerDeserializer(ObjectDeserializer<ItalianAnalyzer.Builder> op) {
