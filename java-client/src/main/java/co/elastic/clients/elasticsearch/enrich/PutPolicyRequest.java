...
public final class PutPolicyRequest extends RequestBase implements ToJsonp {
	...
	/**
	 * Json parser for PutPolicyRequest
	 */
	public static final JsonpValueParser<PutPolicyRequest> JSONP_PARSER = JsonpObjectBuilderParser
			.createForObject(Builder::new, PutPolicyRequest::setupPutPolicyRequestParser);

	protected static void setupPutPolicyRequestParser(DelegatingJsonpValueParser<PutPolicyRequest.Builder> op) {
	...
	public static final Endpoint<PutPolicyRequest, PutPolicyResponse, ElasticsearchError> ENDPOINT = new Endpoint.Simple<>(
			...
			}, Endpoint.Simple.emptyMap(), true, PutPolicyResponse.JSONP_PARSER);
}
