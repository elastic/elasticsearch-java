...
public final class ExistsComponentTemplateResponse implements ToJsonp {
	...
	/**
	 * Json parser for ExistsComponentTemplateResponse
	 */
	public static final JsonpValueParser<ExistsComponentTemplateResponse> JSONP_PARSER = JsonpObjectBuilderParser
			.createForObject(Builder::new, ExistsComponentTemplateResponse::setupExistsComponentTemplateResponseParser);

	protected static void setupExistsComponentTemplateResponseParser(
			DelegatingJsonpValueParser<ExistsComponentTemplateResponse.Builder> op) {
