 ...
 */
public class AutoscalingApiClient extends ApiClient<AutoscalingApiClient> {

	public AutoscalingApiClient(Transport transport) {
		super(transport, null);
	}

	public AutoscalingApiClient(Transport transport, RequestOptions options) {
	...
	/**
	 * Creates a new {@link #AutoscalingApiClient} with specific request options.
	 */
	@Override
	public AutoscalingApiClient withRequestOptions(@Nullable RequestOptions options) {
		return new AutoscalingApiClient(transport, options);
	}
	 ...
	 */
	public AutoscalingApiClient withRequestOptions(Function<RequestOptions.Builder, RequestOptions.Builder> fn) {
