 ...
 *
 * @see <a href=
 *      "../../doc-files/api-spec.html#rollup.delete_job.TaskFailureReason">API
 *      specification</a>
 */
@JsonpDeserializable
public class TaskFailureReason implements JsonpSerializable {
	...
	public static class Builder extends WithJsonObjectBuilderBase<Builder> implements ObjectBuilder<TaskFailureReason> {
		private String type;
