...
public final class GetCategoriesResponse implements ToJsonp {
	...
	/**
	 * Json parser for GetCategoriesResponse
	 */
	public static final JsonpValueParser<GetCategoriesResponse> JSONP_PARSER = JsonpObjectBuilderParser
			.createForObject(Builder::new, GetCategoriesResponse::setupGetCategoriesResponseParser);

	protected static void setupGetCategoriesResponseParser(
			DelegatingJsonpValueParser<GetCategoriesResponse.Builder> op) {

		op.add(Builder::categories, JsonpValueParser.arrayParser(Category.JSONP_PARSER), "categories");
