 ...
 *
 * @see <a href=
 *      "../doc-files/api-spec.html#ml._types.DeploymentAllocationState">API
 *      specification</a>
 */
@JsonpDeserializable
public enum DeploymentAllocationState implements JsonEnum {
	...
	DeploymentAllocationState(String jsonValue) {
	...
	public static final JsonEnum.Deserializer<DeploymentAllocationState> _DESERIALIZER = new JsonEnum.Deserializer<>(
			DeploymentAllocationState.values());
}
