 ...
 */
public class TextStructureApiAsyncClient extends ApiClient<TextStructureApiAsyncClient> {

	public TextStructureApiAsyncClient(Transport transport) {
		super(transport, null);
	}

	public TextStructureApiAsyncClient(Transport transport, RequestOptions options) {
	...
	/**
	 * Creates a new {@link #TextStructureApiAsyncClient} with specific request
	 * options.
	 */
	@Override
	public TextStructureApiAsyncClient withRequestOptions(@Nullable RequestOptions options) {
		return new TextStructureApiAsyncClient(transport, options);
	}
	 ...
	 */
	public TextStructureApiAsyncClient withRequestOptions(Function<RequestOptions.Builder, RequestOptions.Builder> fn) {
