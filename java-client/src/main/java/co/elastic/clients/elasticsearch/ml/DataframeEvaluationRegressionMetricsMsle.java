...
public final class DataframeEvaluationRegressionMetricsMsle implements ToJsonp {
	...
	/**
	 * Json parser for DataframeEvaluationRegressionMetricsMsle
	 */
	public static final JsonpValueParser<DataframeEvaluationRegressionMetricsMsle> JSONP_PARSER = JsonpObjectBuilderParser
			.createForObject(Builder::new,
					DataframeEvaluationRegressionMetricsMsle::setupDataframeEvaluationRegressionMetricsMsleParser);

	protected static void setupDataframeEvaluationRegressionMetricsMsleParser(
			DelegatingJsonpValueParser<DataframeEvaluationRegressionMetricsMsle.Builder> op) {
