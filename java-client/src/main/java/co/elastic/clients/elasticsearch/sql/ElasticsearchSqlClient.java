...
public class ElasticsearchSqlClient extends ApiClient<ElasticsearchTransport, ElasticsearchSqlClient> {
	 ...
	 * 
	 * @see <a href=
	 *      "https://www.elastic.co/docs/api/doc/elasticsearch/v9/operation-sql-clear-cursor">Documentation
	 *      on elastic.co</a>
	 */
	 ...
	 *
	 * @see <a href=
	 *      "https://www.elastic.co/docs/api/doc/elasticsearch/v9/operation-sql-delete-async">Documentation
	 *      on elastic.co</a>
	 */
	 ...
	 * 
	 * @see <a href=
	 *      "https://www.elastic.co/docs/api/doc/elasticsearch/v9/operation-sql-get-async">Documentation
	 *      on elastic.co</a>
	 */
	 ...
	 * 
	 * @see <a href=
	 *      "https://www.elastic.co/docs/api/doc/elasticsearch/v9/operation-sql-get-async-status">Documentation
	 *      on elastic.co</a>
	 */
	 ...
	 * 
	 * @see <a href=
	 *      "https://www.elastic.co/docs/api/doc/elasticsearch/v9/operation-sql-query">Documentation
	 *      on elastic.co</a>
	 */
	 ...
	 * 
	 * @see <a href=
	 *      "https://www.elastic.co/docs/api/doc/elasticsearch/v9/operation-sql-translate">Documentation
	 *      on elastic.co</a>
	 */
