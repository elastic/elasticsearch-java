...
public class SyncJobConnectorReference implements JsonpSerializable {
	...
	private final Map<String, JsonData> syncCursor;
	...
	private SyncJobConnectorReference(Builder builder) {
		...
		this.syncCursor = ApiTypeHelper.unmodifiable(builder.syncCursor);
	 ...
	 */
	public final Map<String, JsonData> syncCursor() {
	...
	protected void serializeInternal(JsonGenerator generator, JsonpMapper mapper) {
		...
		if (ApiTypeHelper.isDefined(this.syncCursor)) {
			generator.writeKey("sync_cursor");
			generator.writeStartObject();
			for (Map.Entry<String, JsonData> item0 : this.syncCursor.entrySet()) {
				generator.writeKey(item0.getKey());
				item0.getValue().serialize(generator, mapper);
	...
	public static class Builder extends WithJsonObjectBuilderBase<Builder>
		...
		@Nullable
		private Map<String, JsonData> syncCursor;
		 ...
		 * API name: {@code sync_cursor}
		 * <p>
		 * Adds all entries of <code>map</code> to <code>syncCursor</code>.
		 */
		public final Builder syncCursor(Map<String, JsonData> map) {
			this.syncCursor = _mapPutAll(this.syncCursor, map);
			return this;
		}
		 ...
		 * API name: {@code sync_cursor}
		 * <p>
		 * Adds an entry to <code>syncCursor</code>.
		 */
		public final Builder syncCursor(String key, JsonData value) {
			this.syncCursor = _mapPut(this.syncCursor, key, value);
			return this;
		}
	...
	protected static void setupSyncJobConnectorReferenceDeserializer(
		...
		op.add(Builder::syncCursor, JsonpDeserializer.stringMapDeserializer(JsonData._DESERIALIZER), "sync_cursor");
