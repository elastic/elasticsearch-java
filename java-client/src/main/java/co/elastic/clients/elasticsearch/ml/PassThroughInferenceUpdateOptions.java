 ...
 *
 * @see <a href=
 *      "../doc-files/api-spec.html#ml._types.PassThroughInferenceUpdateOptions">API
 *      specification</a>
 */
@JsonpDeserializable
public class PassThroughInferenceUpdateOptions implements InferenceConfigUpdateVariant, JsonpSerializable {
	...
	private PassThroughInferenceUpdateOptions(Builder builder) {
	...
	public static PassThroughInferenceUpdateOptions of(
			Function<Builder, ObjectBuilder<PassThroughInferenceUpdateOptions>> fn) {
	...
	/**
	 * Builder for {@link PassThroughInferenceUpdateOptions}.
	 */

	public static class Builder extends WithJsonObjectBuilderBase<Builder>
			implements
				ObjectBuilder<PassThroughInferenceUpdateOptions> {
		@Nullable
		...
		/**
		 * Builds a {@link PassThroughInferenceUpdateOptions}.
		 *
		 * @throws NullPointerException
		 *             if some of the required fields are null.
		 */
		public PassThroughInferenceUpdateOptions build() {
			_checkSingleUse();

			return new PassThroughInferenceUpdateOptions(this);
		}
	}
	...
	/**
	 * Json deserializer for {@link PassThroughInferenceUpdateOptions}
	 */
	public static final JsonpDeserializer<PassThroughInferenceUpdateOptions> _DESERIALIZER = ObjectBuilderDeserializer
			.lazy(Builder::new, PassThroughInferenceUpdateOptions::setupPassThroughInferenceUpdateOptionsDeserializer);

	protected static void setupPassThroughInferenceUpdateOptionsDeserializer(
			ObjectDeserializer<PassThroughInferenceUpdateOptions.Builder> op) {
