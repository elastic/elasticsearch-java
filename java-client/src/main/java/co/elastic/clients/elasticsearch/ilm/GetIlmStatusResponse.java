 ...
 *
 * @see <a href=
 *      "https://github.com/elastic/elasticsearch-specification/tree/bd953a3fc/specification/ilm/get_status/GetIlmStatusResponse.ts#L22-L24">API
 *      specification</a>
 */
@JsonpDeserializable
public class GetIlmStatusResponse implements JsonpSerializable {
	...
	public static class Builder extends ObjectBuilderBase implements ObjectBuilder<GetIlmStatusResponse> {
