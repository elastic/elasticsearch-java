...
public final class CapacityGetRequest extends RequestBase implements ToJsonp {
	...
	/**
	 * Json parser for CapacityGetRequest
	 */
	public static final JsonpValueParser<CapacityGetRequest> JSONP_PARSER = JsonpObjectBuilderParser
			.createForObject(Builder::new, CapacityGetRequest::setupCapacityGetRequestParser);

	protected static void setupCapacityGetRequestParser(DelegatingJsonpValueParser<CapacityGetRequest.Builder> op) {
	...
	public static final Endpoint<CapacityGetRequest, CapacityGetResponse, ElasticsearchError> ENDPOINT = new Endpoint.Simple<>(
			...
			}, Endpoint.Simple.emptyMap(), true, CapacityGetResponse.JSONP_PARSER);
}
