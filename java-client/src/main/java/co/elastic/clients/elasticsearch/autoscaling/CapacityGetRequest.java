...
// typedef: autoscaling.capacity_get.Request
public final class CapacityGetRequest extends RequestBase implements ToJsonp {
	...
	protected CapacityGetRequest(Builder builder) {
	...
	/**
	 * Builder for {@link CapacityGetRequest}.
	 */
	public static class Builder implements ObjectBuilder<CapacityGetRequest> {
		...
		/**
		 * Builds a {@link CapacityGetRequest}.
		 *
		 * @throws NullPointerException
		 *             if some of the required fields are null.
		 */
		public CapacityGetRequest build() {

			return new CapacityGetRequest(this);
		}
	}
	...
	/**
	 * Json deserializer for CapacityGetRequest
	 */
	public static final JsonpDeserializer<CapacityGetRequest> DESERIALIZER = ObjectBuilderDeserializer
			.createForObject(Builder::new, CapacityGetRequest::setupCapacityGetRequestDeserializer);

	protected static void setupCapacityGetRequestDeserializer(DelegatingDeserializer<CapacityGetRequest.Builder> op) {
	...
	public static final Endpoint<CapacityGetRequest, CapacityGetResponse, ElasticsearchError> ENDPOINT = new Endpoint.Simple<>(
			...
			}, Endpoint.Simple.emptyMap(), true, CapacityGetResponse.DESERIALIZER);
}
