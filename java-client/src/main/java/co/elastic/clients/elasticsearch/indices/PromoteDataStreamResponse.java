 ...
 *
 * @see <a href=
 *      "../doc-files/api-spec.html#indices.promote_data_stream.Response">API
 *      specification</a>
 */
@JsonpDeserializable
public class PromoteDataStreamResponse implements JsonpSerializable {
	private final JsonData result;
	...
	public static class Builder extends WithJsonObjectBuilderBase<Builder>
			implements
				ObjectBuilder<PromoteDataStreamResponse> {
		private JsonData result;

		/**
		 * Required - Response value.
		 */
		public final Builder result(JsonData value) {
			this.result = value;
			return this;
		}
