 ...
 *
 * @see <a href=
 *      "https://github.com/elastic/elasticsearch-specification/tree/bd953a3fc/specification/security/_types/RealmInfo.ts#L22-L25">API
 *      specification</a>
 */
@JsonpDeserializable
public class RealmInfo implements JsonpSerializable {
	...
	public static class Builder extends ObjectBuilderBase implements ObjectBuilder<RealmInfo> {
		private String name;
