...
/**
 *
 * @see <a href="../doc-files/api-spec.html#tasks._types.State">API
 *      specification</a>
 */
@JsonpDeserializable
public class State implements JsonpSerializable {
	...
	public static class Builder extends WithJsonObjectBuilderBase<Builder> implements ObjectBuilder<State> {
