...
public class ElasticsearchTextStructureClient
	 ...
	 * 
	 * @see <a href=
	 *      "https://www.elastic.co/docs/api/doc/elasticsearch/v9/operation-text-structure-find-message-structure">Documentation
	 *      on elastic.co</a>
	 */
	 ...
	 * 
	 * @see <a href=
	 *      "https://www.elastic.co/docs/api/doc/elasticsearch/v9/operation-text-structure-test-grok-pattern">Documentation
	 *      on elastic.co</a>
	 */
