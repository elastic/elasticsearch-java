...
public class ElasticsearchFleetClient extends ApiClient<ElasticsearchTransport, ElasticsearchFleetClient> {
	 ...
	 * 
	 * @see <a href=
	 *      "https://www.elastic.co/guide/en/elasticsearch/reference/8.18/fleet-search.html">Documentation
	 *      on elastic.co</a>
	 */
	...
	public FleetSearchResponse<Void> search(FleetSearchRequest request) throws IOException, ElasticsearchException {
		@SuppressWarnings("unchecked")
	...
	public final FleetSearchResponse<Void> search(
