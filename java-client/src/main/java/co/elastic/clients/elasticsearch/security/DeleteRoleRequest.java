...
public final class DeleteRoleRequest extends RequestBase {
	 ...
	 */
	public static class Builder implements ObjectBuilder<DeleteRoleRequest> {
		private String name;
	 ...
	 */
	public static final Endpoint<DeleteRoleRequest, DeleteRoleResponse, ElasticsearchError> ENDPOINT = new Endpoint.Simple<>(
			// Request method
			request -> {
				return "DELETE";
			...
			}, Endpoint.Simple.emptyMap(), false, DeleteRoleResponse._DESERIALIZER);
}
