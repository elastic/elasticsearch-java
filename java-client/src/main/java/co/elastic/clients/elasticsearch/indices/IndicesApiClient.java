 ...
 */
public class IndicesApiClient extends ApiClient<IndicesApiClient> {

	public IndicesApiClient(Transport transport) {
		super(transport, null);
	}

	public IndicesApiClient(Transport transport, RequestOptions options) {
	...
	public DiskUsageResponse diskUsage(DiskUsageRequest request) throws IOException {
		return this.transport.performRequest(request, DiskUsageRequest.ENDPOINT, this.requestOptions);
	}
	...
	/**
	 * Creates a new {@link #IndicesApiClient} with specific request options.
	 */
	@Override
	public IndicesApiClient withRequestOptions(@Nullable RequestOptions options) {
		return new IndicesApiClient(transport, options);
	}
	 ...
	 */
	public IndicesApiClient withRequestOptions(Function<RequestOptions.Builder, RequestOptions.Builder> fn) {
