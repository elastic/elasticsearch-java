...
public final class Definition implements ToJsonp {
	@Nullable
	...
	protected Definition(Builder builder) {
	...
	protected void toJsonpInternal(JsonGenerator generator, JsonpMapper mapper) {
		...
		this.trainedModel.toJsonp(generator, mapper);
	...
	/**
	 * Json deserializer for Definition
	 */
