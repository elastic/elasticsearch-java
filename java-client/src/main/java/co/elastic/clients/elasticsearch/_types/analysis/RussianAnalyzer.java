 ...
 *
 * @see <a href=
 *      "../../doc-files/api-spec.html#_types.analysis.RussianAnalyzer">API
 *      specification</a>
 */
@JsonpDeserializable
public class RussianAnalyzer implements AnalyzerVariant, JsonpSerializable {
	...
	public static class Builder extends WithJsonObjectBuilderBase<Builder> implements ObjectBuilder<RussianAnalyzer> {
		@Nullable
		...
		private Builder(RussianAnalyzer instance) {
	 ...
	 */
	public static final JsonpDeserializer<RussianAnalyzer> _DESERIALIZER = ObjectBuilderDeserializer.lazy(Builder::new,
			RussianAnalyzer::setupRussianAnalyzerDeserializer);

	protected static void setupRussianAnalyzerDeserializer(ObjectDeserializer<RussianAnalyzer.Builder> op) {
