...
public final class GetScriptContextRequest extends RequestBase {
	...
	public static final JsonpValueParser<GetScriptContextRequest> JSONP_PARSER = JsonpValueParser
	...
	public static final Endpoint<GetScriptContextRequest, GetScriptContextResponse, ElasticsearchError> ENDPOINT = new Endpoint.Simple<>(
			...
			}, Endpoint.Simple.emptyMap(), false, GetScriptContextResponse.JSONP_PARSER);
}
