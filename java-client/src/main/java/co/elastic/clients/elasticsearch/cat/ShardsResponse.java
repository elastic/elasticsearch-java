...
public class ShardsResponse implements JsonpSerializable {
	...
	public static ShardsResponse of(Consumer<Builder> fn) {
	...
	public static class Builder extends ObjectBuilderBase implements ObjectBuilder<ShardsResponse> {
		...
		public final Builder valueBody(
				Function<ListBuilder<ShardsRecord, ShardsRecord.Builder>, ObjectBuilder<List<ShardsRecord>>> fn) {
			return valueBody(fn.apply(new ListBuilder<>(ShardsRecord.Builder::new)).build());
		}
