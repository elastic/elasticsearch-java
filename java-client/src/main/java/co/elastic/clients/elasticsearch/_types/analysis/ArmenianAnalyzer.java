 ...
 *
 * @see <a href=
 *      "../../doc-files/api-spec.html#_types.analysis.ArmenianAnalyzer">API
 *      specification</a>
 */
@JsonpDeserializable
public class ArmenianAnalyzer implements AnalyzerVariant, JsonpSerializable {
	...
	public static class Builder extends WithJsonObjectBuilderBase<Builder> implements ObjectBuilder<ArmenianAnalyzer> {
		@Nullable
		...
		private Builder(ArmenianAnalyzer instance) {
	 ...
	 */
	public static final JsonpDeserializer<ArmenianAnalyzer> _DESERIALIZER = ObjectBuilderDeserializer.lazy(Builder::new,
			ArmenianAnalyzer::setupArmenianAnalyzerDeserializer);

	protected static void setupArmenianAnalyzerDeserializer(ObjectDeserializer<ArmenianAnalyzer.Builder> op) {
