...
public final class SetUpgradeModeResponse extends AcknowledgedResponseBase {
	...
	/**
	 * Json parser for SetUpgradeModeResponse
	 */
	public static final JsonpValueParser<SetUpgradeModeResponse> JSONP_PARSER = JsonpObjectBuilderParser
			.createForObject(Builder::new, SetUpgradeModeResponse::setupSetUpgradeModeResponseParser);

	protected static void setupSetUpgradeModeResponseParser(
			DelegatingJsonpValueParser<SetUpgradeModeResponse.Builder> op) {
