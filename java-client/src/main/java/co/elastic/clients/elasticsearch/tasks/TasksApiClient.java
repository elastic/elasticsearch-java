 ...
 */
public class TasksApiClient extends ApiClient<TasksApiClient> {

	public TasksApiClient(Transport transport) {
		super(transport, null);
	}

	public TasksApiClient(Transport transport, RequestOptions options) {
	...
	/**
	 * Creates a new {@link #TasksApiClient} with specific request options.
	 */
	@Override
	public TasksApiClient withRequestOptions(@Nullable RequestOptions options) {
		return new TasksApiClient(transport, options);
	}
	 ...
	 */
	public TasksApiClient withRequestOptions(Function<RequestOptions.Builder, RequestOptions.Builder> fn) {
