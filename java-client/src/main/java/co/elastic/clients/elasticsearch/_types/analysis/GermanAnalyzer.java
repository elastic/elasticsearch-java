 ...
 *
 * @see <a href=
 *      "../../doc-files/api-spec.html#_types.analysis.GermanAnalyzer">API
 *      specification</a>
 */
@JsonpDeserializable
public class GermanAnalyzer implements AnalyzerVariant, JsonpSerializable {
	...
	public static class Builder extends WithJsonObjectBuilderBase<Builder> implements ObjectBuilder<GermanAnalyzer> {
		@Nullable
		...
		private Builder(GermanAnalyzer instance) {
	 ...
	 */
	public static final JsonpDeserializer<GermanAnalyzer> _DESERIALIZER = ObjectBuilderDeserializer.lazy(Builder::new,
			GermanAnalyzer::setupGermanAnalyzerDeserializer);

	protected static void setupGermanAnalyzerDeserializer(ObjectDeserializer<GermanAnalyzer.Builder> op) {
