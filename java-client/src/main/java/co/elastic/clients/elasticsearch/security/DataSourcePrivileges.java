...
// typedef: security._types.DataSourcePrivileges

/**
 *
 * @see <a href=
 *      "../doc-files/api-spec.html#security._types.DataSourcePrivileges">API
 *      specification</a>
 */
@JsonpDeserializable
public class DataSourcePrivileges implements JsonpSerializable {
	...
	private DataSourcePrivileges(Builder builder) {
	...
	public static DataSourcePrivileges of(Function<Builder, ObjectBuilder<DataSourcePrivileges>> fn) {
		return fn.apply(new Builder()).build();
	}

	/**
	 * Required - A list of data source names or wildcard patterns to which the
	...
	/**
	 * Required - The data source privileges that owners of the role have for the
	...
	/**
	 * Builder for {@link DataSourcePrivileges}.
	 */

	public static class Builder extends WithJsonObjectBuilderBase<Builder>
			implements
				ObjectBuilder<DataSourcePrivileges> {
		...
		private Builder(DataSourcePrivileges instance) {
		 ...
		 */
		public final Builder privileges(DataSourcePrivilege value, DataSourcePrivilege... values) {
			this.privileges = _listAdd(this.privileges, value.jsonValue(),
					Arrays.stream(values).map(DataSourcePrivilege::jsonValue).toArray(String[]::new));
			return this;
		}
		...
		/**
		 * Builds a {@link DataSourcePrivileges}.
		 *
		 * @throws NullPointerException
		 *             if some of the required fields are null.
		 */
		public DataSourcePrivileges build() {
			_checkSingleUse();

			return new DataSourcePrivileges(this);
		}
	}
	...
	/**
	 * Json deserializer for {@link DataSourcePrivileges}
	 */
	public static final JsonpDeserializer<DataSourcePrivileges> _DESERIALIZER = ObjectBuilderDeserializer
			.lazy(Builder::new, DataSourcePrivileges::setupDataSourcePrivilegesDeserializer);

	protected static void setupDataSourcePrivilegesDeserializer(ObjectDeserializer<DataSourcePrivileges.Builder> op) {
