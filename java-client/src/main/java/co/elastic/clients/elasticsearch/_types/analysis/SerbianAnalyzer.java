...
// typedef: _types.analysis.SerbianAnalyzer

/**
 *
 * @see <a href=
 *      "../../doc-files/api-spec.html#_types.analysis.SerbianAnalyzer">API
 *      specification</a>
 */
@JsonpDeserializable
public class SerbianAnalyzer implements AnalyzerVariant, JsonpSerializable {
	...
	private SerbianAnalyzer(Builder builder) {
	...
	public static SerbianAnalyzer of(Function<Builder, ObjectBuilder<SerbianAnalyzer>> fn) {
	...
	/**
	 * Builder for {@link SerbianAnalyzer}.
	 */

	public static class Builder extends WithJsonObjectBuilderBase<Builder> implements ObjectBuilder<SerbianAnalyzer> {
		@Nullable
		...
		private Builder(SerbianAnalyzer instance) {
		...
		/**
		 * Builds a {@link SerbianAnalyzer}.
		 *
		 * @throws NullPointerException
		 *             if some of the required fields are null.
		 */
		public SerbianAnalyzer build() {
			_checkSingleUse();

			return new SerbianAnalyzer(this);
		}
	}
	...
	/**
	 * Json deserializer for {@link SerbianAnalyzer}
	 */
	public static final JsonpDeserializer<SerbianAnalyzer> _DESERIALIZER = ObjectBuilderDeserializer.lazy(Builder::new,
			SerbianAnalyzer::setupSerbianAnalyzerDeserializer);

	protected static void setupSerbianAnalyzerDeserializer(ObjectDeserializer<SerbianAnalyzer.Builder> op) {
