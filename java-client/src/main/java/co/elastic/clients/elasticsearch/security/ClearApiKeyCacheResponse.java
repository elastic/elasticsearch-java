 ...
 *
 * @see <a href=
 *      "https://github.com/elastic/elasticsearch-specification/tree/bd953a3fc/specification/security/clear_api_key_cache/SecurityClearApiKeyCacheResponse.ts#L25-L32">API
 *      specification</a>
 */
@JsonpDeserializable
public class ClearApiKeyCacheResponse implements JsonpSerializable {
	...
	public static class Builder extends ObjectBuilderBase implements ObjectBuilder<ClearApiKeyCacheResponse> {
