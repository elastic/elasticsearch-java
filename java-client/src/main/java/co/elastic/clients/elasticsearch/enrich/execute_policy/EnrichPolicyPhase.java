 ...
 *
 * @see <a href=
 *      "https://github.com/elastic/elasticsearch-specification/tree/bd953a3fc/specification/enrich/execute_policy/types.ts#L24-L29">API
 *      specification</a>
 */
@JsonpDeserializable
public enum EnrichPolicyPhase implements JsonEnum {
	...
	EnrichPolicyPhase(String jsonValue) {
