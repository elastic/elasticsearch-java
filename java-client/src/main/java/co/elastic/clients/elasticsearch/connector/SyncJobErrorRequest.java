 ...
 * 
 * @see <a href=
 *      "../doc-files/api-spec.html#connector.sync_job_error.Request">API
 *      specification</a>
 */
@JsonpDeserializable
public class SyncJobErrorRequest extends RequestBase implements JsonpSerializable {
	...
	/**
	 * Required - The error for the connector sync job error field.
	 * <p>
	 * API name: {@code error}
	 */
	...
	/**
	 * Builder for {@link SyncJobErrorRequest}.
	 */

	public static class Builder extends RequestBase.AbstractBuilder<Builder>
			implements
				ObjectBuilder<SyncJobErrorRequest> {
		...
		/**
		 * Builds a {@link SyncJobErrorRequest}.
		 *
	...
	/**
	 * Json deserializer for {@link SyncJobErrorRequest}
	 */
	public static final JsonpDeserializer<SyncJobErrorRequest> _DESERIALIZER = ObjectBuilderDeserializer
			.lazy(Builder::new, SyncJobErrorRequest::setupSyncJobErrorRequestDeserializer);
	...
	/**
	 * Endpoint "{@code connector.sync_job_error}".
	 */
	public static final Endpoint<SyncJobErrorRequest, SyncJobErrorResponse, ErrorResponse> _ENDPOINT = new SimpleEndpoint<>(
			"es/connector.sync_job_error",
			...
			}, SimpleEndpoint.emptyMap(), true, SyncJobErrorResponse._DESERIALIZER);
}
