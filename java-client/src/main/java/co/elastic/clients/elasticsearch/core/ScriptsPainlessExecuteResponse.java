 ...
 *
 * @see <a href=
 *      "https://github.com/elastic/elasticsearch-specification/tree/bd953a3fc/specification/_global/scripts_painless_execute/ExecutePainlessScriptResponse.ts#L20-L24">API
 *      specification</a>
 */
@JsonpDeserializable
