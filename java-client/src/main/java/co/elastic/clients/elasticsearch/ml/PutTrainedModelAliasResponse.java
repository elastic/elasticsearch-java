...
public final class PutTrainedModelAliasResponse extends AcknowledgedResponseBase {
	...
	public static class Builder extends AcknowledgedResponseBase.AbstractBuilder<Builder>
		...
		/**
		 * Builds a {@link PutTrainedModelAliasResponse}.
		 *
	...
	/**
	 * Json parser for PutTrainedModelAliasResponse
	 */
	public static final JsonpValueParser<PutTrainedModelAliasResponse> JSONP_PARSER = JsonpObjectBuilderParser
			.createForObject(Builder::new, PutTrainedModelAliasResponse::setupPutTrainedModelAliasResponseParser);

	protected static void setupPutTrainedModelAliasResponseParser(
			DelegatingJsonpValueParser<PutTrainedModelAliasResponse.Builder> op) {
