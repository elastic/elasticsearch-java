...
public final class MigrateToDataStreamResponse extends AcknowledgedResponseBase {
	...
	/**
	 * Json parser for MigrateToDataStreamResponse
	 */
	public static final JsonpValueParser<MigrateToDataStreamResponse> JSONP_PARSER = JsonpObjectBuilderParser
			.createForObject(Builder::new, MigrateToDataStreamResponse::setupMigrateToDataStreamResponseParser);

	protected static void setupMigrateToDataStreamResponseParser(
			DelegatingJsonpValueParser<MigrateToDataStreamResponse.Builder> op) {
