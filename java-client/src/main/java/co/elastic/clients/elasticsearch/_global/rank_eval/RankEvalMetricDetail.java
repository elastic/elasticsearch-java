...
public final class RankEvalMetricDetail implements ToJsonp {
	...
	private final Map<String, Map<String, JsonValue>> metricDetails;

	// ---------------------------------------------------------------------------------------------

	protected RankEvalMetricDetail(Builder builder) {
	...
	protected void toJsonpInternal(JsonGenerator generator, JsonpMapper mapper) {
		...
		generator.writeStartObject();
		for (Map.Entry<String, Map<String, JsonValue>> item0 : this.metricDetails.entrySet()) {
	...
	public static class Builder implements ObjectBuilder<RankEvalMetricDetail> {
		...
		private Map<String, Map<String, JsonValue>> metricDetails;
		 ...
		 */
		public Builder putMetricDetails(String key, Map<String, JsonValue> value) {
