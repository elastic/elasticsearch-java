...
public final class ShardsRequest extends CatRequestBase {
	...
	protected ShardsRequest(Builder builder) {
	 ...
	 */
	public static final Endpoint<ShardsRequest, ShardsResponse, ElasticsearchError> ENDPOINT = new Endpoint.Simple<>(
			// Request method
			request -> {
				return "GET";
			...
			}, Endpoint.Simple.emptyMap(), false, ShardsResponse.DESERIALIZER);
}
