...
// typedef: inference._types.OpenShiftAiTaskSettings

/**
 *
 * @see <a href=
 *      "../doc-files/api-spec.html#inference._types.OpenShiftAiTaskSettings">API
 *      specification</a>
 */
@JsonpDeserializable
public class OpenShiftAiTaskSettings implements JsonpSerializable {
	@Nullable
	...
	/**
	 * Builder for {@link OpenShiftAiTaskSettings}.
	 */

	public static class Builder extends WithJsonObjectBuilderBase<Builder>
			implements
				ObjectBuilder<OpenShiftAiTaskSettings> {
		@Nullable
		...
		/**
		 * Builds a {@link OpenShiftAiTaskSettings}.
		 *
	...
	/**
	 * Json deserializer for {@link OpenShiftAiTaskSettings}
	 */
	public static final JsonpDeserializer<OpenShiftAiTaskSettings> _DESERIALIZER = ObjectBuilderDeserializer
			.lazy(Builder::new, OpenShiftAiTaskSettings::setupOpenShiftAiTaskSettingsDeserializer);

	protected static void setupOpenShiftAiTaskSettingsDeserializer(
			ObjectDeserializer<OpenShiftAiTaskSettings.Builder> op) {
