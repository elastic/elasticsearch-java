...
public final class LowercaseProcessor extends ProcessorBase {
	...
	protected LowercaseProcessor(Builder builder) {
		super(builder);
	...
	/**
	 * Json parser for LowercaseProcessor
	 */
	public static final JsonpValueParser<LowercaseProcessor> JSONP_PARSER = JsonpObjectBuilderParser
			.createForObject(Builder::new, LowercaseProcessor::setupLowercaseProcessorParser);

	protected static void setupLowercaseProcessorParser(DelegatingJsonpValueParser<LowercaseProcessor.Builder> op) {
