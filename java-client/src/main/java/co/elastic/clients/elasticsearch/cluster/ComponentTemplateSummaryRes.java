...
// typedef: cluster._types.ComponentTemplateSummaryRes

/**
 *
 * @see <a href=
 *      "../doc-files/api-spec.html#cluster._types.ComponentTemplateSummaryRes">API
 *      specification</a>
 */
@JsonpDeserializable
public class ComponentTemplateSummaryRes implements JsonpSerializable {
	@Nullable
	...
	private ComponentTemplateSummaryRes(Builder builder) {
	...
	public static ComponentTemplateSummaryRes of(Function<Builder, ObjectBuilder<ComponentTemplateSummaryRes>> fn) {
	...
	/**
	 * Builder for {@link ComponentTemplateSummaryRes}.
	 */

	public static class Builder extends WithJsonObjectBuilderBase<Builder>
			implements
				ObjectBuilder<ComponentTemplateSummaryRes> {
		@Nullable
		...
		private Builder(ComponentTemplateSummaryRes instance) {
		...
		/**
		 * Builds a {@link ComponentTemplateSummaryRes}.
		 *
		 * @throws NullPointerException
		 *             if some of the required fields are null.
		 */
		public ComponentTemplateSummaryRes build() {
			_checkSingleUse();

			return new ComponentTemplateSummaryRes(this);
		}
	}
	...
	/**
	 * Json deserializer for {@link ComponentTemplateSummaryRes}
	 */
	public static final JsonpDeserializer<ComponentTemplateSummaryRes> _DESERIALIZER = ObjectBuilderDeserializer
			.lazy(Builder::new, ComponentTemplateSummaryRes::setupComponentTemplateSummaryResDeserializer);

	protected static void setupComponentTemplateSummaryResDeserializer(
			ObjectDeserializer<ComponentTemplateSummaryRes.Builder> op) {
