 ...
 * 
 * @see <a href=
 *      "../doc-files/api-spec.html#connector.update_features.Request">API
 *      specification</a>
 */
@JsonpDeserializable
public class UpdateFeaturesRequest extends RequestBase implements JsonpSerializable {
	...
	/**
	 * Builder for {@link UpdateFeaturesRequest}.
	 */

	public static class Builder extends RequestBase.AbstractBuilder<Builder>
			implements
				ObjectBuilder<UpdateFeaturesRequest> {
		...
		/**
		 * Builds a {@link UpdateFeaturesRequest}.
		 *
	...
	/**
	 * Json deserializer for {@link UpdateFeaturesRequest}
	 */
	public static final JsonpDeserializer<UpdateFeaturesRequest> _DESERIALIZER = ObjectBuilderDeserializer
			.lazy(Builder::new, UpdateFeaturesRequest::setupUpdateFeaturesRequestDeserializer);
	...
	/**
	 * Endpoint "{@code connector.update_features}".
	 */
	public static final Endpoint<UpdateFeaturesRequest, UpdateFeaturesResponse, ErrorResponse> _ENDPOINT = new SimpleEndpoint<>(
			"es/connector.update_features",
			...
			}, SimpleEndpoint.emptyMap(), true, UpdateFeaturesResponse._DESERIALIZER);
}
