...
public final class DeleteJobResponse extends AcknowledgedResponseBase {
	...
	/**
	 * Json parser for DeleteJobResponse
	 */
	public static final JsonpValueParser<DeleteJobResponse> JSONP_PARSER = JsonpObjectBuilderParser
			.createForObject(Builder::new, DeleteJobResponse::setupDeleteJobResponseParser);

	protected static void setupDeleteJobResponseParser(DelegatingJsonpValueParser<DeleteJobResponse.Builder> op) {
