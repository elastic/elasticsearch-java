 ...
 */
public class WatcherApiAsyncClient extends ApiClient<WatcherApiAsyncClient> {

	public WatcherApiAsyncClient(Transport transport) {
		super(transport, null);
	}

	public WatcherApiAsyncClient(Transport transport, RequestOptions options) {
	...
	/**
	 * Creates a new {@link #WatcherApiAsyncClient} with specific request options.
	 */
	@Override
	public WatcherApiAsyncClient withRequestOptions(@Nullable RequestOptions options) {
		return new WatcherApiAsyncClient(transport, options);
	}
	 ...
	 */
	public WatcherApiAsyncClient withRequestOptions(Function<RequestOptions.Builder, RequestOptions.Builder> fn) {
