...
public final class TrimProcessor extends ProcessorBase {
	...
	/**
	 * Json parser for TrimProcessor
	 */
	public static final JsonpValueParser<TrimProcessor> JSONP_PARSER = JsonpObjectBuilderParser
			.createForObject(Builder::new, TrimProcessor::setupTrimProcessorParser);

	protected static void setupTrimProcessorParser(DelegatingJsonpValueParser<TrimProcessor.Builder> op) {
