...
public final class FindFileStructureRequest extends RequestBase {
	...
	/**
	 * Builder for {@link FindFileStructureRequest}.
	 */
	public static class Builder implements ObjectBuilder<FindFileStructureRequest> {
		...
		/**
		 * Builds a {@link FindFileStructureRequest}.
		 *
	 ...
	 */
	public static final Endpoint<FindFileStructureRequest, FindFileStructureResponse, ErrorResponse> ENDPOINT = new SimpleEndpoint<>(
			// Request method
			request -> {
				return "POST";
