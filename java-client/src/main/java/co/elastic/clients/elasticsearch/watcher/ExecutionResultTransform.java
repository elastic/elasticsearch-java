...
// typedef: watcher._types.ExecutionResultTransform

/**
 *
 * @see <a href=
 *      "../doc-files/api-spec.html#watcher._types.ExecutionResultTransform">API
 *      specification</a>
 */
@JsonpDeserializable
public class ExecutionResultTransform implements JsonpSerializable {
	private final Map<String, JsonData> payload;

	private final ExecutionResultStatus status;

	private final ExecutionResultTransformType type;
	...
	private ExecutionResultTransform(Builder builder) {
	...
	public static ExecutionResultTransform of(Function<Builder, ObjectBuilder<ExecutionResultTransform>> fn) {
	 ...
	 */
	public final ExecutionResultTransformType type() {
		return this.type;
	}
	...
	/**
	 * Builder for {@link ExecutionResultTransform}.
	 */

	public static class Builder extends WithJsonObjectBuilderBase<Builder>
			implements
				ObjectBuilder<ExecutionResultTransform> {
		@Nullable
		private Map<String, JsonData> payload;

		private ExecutionResultStatus status;

		private ExecutionResultTransformType type;
		...
		private Builder(ExecutionResultTransform instance) {
		 ...
		 * Required - API name: {@code type}
		 */
		public final Builder type(ExecutionResultTransformType value) {
			this.type = value;
			return this;
		}
		...
		/**
		 * Builds a {@link ExecutionResultTransform}.
		 *
		 * @throws NullPointerException
		 *             if some of the required fields are null.
		 */
		public ExecutionResultTransform build() {
			_checkSingleUse();

			return new ExecutionResultTransform(this);
		}
	}
	...
	/**
	 * Json deserializer for {@link ExecutionResultTransform}
	 */
	public static final JsonpDeserializer<ExecutionResultTransform> _DESERIALIZER = ObjectBuilderDeserializer
			.lazy(Builder::new, ExecutionResultTransform::setupExecutionResultTransformDeserializer);

	protected static void setupExecutionResultTransformDeserializer(
			ObjectDeserializer<ExecutionResultTransform.Builder> op) {
		...
		op.add(Builder::type, ExecutionResultTransformType._DESERIALIZER, "type");
