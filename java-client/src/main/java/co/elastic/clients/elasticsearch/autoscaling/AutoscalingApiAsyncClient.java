 ...
 */
public class AutoscalingApiAsyncClient extends ApiClient<AutoscalingApiAsyncClient> {

	public AutoscalingApiAsyncClient(Transport transport) {
		super(transport, null);
	}

	public AutoscalingApiAsyncClient(Transport transport, RequestOptions options) {
	...
	/**
	 * Creates a new {@link #AutoscalingApiAsyncClient} with specific request
	 * options.
	 */
	@Override
	public AutoscalingApiAsyncClient withRequestOptions(@Nullable RequestOptions options) {
		return new AutoscalingApiAsyncClient(transport, options);
	}
	 ...
	 */
	public AutoscalingApiAsyncClient withRequestOptions(Function<RequestOptions.Builder, RequestOptions.Builder> fn) {
