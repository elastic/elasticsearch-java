...
// typedef: snapshot._types.SourceOnlyRepositorySettingsForSharedFileSystem

/**
 *
 * @see <a href=
 *      "../doc-files/api-spec.html#snapshot._types.SourceOnlyRepositorySettingsForSharedFileSystem">API
 *      specification</a>
 */
@JsonpDeserializable
public class SourceOnlyRepositorySettingsForSharedFileSystem
		implements
			SourceOnlyRepositorySettingsVariant,
			JsonpSerializable {
	...
	private SourceOnlyRepositorySettingsForSharedFileSystem(Builder builder) {
	...
	public static SourceOnlyRepositorySettingsForSharedFileSystem of(
			Function<Builder, ObjectBuilder<SourceOnlyRepositorySettingsForSharedFileSystem>> fn) {
		return fn.apply(new Builder()).build();
	}

	/**
	 * SourceOnlyRepositorySettings variant kind.
	 */
	@Override
	public SourceOnlyRepositorySettings.Kind _sourceOnlyRepositorySettingsKind() {
		return SourceOnlyRepositorySettings.Kind.Fs;
	}
	...
	protected void serializeInternal(JsonGenerator generator, JsonpMapper mapper) {
		...
		generator.write("delegate_type", "fs");
	...
	/**
	 * Builder for {@link SourceOnlyRepositorySettingsForSharedFileSystem}.
	 */

	public static class Builder extends WithJsonObjectBuilderBase<Builder>
			implements
				ObjectBuilder<SourceOnlyRepositorySettingsForSharedFileSystem> {
		...
		private Builder(SourceOnlyRepositorySettingsForSharedFileSystem instance) {
		...
		/**
		 * Builds a {@link SourceOnlyRepositorySettingsForSharedFileSystem}.
		 *
		 * @throws NullPointerException
		 *             if some of the required fields are null.
		 */
		public SourceOnlyRepositorySettingsForSharedFileSystem build() {
			_checkSingleUse();

			return new SourceOnlyRepositorySettingsForSharedFileSystem(this);
		}
	}
	...
	/**
	 * Json deserializer for {@link SourceOnlyRepositorySettingsForSharedFileSystem}
	 */
	public static final JsonpDeserializer<SourceOnlyRepositorySettingsForSharedFileSystem> _DESERIALIZER = ObjectBuilderDeserializer
			.lazy(Builder::new,
					SourceOnlyRepositorySettingsForSharedFileSystem::setupSourceOnlyRepositorySettingsForSharedFileSystemDeserializer);

	protected static void setupSourceOnlyRepositorySettingsForSharedFileSystemDeserializer(
			ObjectDeserializer<SourceOnlyRepositorySettingsForSharedFileSystem.Builder> op) {
