 ...
 */
public class FeaturesApiClient extends ApiClient<FeaturesApiClient> {

	public FeaturesApiClient(Transport transport) {
		super(transport, null);
	}

	public FeaturesApiClient(Transport transport, RequestOptions options) {
	...
	/**
	 * Creates a new {@link #FeaturesApiClient} with specific request options.
	 */
	@Override
	public FeaturesApiClient withRequestOptions(@Nullable RequestOptions options) {
		return new FeaturesApiClient(transport, options);
	}
	 ...
	 */
	public FeaturesApiClient withRequestOptions(Function<RequestOptions.Builder, RequestOptions.Builder> fn) {
