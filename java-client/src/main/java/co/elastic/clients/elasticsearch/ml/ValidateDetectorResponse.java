...
public final class ValidateDetectorResponse extends AcknowledgedResponseBase {
	...
	/**
	 * Json parser for ValidateDetectorResponse
	 */
	public static final JsonpValueParser<ValidateDetectorResponse> JSONP_PARSER = JsonpObjectBuilderParser
			.createForObject(Builder::new, ValidateDetectorResponse::setupValidateDetectorResponseParser);

	protected static void setupValidateDetectorResponseParser(
			DelegatingJsonpValueParser<ValidateDetectorResponse.Builder> op) {
