 ...
 *
 * @see <a href=
 *      "../../doc-files/api-spec.html#_types.analysis.BengaliAnalyzer">API
 *      specification</a>
 */
@JsonpDeserializable
public class BengaliAnalyzer implements AnalyzerVariant, JsonpSerializable {
	...
	public static class Builder extends WithJsonObjectBuilderBase<Builder> implements ObjectBuilder<BengaliAnalyzer> {
		@Nullable
		...
		private Builder(BengaliAnalyzer instance) {
	 ...
	 */
	public static final JsonpDeserializer<BengaliAnalyzer> _DESERIALIZER = ObjectBuilderDeserializer.lazy(Builder::new,
			BengaliAnalyzer::setupBengaliAnalyzerDeserializer);

	protected static void setupBengaliAnalyzerDeserializer(ObjectDeserializer<BengaliAnalyzer.Builder> op) {
