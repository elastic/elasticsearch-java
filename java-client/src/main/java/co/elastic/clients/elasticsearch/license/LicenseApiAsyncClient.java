 ...
 */
public class LicenseApiAsyncClient extends ApiClient<LicenseApiAsyncClient> {

	public LicenseApiAsyncClient(Transport transport) {
		super(transport, null);
	}

	public LicenseApiAsyncClient(Transport transport, RequestOptions options) {
	...
	/**
	 * Creates a new {@link #LicenseApiAsyncClient} with specific request options.
	 */
	@Override
	public LicenseApiAsyncClient withRequestOptions(@Nullable RequestOptions options) {
		return new LicenseApiAsyncClient(transport, options);
	}
	 ...
	 */
	public LicenseApiAsyncClient withRequestOptions(Function<RequestOptions.Builder, RequestOptions.Builder> fn) {
