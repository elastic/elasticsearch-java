 ...
 * available here as they don't have a dedicated class. Use {@link Suggest}'s
 * builder for these.
 * 
 */
public class SuggestBuilders {
	private SuggestBuilders() {
	}

	/**
	 * Creates a builder for the {@link CompletionSuggester completion}
	 * {@code Suggest} variant.
	 */
	...
	/**
	 * Creates a builder for the {@link PhraseSuggester phrase} {@code Suggest}
	 * variant.
	 */
	...
	/**
	 * Creates a builder for the {@link TermSuggester term} {@code Suggest} variant.
	 */
