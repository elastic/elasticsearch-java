 ...
 */
public class SqlApiClient extends ApiClient<SqlApiClient> {

	public SqlApiClient(Transport transport) {
		super(transport, null);
	}

	public SqlApiClient(Transport transport, RequestOptions options) {
	...
	/**
	 * Creates a new {@link #SqlApiClient} with specific request options.
	 */
	@Override
	public SqlApiClient withRequestOptions(@Nullable RequestOptions options) {
		return new SqlApiClient(transport, options);
	}

	/**
	 * Creates a new {@link #SqlApiClient} with specific request options, inheriting
	 * existing options.
	 *
	 * @param fn
	 ...
	 */
	public SqlApiClient withRequestOptions(Function<RequestOptions.Builder, RequestOptions.Builder> fn) {
