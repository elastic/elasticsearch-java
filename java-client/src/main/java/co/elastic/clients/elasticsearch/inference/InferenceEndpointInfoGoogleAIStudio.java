...
// typedef: inference._types.InferenceEndpointInfoGoogleAIStudio

/**
 *
 * @see <a href=
 *      "../doc-files/api-spec.html#inference._types.InferenceEndpointInfoGoogleAIStudio">API
 *      specification</a>
 */

public abstract class InferenceEndpointInfoGoogleAIStudio extends InferenceEndpoint {
	...
	// ---------------------------------------------------------------------------------------------
	protected static <BuilderT extends AbstractBuilder<BuilderT>> void setupInferenceEndpointInfoGoogleAIStudioDeserializer(
