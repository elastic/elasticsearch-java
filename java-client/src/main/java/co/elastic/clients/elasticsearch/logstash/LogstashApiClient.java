 ...
 */
public class LogstashApiClient extends ApiClient<LogstashApiClient> {

	public LogstashApiClient(Transport transport) {
		super(transport, null);
	}

	public LogstashApiClient(Transport transport, RequestOptions options) {
	...
	/**
	 * Creates a new {@link #LogstashApiClient} with specific request options.
	 */
	@Override
	public LogstashApiClient withRequestOptions(@Nullable RequestOptions options) {
		return new LogstashApiClient(transport, options);
	}
	 ...
	 */
	public LogstashApiClient withRequestOptions(Function<RequestOptions.Builder, RequestOptions.Builder> fn) {
