...
// typedef: snapshot._types.SourceOnlyRepositorySettingsForS3

/**
 *
 * @see <a href=
 *      "../doc-files/api-spec.html#snapshot._types.SourceOnlyRepositorySettingsForS3">API
 *      specification</a>
 */
@JsonpDeserializable
public class SourceOnlyRepositorySettingsForS3 implements SourceOnlyRepositorySettingsVariant, JsonpSerializable {
	...
	private SourceOnlyRepositorySettingsForS3(Builder builder) {
	...
	public static SourceOnlyRepositorySettingsForS3 of(
			Function<Builder, ObjectBuilder<SourceOnlyRepositorySettingsForS3>> fn) {
	...
	public SourceOnlyRepositorySettings.Kind _sourceOnlyRepositorySettingsKind() {
		return SourceOnlyRepositorySettings.Kind.S3;
	}
	...
	protected void serializeInternal(JsonGenerator generator, JsonpMapper mapper) {
		...
		generator.write("delegate_type", "s3");
	...
	/**
	 * Builder for {@link SourceOnlyRepositorySettingsForS3}.
	 */

	public static class Builder extends WithJsonObjectBuilderBase<Builder>
			implements
				ObjectBuilder<SourceOnlyRepositorySettingsForS3> {
		...
		private Builder(SourceOnlyRepositorySettingsForS3 instance) {
		...
		/**
		 * Builds a {@link SourceOnlyRepositorySettingsForS3}.
		 *
		 * @throws NullPointerException
		 *             if some of the required fields are null.
		 */
		public SourceOnlyRepositorySettingsForS3 build() {
			_checkSingleUse();

			return new SourceOnlyRepositorySettingsForS3(this);
		}
	}
	...
	/**
	 * Json deserializer for {@link SourceOnlyRepositorySettingsForS3}
	 */
	public static final JsonpDeserializer<SourceOnlyRepositorySettingsForS3> _DESERIALIZER = ObjectBuilderDeserializer
			.lazy(Builder::new, SourceOnlyRepositorySettingsForS3::setupSourceOnlyRepositorySettingsForS3Deserializer);

	protected static void setupSourceOnlyRepositorySettingsForS3Deserializer(
			ObjectDeserializer<SourceOnlyRepositorySettingsForS3.Builder> op) {
