...
public class DeleteDatasetRequest extends RequestBase {
	@Nullable
	...
	public static DeleteDatasetRequest of(Function<Builder, ObjectBuilder<DeleteDatasetRequest>> fn) {
	...
	/**
	 * Required - A comma-separated list of dataset names to delete.
	 * <p>
	 * API name: {@code name}
	 */
	...
	/**
	 * Builder for {@link DeleteDatasetRequest}.
	 */

	public static class Builder extends RequestBase.AbstractBuilder<Builder>
			implements
				ObjectBuilder<DeleteDatasetRequest> {
		@Nullable
		...
		private Builder(DeleteDatasetRequest instance) {
		...
		/**
		 * Builds a {@link DeleteDatasetRequest}.
		 *
	...
	/**
	 * Endpoint "{@code esql.delete_dataset}".
	 */
	public static final Endpoint<DeleteDatasetRequest, DeleteDatasetResponse, ErrorResponse> _ENDPOINT = new SimpleEndpoint<>(
			"es/esql.delete_dataset",
			...
			}, SimpleEndpoint.emptyMap(), false, DeleteDatasetResponse._DESERIALIZER);
}
