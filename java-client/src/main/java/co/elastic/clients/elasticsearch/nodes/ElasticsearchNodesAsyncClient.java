...
public class ElasticsearchNodesAsyncClient extends ApiClient<ElasticsearchTransport, ElasticsearchNodesAsyncClient> {
	 ...
	 * 
	 * @see <a href=
	 *      "https://www.elastic.co/docs/api/doc/elasticsearch/v9/operation-nodes-clear-repositories-metering-archive">Documentation
	 *      on elastic.co</a>
	 */
	 ...
	 * 
	 * @see <a href=
	 *      "https://www.elastic.co/docs/api/doc/elasticsearch/v9/operation-nodes-get-repositories-metering-info">Documentation
	 *      on elastic.co</a>
	 */
	 ...
	 * 
	 * @see <a href=
	 *      "https://www.elastic.co/docs/api/doc/elasticsearch/v9/operation-nodes-hot-threads">Documentation
	 *      on elastic.co</a>
	 */
	 ...
	 * 
	 * @see <a href=
	 *      "https://www.elastic.co/docs/api/doc/elasticsearch/v9/operation-nodes-info">Documentation
	 *      on elastic.co</a>
	 */
	 ...
	 * 
	 * @see <a href=
	 *      "https://www.elastic.co/docs/api/doc/elasticsearch/v9/operation-nodes-reload-secure-settings">Documentation
	 *      on elastic.co</a>
	 */
	 ...
	 * 
	 * @see <a href=
	 *      "https://www.elastic.co/docs/api/doc/elasticsearch/v9/operation-nodes-stats">Documentation
	 *      on elastic.co</a>
	 */
