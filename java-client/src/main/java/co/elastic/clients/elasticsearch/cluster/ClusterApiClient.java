 ...
 */
public class ClusterApiClient extends ApiClient<ClusterApiClient> {

	public ClusterApiClient(Transport transport) {
		super(transport, null);
	}

	public ClusterApiClient(Transport transport, RequestOptions options) {
	...
	/**
	 * Creates a new {@link #ClusterApiClient} with specific request options.
	 */
	@Override
	public ClusterApiClient withRequestOptions(@Nullable RequestOptions options) {
		return new ClusterApiClient(transport, options);
	}
	 ...
	 */
	public ClusterApiClient withRequestOptions(Function<RequestOptions.Builder, RequestOptions.Builder> fn) {
