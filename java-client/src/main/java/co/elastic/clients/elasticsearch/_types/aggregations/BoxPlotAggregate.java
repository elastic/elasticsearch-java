 ...
 *
 * @see <a href=
 *      "../../doc-files/api-spec.html#_types.aggregations.BoxPlotAggregate">API
 *      specification</a>
 */
@JsonpDeserializable
public class BoxPlotAggregate extends AggregateBase implements AggregateVariant {
	...
	private BoxPlotAggregate(Builder builder) {
		...
		this.q1 = ApiTypeHelper.requireNonNull(builder.q1, this, "q1", 0);
		this.q2 = ApiTypeHelper.requireNonNull(builder.q2, this, "q2", 0);
		this.q3 = ApiTypeHelper.requireNonNull(builder.q3, this, "q3", 0);
