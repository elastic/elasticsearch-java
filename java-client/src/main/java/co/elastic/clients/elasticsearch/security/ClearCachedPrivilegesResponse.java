 ...
 *
 * @see <a href=
 *      "https://github.com/elastic/elasticsearch-specification/tree/bd953a3fc/specification/security/clear_cached_privileges/SecurityClearCachedPrivilegesResponse.ts#L25-L32">API
 *      specification</a>
 */
@JsonpDeserializable
public class ClearCachedPrivilegesResponse implements JsonpSerializable {
	...
	private ClearCachedPrivilegesResponse(Builder builder) {
	...
	public static ClearCachedPrivilegesResponse of(Function<Builder, ObjectBuilder<ClearCachedPrivilegesResponse>> fn) {
	...
	public static class Builder extends ObjectBuilderBase implements ObjectBuilder<ClearCachedPrivilegesResponse> {
	 ...
	 */
	public static final JsonpDeserializer<ClearCachedPrivilegesResponse> _DESERIALIZER = ObjectBuilderDeserializer
			.lazy(Builder::new, ClearCachedPrivilegesResponse::setupClearCachedPrivilegesResponseDeserializer);

	protected static void setupClearCachedPrivilegesResponseDeserializer(
			ObjectDeserializer<ClearCachedPrivilegesResponse.Builder> op) {
