...
public final class ClearCachedPrivilegesResponse implements ToJsonp {
	...
	/**
	 * Json parser for ClearCachedPrivilegesResponse
	 */
	public static final JsonpValueParser<ClearCachedPrivilegesResponse> JSONP_PARSER = JsonpObjectBuilderParser
			.createForObject(Builder::new, ClearCachedPrivilegesResponse::setupClearCachedPrivilegesResponseParser);

	protected static void setupClearCachedPrivilegesResponseParser(
			DelegatingJsonpValueParser<ClearCachedPrivilegesResponse.Builder> op) {
