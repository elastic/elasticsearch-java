...
public class AliasesResponse implements JsonpSerializable {
	...
	public static AliasesResponse of(Consumer<Builder> fn) {
	...
	public static class Builder extends ObjectBuilderBase implements ObjectBuilder<AliasesResponse> {
		...
		public final Builder valueBody(
				Function<ListBuilder<AliasesRecord, AliasesRecord.Builder>, ObjectBuilder<List<AliasesRecord>>> fn) {
			return valueBody(fn.apply(new ListBuilder<>(AliasesRecord.Builder::new)).build());
		}
