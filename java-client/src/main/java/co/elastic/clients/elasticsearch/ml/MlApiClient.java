 ...
 */
public class MlApiClient extends ApiClient<MlApiClient> {

	public MlApiClient(Transport transport) {
		super(transport, null);
	}

	public MlApiClient(Transport transport, RequestOptions options) {
	...
	/**
	 * Creates a new {@link #MlApiClient} with specific request options.
	 */
	@Override
	public MlApiClient withRequestOptions(@Nullable RequestOptions options) {
		return new MlApiClient(transport, options);
	}

	/**
	 * Creates a new {@link #MlApiClient} with specific request options, inheriting
	 * existing options.
	 *
	 * @param fn
	 ...
	 */
	public MlApiClient withRequestOptions(Function<RequestOptions.Builder, RequestOptions.Builder> fn) {
