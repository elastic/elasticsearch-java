 ...
 */
public class DanglingIndicesApiClient extends ApiClient<DanglingIndicesApiClient> {

	public DanglingIndicesApiClient(Transport transport) {
		super(transport, null);
	}

	public DanglingIndicesApiClient(Transport transport, RequestOptions options) {
	...
	/**
	 * Creates a new {@link #DanglingIndicesApiClient} with specific request
	 * options.
	 */
	@Override
	public DanglingIndicesApiClient withRequestOptions(@Nullable RequestOptions options) {
		return new DanglingIndicesApiClient(transport, options);
	}
	 ...
	 */
	public DanglingIndicesApiClient withRequestOptions(Function<RequestOptions.Builder, RequestOptions.Builder> fn) {
