...
// typedef: rollup.delete_rollup_job.Response
public final class DeleteRollupJobResponse extends AcknowledgedResponseBase {
	@Nullable
	private final List<TaskFailure> taskFailures;

	// ---------------------------------------------------------------------------------------------

	protected DeleteRollupJobResponse(Builder builder) {
		super(builder);
	...
	/**
	 * Builder for {@link DeleteRollupJobResponse}.
	 */
	public static class Builder extends AcknowledgedResponseBase.AbstractBuilder<Builder>
			implements
				ObjectBuilder<DeleteRollupJobResponse> {
		@Nullable
		...
		/**
		 * Builds a {@link DeleteRollupJobResponse}.
		 *
		 * @throws NullPointerException
		 *             if some of the required fields are null.
		 */
		public DeleteRollupJobResponse build() {

			return new DeleteRollupJobResponse(this);
		}
	}
