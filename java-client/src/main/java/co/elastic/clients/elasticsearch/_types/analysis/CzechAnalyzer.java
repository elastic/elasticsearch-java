 ...
 *
 * @see <a href=
 *      "../../doc-files/api-spec.html#_types.analysis.CzechAnalyzer">API
 *      specification</a>
 */
@JsonpDeserializable
public class CzechAnalyzer implements AnalyzerVariant, JsonpSerializable {
	...
	public static class Builder extends WithJsonObjectBuilderBase<Builder> implements ObjectBuilder<CzechAnalyzer> {
		@Nullable
		...
		private Builder(CzechAnalyzer instance) {
	 ...
	 */
	public static final JsonpDeserializer<CzechAnalyzer> _DESERIALIZER = ObjectBuilderDeserializer.lazy(Builder::new,
			CzechAnalyzer::setupCzechAnalyzerDeserializer);

	protected static void setupCzechAnalyzerDeserializer(ObjectDeserializer<CzechAnalyzer.Builder> op) {
