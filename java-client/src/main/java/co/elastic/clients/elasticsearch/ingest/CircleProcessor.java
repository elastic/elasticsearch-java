...
public final class CircleProcessor extends ProcessorBase {
	...
	/**
	 * Json parser for CircleProcessor
	 */
	public static final JsonpValueParser<CircleProcessor> JSONP_PARSER = JsonpObjectBuilderParser
			.createForObject(Builder::new, CircleProcessor::setupCircleProcessorParser);

	protected static void setupCircleProcessorParser(DelegatingJsonpValueParser<CircleProcessor.Builder> op) {
		ProcessorBase.setupProcessorBaseParser(op);
		op.add(Builder::errorDistance, JsonpValueParser.numberParser(), "error_distance");
		...
		op.add(Builder::shapeType, JsonpValueParser.jsonValueParser(), "shape_type");
