...
public final class QueryWatchesResponse implements ToJsonp {
	...
	/**
	 * Json parser for QueryWatchesResponse
	 */
	public static final JsonpValueParser<QueryWatchesResponse> JSONP_PARSER = JsonpObjectBuilderParser
			.createForObject(Builder::new, QueryWatchesResponse::setupQueryWatchesResponseParser);

	protected static void setupQueryWatchesResponseParser(DelegatingJsonpValueParser<QueryWatchesResponse.Builder> op) {
