...
public abstract class NodesResponseBase implements ToJsonp {
	...
	// ---------------------------------------------------------------------------------------------
	protected static <BuilderT extends AbstractBuilder<BuilderT>> void setupNodesResponseBaseParser(
			DelegatingJsonpValueParser<BuilderT> op) {

		op.add(AbstractBuilder::_nodes, NodeStatistics.JSONP_PARSER, "_nodes");
