 ...
 */
public class AsyncSearchApiClient extends ApiClient<AsyncSearchApiClient> {

	public AsyncSearchApiClient(Transport transport) {
		super(transport, null);
	}

	public AsyncSearchApiClient(Transport transport, RequestOptions options) {
	...
	/**
	 * Creates a new {@link #AsyncSearchApiClient} with specific request options.
	 */
	@Override
	public AsyncSearchApiClient withRequestOptions(@Nullable RequestOptions options) {
		return new AsyncSearchApiClient(transport, options);
	}
	 ...
	 */
	public AsyncSearchApiClient withRequestOptions(Function<RequestOptions.Builder, RequestOptions.Builder> fn) {
