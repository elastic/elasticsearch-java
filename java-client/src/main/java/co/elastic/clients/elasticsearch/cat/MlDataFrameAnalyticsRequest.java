...
public final class MlDataFrameAnalyticsRequest extends CatRequestBase {
	...
	protected MlDataFrameAnalyticsRequest(Builder builder) {
	 ...
	 */
	public static final Endpoint<MlDataFrameAnalyticsRequest, MlDataFrameAnalyticsResponse, ElasticsearchError> ENDPOINT = new Endpoint.Simple<>(
			// Request method
			request -> {
				return "GET";
			...
			}, Endpoint.Simple.emptyMap(), false, MlDataFrameAnalyticsResponse.DESERIALIZER);
}
