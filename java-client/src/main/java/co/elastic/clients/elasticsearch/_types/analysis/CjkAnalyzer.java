...
/**
 *
 * @see <a href="../../doc-files/api-spec.html#_types.analysis.CjkAnalyzer">API
 *      specification</a>
 */
@JsonpDeserializable
public class CjkAnalyzer implements AnalyzerVariant, JsonpSerializable {
	...
	public static class Builder extends WithJsonObjectBuilderBase<Builder> implements ObjectBuilder<CjkAnalyzer> {
		@Nullable
		...
		private Builder(CjkAnalyzer instance) {
