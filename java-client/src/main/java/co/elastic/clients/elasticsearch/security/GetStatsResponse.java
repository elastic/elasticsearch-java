...
// typedef: security.get_stats.Response

/**
 *
 * @see <a href="../doc-files/api-spec.html#security.get_stats.Response">API
 *      specification</a>
 */
@JsonpDeserializable
public class GetStatsResponse implements JsonpSerializable {
	private final Map<String, NodeSecurityStats> nodes;
	...
	/**
	 * Required - A map of node IDs to security statistics for that node.
	 * <p>
	 * API name: {@code nodes}
	 */
	public final Map<String, NodeSecurityStats> nodes() {
		return this.nodes;
	}
	...
	protected void serializeInternal(JsonGenerator generator, JsonpMapper mapper) {
		...
		if (ApiTypeHelper.isDefined(this.nodes)) {
			...
			generator.writeStartObject();
			for (Map.Entry<String, NodeSecurityStats> item0 : this.nodes.entrySet()) {
	...
	public static class Builder extends WithJsonObjectBuilderBase<Builder> implements ObjectBuilder<GetStatsResponse> {
		private Map<String, NodeSecurityStats> nodes;
		 ...
		 */
		public final Builder nodes(Map<String, NodeSecurityStats> map) {
		 ...
		 */
		public final Builder nodes(String key, NodeSecurityStats value) {
		...
		public final Builder nodes(String key,
				Function<NodeSecurityStats.Builder, ObjectBuilder<NodeSecurityStats>> fn) {
			return nodes(key, fn.apply(new NodeSecurityStats.Builder()).build());
		}
	...
	protected static void setupGetStatsResponseDeserializer(ObjectDeserializer<GetStatsResponse.Builder> op) {
		...
		op.add(Builder::nodes, JsonpDeserializer.stringMapDeserializer(NodeSecurityStats._DESERIALIZER), "nodes");
