...
// typedef: inference._types.CompletionToolChoiceFunction

/**
 * The tool choice function.
 * 
 * @see <a href=
 *      "../doc-files/api-spec.html#inference._types.CompletionToolChoiceFunction">API
 *      specification</a>
 */
@JsonpDeserializable
public class CompletionToolChoiceFunction implements JsonpSerializable {
	...
	public static class Builder extends WithJsonObjectBuilderBase<Builder>
		...
		private Builder(CompletionToolChoiceFunction instance) {
