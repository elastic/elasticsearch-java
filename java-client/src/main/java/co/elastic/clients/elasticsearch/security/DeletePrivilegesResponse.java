 ...
 */
@JsonpDeserializable
public class DeletePrivilegesResponse implements JsonpSerializable {
	private final Map<String, Map<String, FoundStatus>> result;
	...
	public void serialize(JsonGenerator generator, JsonpMapper mapper) {
		...
		for (Map.Entry<String, Map<String, FoundStatus>> item0 : this.result.entrySet()) {
			generator.writeKey(item0.getKey());
			generator.writeStartObject();
			if (item0.getValue() != null) {
				for (Map.Entry<String, FoundStatus> item1 : item0.getValue().entrySet()) {
	...
	public static class Builder extends WithJsonObjectBuilderBase<Builder>
		...
		private Map<String, Map<String, FoundStatus>> result = new HashMap<>();
		 ...
		 */
		public final Builder result(String key, Map<String, FoundStatus> value) {
		...
		public Builder withJson(JsonParser parser, JsonpMapper mapper) {
			...
			Map<String, Map<String, FoundStatus>> value = (Map<String, Map<String, FoundStatus>>) JsonpDeserializer
	...
	public static final JsonpDeserializer<DeletePrivilegesResponse> _DESERIALIZER = createDeletePrivilegesResponseDeserializer();
	protected static JsonpDeserializer<DeletePrivilegesResponse> createDeletePrivilegesResponseDeserializer() {
