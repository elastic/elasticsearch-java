...
// typedef: inference._types.InferenceEndpointInfoContextualAi

/**
 *
 * @see <a href=
 *      "../doc-files/api-spec.html#inference._types.InferenceEndpointInfoContextualAi">API
 *      specification</a>
 */

public abstract class InferenceEndpointInfoContextualAi extends InferenceEndpoint {
	...
	protected InferenceEndpointInfoContextualAi(AbstractBuilder<?> builder) {
		super(builder);
	...
	public abstract static class AbstractBuilder<BuilderT extends AbstractBuilder<BuilderT>>
		 ...
		 * API name: {@code task_type}
		 */
		public final BuilderT taskType(TaskTypeContextualAI value) {
			this.taskType = value;
			return self();
		}
	...
	// ---------------------------------------------------------------------------------------------
	protected static <BuilderT extends AbstractBuilder<BuilderT>> void setupInferenceEndpointInfoContextualAiDeserializer(
		...
		op.add(AbstractBuilder::taskType, TaskTypeContextualAI._DESERIALIZER, "task_type");
