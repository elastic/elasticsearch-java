...
public final class ExecuteEnrichPolicyStatus implements ToJsonp {
	...
	/**
	 * Json parser for ExecuteEnrichPolicyStatus
	 */
	public static final JsonpValueParser<ExecuteEnrichPolicyStatus> JSONP_PARSER = JsonpObjectBuilderParser
			.createForObject(Builder::new, ExecuteEnrichPolicyStatus::setupExecuteEnrichPolicyStatusParser);

	protected static void setupExecuteEnrichPolicyStatusParser(
			DelegatingJsonpValueParser<ExecuteEnrichPolicyStatus.Builder> op) {

		op.add(Builder::phase, JsonpValueParser.jsonValueParser(), "phase");
