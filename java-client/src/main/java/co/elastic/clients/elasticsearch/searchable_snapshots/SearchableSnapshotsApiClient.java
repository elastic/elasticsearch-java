 ...
 */
public class SearchableSnapshotsApiClient extends ApiClient<SearchableSnapshotsApiClient> {

	public SearchableSnapshotsApiClient(Transport transport) {
		super(transport, null);
	}

	public SearchableSnapshotsApiClient(Transport transport, RequestOptions options) {
	...
	/**
	 * Creates a new {@link #SearchableSnapshotsApiClient} with specific request
	 * options.
	 */
	@Override
	public SearchableSnapshotsApiClient withRequestOptions(@Nullable RequestOptions options) {
		return new SearchableSnapshotsApiClient(transport, options);
	}
	 ...
	 */
	public SearchableSnapshotsApiClient withRequestOptions(
