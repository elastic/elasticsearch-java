...
// typedef: cluster.stats.ExtendedSearchUsage

/**
 *
 * @see <a href=
 *      "../../doc-files/api-spec.html#cluster.stats.ExtendedSearchUsage">API
 *      specification</a>
 */
@JsonpDeserializable
public class ExtendedSearchUsage implements JsonpSerializable {
	@Nullable
	...
	public static ExtendedSearchUsage of(Function<Builder, ObjectBuilder<ExtendedSearchUsage>> fn) {
	 ...
	 */
	@Nullable
	public final ExtendedRetrieversSearchUsage retrievers() {
	...
	/**
	 * Builder for {@link ExtendedSearchUsage}.
	 */

	public static class Builder extends WithJsonObjectBuilderBase<Builder>
			implements
				ObjectBuilder<ExtendedSearchUsage> {
		@Nullable
		 ...
		 * API name: {@code retrievers}
		 */
		public final Builder retrievers(@Nullable ExtendedRetrieversSearchUsage value) {
			this.retrievers = value;
			return this;
		}
		...
		/**
		 * Builds a {@link ExtendedSearchUsage}.
		 *
		 * @throws NullPointerException
		 *             if some of the required fields are null.
		 */
		public ExtendedSearchUsage build() {
			_checkSingleUse();

			return new ExtendedSearchUsage(this);
		}
	}
	...
	/**
	 * Json deserializer for {@link ExtendedSearchUsage}
	 */
	public static final JsonpDeserializer<ExtendedSearchUsage> _DESERIALIZER = ObjectBuilderDeserializer
			.lazy(Builder::new, ExtendedSearchUsage::setupExtendedSearchUsageDeserializer);
