...
public final class UnfreezeResponse extends AcknowledgedResponseBase {
	...
	/**
	 * Json parser for UnfreezeResponse
	 */
	public static final JsonpValueParser<UnfreezeResponse> JSONP_PARSER = JsonpObjectBuilderParser
			.createForObject(Builder::new, UnfreezeResponse::setupUnfreezeResponseParser);

	protected static void setupUnfreezeResponseParser(DelegatingJsonpValueParser<UnfreezeResponse.Builder> op) {
