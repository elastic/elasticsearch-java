...
// typedef: dangling_indices.index_delete.Request
public final class IndexDeleteRequest extends RequestBase implements ToJsonp {
	...
	protected IndexDeleteRequest(Builder builder) {
	...
	/**
	 * Builder for {@link IndexDeleteRequest}.
	 */
	public static class Builder implements ObjectBuilder<IndexDeleteRequest> {
		...
		/**
		 * Builds a {@link IndexDeleteRequest}.
		 *
		 * @throws NullPointerException
		 *             if some of the required fields are null.
		 */
		public IndexDeleteRequest build() {

			return new IndexDeleteRequest(this);
		}
	}
	...
	/**
	 * Json deserializer for IndexDeleteRequest
	 */
	public static final JsonpDeserializer<IndexDeleteRequest> DESERIALIZER = ObjectBuilderDeserializer
			.createForObject(Builder::new, IndexDeleteRequest::setupIndexDeleteRequestDeserializer);

	protected static void setupIndexDeleteRequestDeserializer(DelegatingDeserializer<IndexDeleteRequest.Builder> op) {
	...
	public static final Endpoint<IndexDeleteRequest, IndexDeleteResponse, ElasticsearchError> ENDPOINT = new Endpoint.Simple<>(
			...
			}, Endpoint.Simple.emptyMap(), true, IndexDeleteResponse.DESERIALIZER);
}
