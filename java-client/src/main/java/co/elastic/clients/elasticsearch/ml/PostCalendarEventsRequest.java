...
public final class PostCalendarEventsRequest extends RequestBase implements ToJsonp {
	...
	/**
	 * Json parser for PostCalendarEventsRequest
	 */
	public static final JsonpValueParser<PostCalendarEventsRequest> JSONP_PARSER = JsonpObjectBuilderParser
			.createForObject(Builder::new, PostCalendarEventsRequest::setupPostCalendarEventsRequestParser);

	protected static void setupPostCalendarEventsRequestParser(
			DelegatingJsonpValueParser<PostCalendarEventsRequest.Builder> op) {

		op.add(Builder::events, JsonpValueParser.arrayParser(CalendarEvent.JSONP_PARSER), "events");
	...
	public static final Endpoint<PostCalendarEventsRequest, PostCalendarEventsResponse, ElasticsearchError> ENDPOINT = new Endpoint.Simple<>(
			...
			}, Endpoint.Simple.emptyMap(), true, PostCalendarEventsResponse.JSONP_PARSER);
}
