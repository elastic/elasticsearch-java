 ...
 */
public class EnrichApiClient extends ApiClient<EnrichApiClient> {

	public EnrichApiClient(Transport transport) {
		super(transport, null);
	}

	public EnrichApiClient(Transport transport, RequestOptions options) {
	...
	/**
	 * Creates a new {@link #EnrichApiClient} with specific request options.
	 */
	@Override
	public EnrichApiClient withRequestOptions(@Nullable RequestOptions options) {
		return new EnrichApiClient(transport, options);
	}
	 ...
	 */
	public EnrichApiClient withRequestOptions(Function<RequestOptions.Builder, RequestOptions.Builder> fn) {
