...
public final class UppercaseProcessor extends ProcessorBase {
	...
	public static class Builder extends ProcessorBase.AbstractBuilder<Builder>
		...
		/**
		 * Builds a {@link UppercaseProcessor}.
		 *
	...
	/**
	 * Json parser for UppercaseProcessor
	 */
	public static final JsonpValueParser<UppercaseProcessor> JSONP_PARSER = JsonpObjectBuilderParser
			.createForObject(Builder::new, UppercaseProcessor::setupUppercaseProcessorParser);

	protected static void setupUppercaseProcessorParser(DelegatingJsonpValueParser<UppercaseProcessor.Builder> op) {
