...
public class DataframeEvaluationContainer extends TaggedUnion<DataframeEvaluationContainer.Tag, Object>
	...
	public static final JsonpValueParser<DataframeEvaluationContainer> JSONP_PARSER = JsonpValueParser
			.lazy(DataframeEvaluationContainer::buildJsonpParser);

	private static JsonpValueParser<DataframeEvaluationContainer> buildJsonpParser() {
		JsonpObjectParser<Builder> op = new JsonpObjectParser<>(Builder::new);

		op.add(Builder::classification, DataframeEvaluationClassification.JSONP_PARSER, "classification");
		op.add(Builder::outlierDetection, DataframeEvaluationOutlierDetection.JSONP_PARSER, "outlier_detection");
		op.add(Builder::regression, DataframeEvaluationRegression.JSONP_PARSER, "regression");
