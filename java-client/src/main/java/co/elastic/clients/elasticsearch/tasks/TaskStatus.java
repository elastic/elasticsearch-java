...
// typedef: tasks._types.TaskStatus

/**
 *
 * @see <a href="../doc-files/api-spec.html#tasks._types.TaskStatus">API
 *      specification</a>
 */
@JsonpDeserializable
public class TaskStatus implements JsonpSerializable {
	...
	public static TaskStatus of(Function<Builder, ObjectBuilder<TaskStatus>> fn) {
	...
	/**
	 * Builder for {@link TaskStatus}.
	 */

	public static class Builder extends WithJsonObjectBuilderBase<Builder> implements ObjectBuilder<TaskStatus> {
	 ...
	 */
	public static final JsonpDeserializer<TaskStatus> _DESERIALIZER = ObjectBuilderDeserializer.lazy(Builder::new,
			TaskStatus::setupTaskStatusDeserializer);

	protected static void setupTaskStatusDeserializer(ObjectDeserializer<TaskStatus.Builder> op) {
