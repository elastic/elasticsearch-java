...
public final class Suggest<T> implements ToJsonp {
	...
	protected Suggest(Builder<T> builder) {
	...
	/**
	 * Builder for {@link Suggest}.
	 */
	public static class Builder<T> implements ObjectBuilder<Suggest<T>> {
		...
		/**
		 * Builds a {@link Suggest}.
		 *
		 * @throws NullPointerException
		 *             if some of the required fields are null.
		 */
		public Suggest<T> build() {

			return new Suggest<T>(this);
		}
	}
