...
/**
 *
 * @see <a href="../../doc-files/api-spec.html#nodes.info.NodeInfoSettings">API
 *      specification</a>
 */
@JsonpDeserializable
public class NodeInfoSettings implements JsonpSerializable {
	...
	public static class Builder extends WithJsonObjectBuilderBase<Builder> implements ObjectBuilder<NodeInfoSettings> {
