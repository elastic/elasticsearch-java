...
public final class ValidationLoss implements ToJsonp {
	...
	/**
	 * Json parser for ValidationLoss
	 */
	public static final JsonpValueParser<ValidationLoss> JSONP_PARSER = JsonpObjectBuilderParser
			.createForObject(Builder::new, ValidationLoss::setupValidationLossParser);

	protected static void setupValidationLossParser(DelegatingJsonpValueParser<ValidationLoss.Builder> op) {

		op.add(Builder::foldValues, JsonpValueParser.arrayParser(JsonpValueParser.stringParser()), "fold_values");
		op.add(Builder::lossType, JsonpValueParser.stringParser(), "loss_type");
