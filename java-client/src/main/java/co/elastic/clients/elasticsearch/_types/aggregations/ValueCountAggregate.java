 ...
 */
@JsonpDeserializable
public class ValueCountAggregate extends SingleMetricAggregateBase implements AggregateVariant, ApiKeyAggregateVariant {
	// ---------------------------------------------------------------------------------------------
	...
	public ApiKeyAggregate.Kind _apiKeyAggregateKind() {
		return ApiKeyAggregate.Kind.ValueCount;
	}
