...
public class TransformsResponse implements JsonpSerializable {
	...
	public static TransformsResponse of(Consumer<Builder> fn) {
	...
	public static class Builder extends ObjectBuilderBase implements ObjectBuilder<TransformsResponse> {
		...
		public final Builder valueBody(
				Function<ListBuilder<TransformsRecord, TransformsRecord.Builder>, ObjectBuilder<List<TransformsRecord>>> fn) {
			return valueBody(fn.apply(new ListBuilder<>(TransformsRecord.Builder::new)).build());
		}
