...
public final class CloseJobResponse implements ToJsonp {
	...
	/**
	 * Json parser for CloseJobResponse
	 */
	public static final JsonpValueParser<CloseJobResponse> JSONP_PARSER = JsonpObjectBuilderParser
			.createForObject(Builder::new, CloseJobResponse::setupCloseJobResponseParser);

	protected static void setupCloseJobResponseParser(DelegatingJsonpValueParser<CloseJobResponse.Builder> op) {
