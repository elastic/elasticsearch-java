...
public class ElasticsearchRollupClient extends ApiClient<ElasticsearchTransport, ElasticsearchRollupClient> {
	 ...
	 *
	 * @see <a href=
	 *      "https://www.elastic.co/docs/api/doc/elasticsearch/v9/operation-rollup-delete-job">Documentation
	 *      on elastic.co</a>
	 */
	 ...
	 * 
	 * @see <a href=
	 *      "https://www.elastic.co/docs/api/doc/elasticsearch/v9/operation-rollup-get-jobs">Documentation
	 *      on elastic.co</a>
	 */
	 ...
	 *
	 * @see <a href=
	 *      "https://www.elastic.co/docs/api/doc/elasticsearch/v9/operation-rollup-get-rollup-caps">Documentation
	 *      on elastic.co</a>
	 */
	 ...
	 *
	 * @see <a href=
	 *      "https://www.elastic.co/docs/api/doc/elasticsearch/v9/operation-rollup-get-rollup-index-caps">Documentation
	 *      on elastic.co</a>
	 */
	 ...
	 * 
	 * @see <a href=
	 *      "https://www.elastic.co/docs/api/doc/elasticsearch/v9/operation-rollup-put-job">Documentation
	 *      on elastic.co</a>
	 */
	 ...
	 * 
	 * @see <a href=
	 *      "https://www.elastic.co/docs/api/doc/elasticsearch/v9/operation-rollup-rollup-search">Documentation
	 *      on elastic.co</a>
	 */
	 ...
	 * 
	 * @see <a href=
	 *      "https://www.elastic.co/docs/api/doc/elasticsearch/v9/operation-rollup-start-job">Documentation
	 *      on elastic.co</a>
	 */
	 ...
	 * 
	 * @see <a href=
	 *      "https://www.elastic.co/docs/api/doc/elasticsearch/v9/operation-rollup-stop-job">Documentation
	 *      on elastic.co</a>
	 */
