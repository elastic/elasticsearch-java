...
public class HelpResponse implements JsonpSerializable {
	...
	public static HelpResponse of(Consumer<Builder> fn) {
	...
	public static class Builder extends ObjectBuilderBase implements ObjectBuilder<HelpResponse> {
		...
		public final Builder valueBody(
				Function<ListBuilder<HelpRecord, HelpRecord.Builder>, ObjectBuilder<List<HelpRecord>>> fn) {
			return valueBody(fn.apply(new ListBuilder<>(HelpRecord.Builder::new)).build());
		}
