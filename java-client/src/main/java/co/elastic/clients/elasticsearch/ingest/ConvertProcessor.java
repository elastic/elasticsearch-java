...
public final class ConvertProcessor extends ProcessorBase {
	...
	/**
	 * Json parser for ConvertProcessor
	 */
	public static final JsonpValueParser<ConvertProcessor> JSONP_PARSER = JsonpObjectBuilderParser
			.createForObject(Builder::new, ConvertProcessor::setupConvertProcessorParser);

	protected static void setupConvertProcessorParser(DelegatingJsonpValueParser<ConvertProcessor.Builder> op) {
