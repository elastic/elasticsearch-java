 ...
 */
public class GraphClient extends ApiClient<GraphClient> {

	public GraphClient(Transport transport) {
		super(transport, null);
	}

	public GraphClient(Transport transport, RequestOptions options) {
	...
	/**
	 * Creates a new {@link #GraphClient} with specific request options.
	 */
	@Override
	public GraphClient withRequestOptions(@Nullable RequestOptions options) {
		return new GraphClient(transport, options);
	}

	/**
	 * Creates a new {@link #GraphClient} with specific request options, inheriting
	 * existing options.
	 *
	 * @param fn
	 ...
	 */
	public GraphClient withRequestOptions(Function<RequestOptions.Builder, RequestOptions.Builder> fn) {
