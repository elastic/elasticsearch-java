...
public final class PostJobDataRequest extends RequestBase implements ToJsonp {
	...
	/**
	 * Json parser for PostJobDataRequest
	 */
	public static final JsonpValueParser<PostJobDataRequest> JSONP_PARSER = JsonpObjectBuilderParser
			.createForObject(Builder::new, PostJobDataRequest::setupPostJobDataRequestParser);

	protected static void setupPostJobDataRequestParser(DelegatingJsonpValueParser<PostJobDataRequest.Builder> op) {

		op.add(Builder::data, JsonpValueParser.arrayParser(JsonpValueParser.jsonValueParser()), "data");
	...
	public static final Endpoint<PostJobDataRequest, PostJobDataResponse, ElasticsearchError> ENDPOINT = new Endpoint.Simple<>(
			...
			}, Endpoint.Simple.emptyMap(), true, PostJobDataResponse.JSONP_PARSER);
}
