...
/**
 *
 * @see <a href="../doc-files/api-spec.html#ml._types.DetectorRead">API
 *      specification</a>
 */
@JsonpDeserializable
public class DetectorRead implements JsonpSerializable {
	...
	/**
	 * Builder for {@link DetectorRead}.
	 */

	public static class Builder extends ObjectBuilderBase implements ObjectBuilder<DetectorRead> {
		@Nullable
	...
	/**
	 * Json deserializer for {@link DetectorRead}
	 */
	public static final JsonpDeserializer<DetectorRead> _DESERIALIZER = ObjectBuilderDeserializer.lazy(Builder::new,
			DetectorRead::setupDetectorReadDeserializer);
