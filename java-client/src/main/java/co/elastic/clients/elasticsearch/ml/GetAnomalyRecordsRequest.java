...
// typedef: ml.get_anomaly_records.Request
public final class GetAnomalyRecordsRequest extends RequestBase implements ToJsonp {
	...
	protected GetAnomalyRecordsRequest(Builder builder) {
	...
	/**
	 * Builder for {@link GetAnomalyRecordsRequest}.
	 */
	public static class Builder implements ObjectBuilder<GetAnomalyRecordsRequest> {
		...
		/**
		 * Builds a {@link GetAnomalyRecordsRequest}.
		 *
		 * @throws NullPointerException
		 *             if some of the required fields are null.
		 */
		public GetAnomalyRecordsRequest build() {

			return new GetAnomalyRecordsRequest(this);
		}
	}
	 ...
	 */
	public static final Endpoint<GetAnomalyRecordsRequest, GetAnomalyRecordsResponse, ElasticsearchError> ENDPOINT = new Endpoint.Simple<>(
			// Request method
			request -> {
				return "POST";
