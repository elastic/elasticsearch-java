...
public final class GetRollupIndexCapsRequest extends RequestBase {
	...
	protected GetRollupIndexCapsRequest(Builder builder) {
	 ...
	 */
	public static final Endpoint<GetRollupIndexCapsRequest, GetRollupIndexCapsResponse, ElasticsearchError> ENDPOINT = new Endpoint.Simple<>(
			// Request method
			request -> {
				return "GET";
			...
			}, Endpoint.Simple.emptyMap(), false, GetRollupIndexCapsResponse.DESERIALIZER);
}
