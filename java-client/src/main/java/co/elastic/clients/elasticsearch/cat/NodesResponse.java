...
public final class NodesResponse implements ToJsonp {
	...
	/**
	 * Json parser for NodesResponse
	 */
	public static final JsonpValueParser<NodesResponse> JSONP_PARSER = JsonpObjectBuilderParser
			.createForObject(Builder::new, NodesResponse::setupNodesResponseParser);

	protected static void setupNodesResponseParser(DelegatingJsonpValueParser<NodesResponse.Builder> op) {

		op.add(Builder::value, JsonpValueParser.arrayParser(NodesRecord.JSONP_PARSER), "value");
