...
public class SegmentsResponse implements JsonpSerializable {
	...
	public static class Builder extends ObjectBuilderBase implements ObjectBuilder<SegmentsResponse> {
		...
		public final Builder valueBody(
				Function<ListBuilder<SegmentsRecord, SegmentsRecord.Builder>, ObjectBuilder<List<SegmentsRecord>>> fn) {
			return valueBody(fn.apply(new ListBuilder<>(SegmentsRecord.Builder::new)).build());
		}
