...
public final class GetFiltersResponse implements ToJsonp {
	...
	/**
	 * Json parser for GetFiltersResponse
	 */
	public static final JsonpValueParser<GetFiltersResponse> JSONP_PARSER = JsonpObjectBuilderParser
			.createForObject(Builder::new, GetFiltersResponse::setupGetFiltersResponseParser);

	protected static void setupGetFiltersResponseParser(DelegatingJsonpValueParser<GetFiltersResponse.Builder> op) {

		op.add(Builder::count, JsonpValueParser.numberParser(), "count");
		op.add(Builder::filters, JsonpValueParser.arrayParser(Filter.JSONP_PARSER), "filters");
