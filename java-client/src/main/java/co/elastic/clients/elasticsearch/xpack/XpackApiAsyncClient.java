 ...
 */
public class XpackApiAsyncClient extends ApiClient<XpackApiAsyncClient> {

	public XpackApiAsyncClient(Transport transport) {
		super(transport, null);
	}

	public XpackApiAsyncClient(Transport transport, RequestOptions options) {
	...
	/**
	 * Creates a new {@link #XpackApiAsyncClient} with specific request options.
	 */
	@Override
	public XpackApiAsyncClient withRequestOptions(@Nullable RequestOptions options) {
		return new XpackApiAsyncClient(transport, options);
	}
	 ...
	 */
	public XpackApiAsyncClient withRequestOptions(Function<RequestOptions.Builder, RequestOptions.Builder> fn) {
