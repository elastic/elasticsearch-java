...
public final class ClusterStateMetadataIndexGraveyard implements ToJsonp {
	...
	/**
	 * Json parser for ClusterStateMetadataIndexGraveyard
	 */
	public static final JsonpValueParser<ClusterStateMetadataIndexGraveyard> JSONP_PARSER = JsonpObjectBuilderParser
			.createForObject(Builder::new,
					ClusterStateMetadataIndexGraveyard::setupClusterStateMetadataIndexGraveyardParser);

	protected static void setupClusterStateMetadataIndexGraveyardParser(
			DelegatingJsonpValueParser<ClusterStateMetadataIndexGraveyard.Builder> op) {

		op.add(Builder::tombstones, JsonpValueParser.arrayParser(Tombstone.JSONP_PARSER), "tombstones");
