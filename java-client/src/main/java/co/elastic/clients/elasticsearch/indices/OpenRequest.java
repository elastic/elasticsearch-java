...
public final class OpenRequest extends RequestBase {
	 ...
	 */
	public static class Builder implements ObjectBuilder<OpenRequest> {
	 ...
	 */
	public static final Endpoint<OpenRequest, OpenResponse, ElasticsearchError> ENDPOINT = new Endpoint.Simple<>(
			// Request method
			request -> {
				return "POST";
			...
			}, Endpoint.Simple.emptyMap(), false, OpenResponse._DESERIALIZER);
}
