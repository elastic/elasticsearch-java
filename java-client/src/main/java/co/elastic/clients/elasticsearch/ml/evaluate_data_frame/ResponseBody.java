...
// typedef: ml.evaluate_data_frame.ResponseBody

/**
 *
 * @see <a href=
 *      "../../doc-files/api-spec.html#ml.evaluate_data_frame.ResponseBody">API
 *      specification</a>
 */
@JsonpDeserializable
public class ResponseBody implements TaggedUnion<ResponseBody.Kind, Object>, JsonpSerializable {

	/**
	 * {@link ResponseBody} variant kinds.
	 * 
	 * @see <a href=
	 *      "../../doc-files/api-spec.html#ml.evaluate_data_frame.ResponseBody">API
	 *      specification</a>
	...
	public static class Builder extends WithJsonObjectBuilderBase<Builder> implements ObjectBuilder<ResponseBody> {
		private Kind _kind;
		...
		public ObjectBuilder<ResponseBody> classification(
		...
		public ObjectBuilder<ResponseBody> outlierDetection(
		...
		public ObjectBuilder<ResponseBody> regression(
	...
	public static final JsonpDeserializer<ResponseBody> _DESERIALIZER = ObjectBuilderDeserializer.lazy(Builder::new,
			ResponseBody::setupResponseBodyDeserializer, Builder::build);
}
