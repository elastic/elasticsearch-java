 ...
 */
public class EqlApiAsyncClient extends ApiClient<EqlApiAsyncClient> {

	public EqlApiAsyncClient(Transport transport) {
		super(transport, null);
	}

	public EqlApiAsyncClient(Transport transport, RequestOptions options) {
	...
	/**
	 * Creates a new {@link #EqlApiAsyncClient} with specific request options.
	 */
	@Override
	public EqlApiAsyncClient withRequestOptions(@Nullable RequestOptions options) {
		return new EqlApiAsyncClient(transport, options);
	}
	 ...
	 */
	public EqlApiAsyncClient withRequestOptions(Function<RequestOptions.Builder, RequestOptions.Builder> fn) {
