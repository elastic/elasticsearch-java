 ...
 *
 * @see <a href=
 *      "../../doc-files/api-spec.html#_global.reindex_rethrottle.ParentReindexStatus">API
 *      specification</a>
 */
@JsonpDeserializable
public class ParentReindexStatus implements JsonpSerializable {
	...
	public static ParentReindexStatus of(Function<Builder, ObjectBuilder<ParentReindexStatus>> fn) {
	...
	public static class Builder extends WithJsonObjectBuilderBase<Builder>
			implements
				ObjectBuilder<ParentReindexStatus> {
		@Nullable
	 ...
	 */
	public static final JsonpDeserializer<ParentReindexStatus> _DESERIALIZER = ObjectBuilderDeserializer
			.lazy(Builder::new, ParentReindexStatus::setupParentReindexStatusDeserializer);

	protected static void setupParentReindexStatusDeserializer(ObjectDeserializer<ParentReindexStatus.Builder> op) {
