...
public class IntervalsContainer extends TaggedUnion<IntervalsContainer.Tag, Object> implements ToJsonp {
	...
	private IntervalsContainer(Builder builder) {
		super(builder.$tag, builder.$variant);

	}

	/**
	 * Is this {@link IntervalsContainer} of a {@code all_of} kind?
	 */
	...
	/**
	 * Is this {@link IntervalsContainer} of a {@code any_of} kind?
	 */
	...
	/**
	 * Is this {@link IntervalsContainer} of a {@code fuzzy} kind?
	 */
	...
	/**
	 * Is this {@link IntervalsContainer} of a {@code match} kind?
	 */
	...
	/**
	 * Is this {@link IntervalsContainer} of a {@code prefix} kind?
	 */
	...
	/**
	 * Is this {@link IntervalsContainer} of a {@code wildcard} kind?
	 */
	...
	public static class Builder {
		...
		public ObjectBuilder<IntervalsContainer> allOf(IntervalsAllOf v) {
			this.$variant = v;
			this.$tag = Tag.allOf;
			return new ObjectBuilder.Constant<>(this.build());
		}

		public ObjectBuilder<IntervalsContainer> allOf(
				Function<IntervalsAllOf.Builder, ObjectBuilder<IntervalsAllOf>> f) {
			return this.allOf(f.apply(new IntervalsAllOf.Builder()).build());
		}

		public ObjectBuilder<IntervalsContainer> anyOf(IntervalsAnyOf v) {
			this.$variant = v;
			this.$tag = Tag.anyOf;
			return new ObjectBuilder.Constant<>(this.build());
		}

		public ObjectBuilder<IntervalsContainer> anyOf(
				Function<IntervalsAnyOf.Builder, ObjectBuilder<IntervalsAnyOf>> f) {
			return this.anyOf(f.apply(new IntervalsAnyOf.Builder()).build());
		}

		public ObjectBuilder<IntervalsContainer> fuzzy(IntervalsFuzzy v) {
			this.$variant = v;
			this.$tag = Tag.fuzzy;
			return new ObjectBuilder.Constant<>(this.build());
		}

		public ObjectBuilder<IntervalsContainer> fuzzy(
				Function<IntervalsFuzzy.Builder, ObjectBuilder<IntervalsFuzzy>> f) {
			return this.fuzzy(f.apply(new IntervalsFuzzy.Builder()).build());
		}

		public ObjectBuilder<IntervalsContainer> match(IntervalsMatch v) {
			this.$variant = v;
			this.$tag = Tag.match;
			return new ObjectBuilder.Constant<>(this.build());
		}

		public ObjectBuilder<IntervalsContainer> match(
				Function<IntervalsMatch.Builder, ObjectBuilder<IntervalsMatch>> f) {
			return this.match(f.apply(new IntervalsMatch.Builder()).build());
		}

		public ObjectBuilder<IntervalsContainer> prefix(IntervalsPrefix v) {
			this.$variant = v;
			this.$tag = Tag.prefix;
			return new ObjectBuilder.Constant<>(this.build());
		}

		public ObjectBuilder<IntervalsContainer> prefix(
		...
		public ObjectBuilder<IntervalsContainer> wildcard(IntervalsWildcard v) {
			this.$variant = v;
			this.$tag = Tag.wildcard;
			return new ObjectBuilder.Constant<>(this.build());
		}

		public ObjectBuilder<IntervalsContainer> wildcard(
		...
		protected IntervalsContainer build() {
			return new IntervalsContainer(this);
		}
	...
	public static final JsonpDeserializer<IntervalsContainer> DESERIALIZER = JsonpDeserializer
			.lazy(IntervalsContainer::buildDeserializer);

	private static JsonpDeserializer<IntervalsContainer> buildDeserializer() {
