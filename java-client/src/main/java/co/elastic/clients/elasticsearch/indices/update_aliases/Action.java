...
public class Action implements TaggedUnion<Object>, JsonpSerializable {
	...
	public <T extends ActionVariant> Action(ObjectBuilder<T> builder) {
		this(builder.build());
	}
	...
	public static final JsonpDeserializer<Action> _DESERIALIZER = JsonpDeserializer.lazy(Builder::new,
