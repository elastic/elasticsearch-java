...
public final class GetAnomalyRecordsResponse implements ToJsonp {
	...
	/**
	 * Json deserializer for GetAnomalyRecordsResponse
	 */
	public static final JsonpDeserializer<GetAnomalyRecordsResponse> DESERIALIZER = ObjectBuilderDeserializer
			.createForObject(Builder::new, GetAnomalyRecordsResponse::setupGetAnomalyRecordsResponseDeserializer);

	protected static void setupGetAnomalyRecordsResponseDeserializer(
			DelegatingDeserializer<GetAnomalyRecordsResponse.Builder> op) {
