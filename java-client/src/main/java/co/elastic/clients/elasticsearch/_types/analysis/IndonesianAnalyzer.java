 ...
 *
 * @see <a href=
 *      "../../doc-files/api-spec.html#_types.analysis.IndonesianAnalyzer">API
 *      specification</a>
 */
@JsonpDeserializable
public class IndonesianAnalyzer implements AnalyzerVariant, JsonpSerializable {
	...
	public static class Builder extends WithJsonObjectBuilderBase<Builder>
			implements
				ObjectBuilder<IndonesianAnalyzer> {
		@Nullable
		...
		private Builder(IndonesianAnalyzer instance) {
	 ...
	 */
	public static final JsonpDeserializer<IndonesianAnalyzer> _DESERIALIZER = ObjectBuilderDeserializer
			.lazy(Builder::new, IndonesianAnalyzer::setupIndonesianAnalyzerDeserializer);

	protected static void setupIndonesianAnalyzerDeserializer(ObjectDeserializer<IndonesianAnalyzer.Builder> op) {
