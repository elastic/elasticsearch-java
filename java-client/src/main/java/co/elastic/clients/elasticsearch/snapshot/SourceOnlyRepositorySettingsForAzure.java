...
// typedef: snapshot._types.SourceOnlyRepositorySettingsForAzure

/**
 *
 * @see <a href=
 *      "../doc-files/api-spec.html#snapshot._types.SourceOnlyRepositorySettingsForAzure">API
 *      specification</a>
 */
@JsonpDeserializable
public class SourceOnlyRepositorySettingsForAzure implements SourceOnlyRepositorySettingsVariant, JsonpSerializable {
	@Nullable
	...
	private SourceOnlyRepositorySettingsForAzure(Builder builder) {
	...
	public static SourceOnlyRepositorySettingsForAzure of(
			Function<Builder, ObjectBuilder<SourceOnlyRepositorySettingsForAzure>> fn) {
	...
	public SourceOnlyRepositorySettings.Kind _sourceOnlyRepositorySettingsKind() {
		return SourceOnlyRepositorySettings.Kind.Azure;
	}
	...
	protected void serializeInternal(JsonGenerator generator, JsonpMapper mapper) {
		...
		generator.write("delegate_type", "azure");
	...
	/**
	 * Builder for {@link SourceOnlyRepositorySettingsForAzure}.
	 */

	public static class Builder extends WithJsonObjectBuilderBase<Builder>
			implements
				ObjectBuilder<SourceOnlyRepositorySettingsForAzure> {
		@Nullable
		...
		private Builder(SourceOnlyRepositorySettingsForAzure instance) {
		...
		/**
		 * Builds a {@link SourceOnlyRepositorySettingsForAzure}.
		 *
		 * @throws NullPointerException
		 *             if some of the required fields are null.
		 */
		public SourceOnlyRepositorySettingsForAzure build() {
			_checkSingleUse();

			return new SourceOnlyRepositorySettingsForAzure(this);
		}
	}
	...
	/**
	 * Json deserializer for {@link SourceOnlyRepositorySettingsForAzure}
	 */
	public static final JsonpDeserializer<SourceOnlyRepositorySettingsForAzure> _DESERIALIZER = ObjectBuilderDeserializer
			.lazy(Builder::new,
					SourceOnlyRepositorySettingsForAzure::setupSourceOnlyRepositorySettingsForAzureDeserializer);

	protected static void setupSourceOnlyRepositorySettingsForAzureDeserializer(
			ObjectDeserializer<SourceOnlyRepositorySettingsForAzure.Builder> op) {
