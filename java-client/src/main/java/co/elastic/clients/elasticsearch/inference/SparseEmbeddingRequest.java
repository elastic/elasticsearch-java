 ...
 */
@JsonpDeserializable
public class SparseEmbeddingRequest extends RequestBase implements JsonpSerializable {
	...
	/**
	 * Builder for {@link SparseEmbeddingRequest}.
	 */

	public static class Builder extends RequestBase.AbstractBuilder<Builder>
			implements
				ObjectBuilder<SparseEmbeddingRequest> {
		...
		/**
		 * Builds a {@link SparseEmbeddingRequest}.
		 *
	...
	/**
	 * Json deserializer for {@link SparseEmbeddingRequest}
	 */
	public static final JsonpDeserializer<SparseEmbeddingRequest> _DESERIALIZER = ObjectBuilderDeserializer
			.lazy(Builder::new, SparseEmbeddingRequest::setupSparseEmbeddingRequestDeserializer);

	protected static void setupSparseEmbeddingRequestDeserializer(
			ObjectDeserializer<SparseEmbeddingRequest.Builder> op) {
	...
	/**
	 * Endpoint "{@code inference.sparse_embedding}".
	 */
	public static final Endpoint<SparseEmbeddingRequest, SparseEmbeddingResponse, ErrorResponse> _ENDPOINT = new SimpleEndpoint<>(
			"es/inference.sparse_embedding",
