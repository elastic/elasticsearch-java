 ...
 *
 * @see <a href=
 *      "../../doc-files/api-spec.html#_types.analysis.DanishAnalyzer">API
 *      specification</a>
 */
@JsonpDeserializable
public class DanishAnalyzer implements AnalyzerVariant, JsonpSerializable {
	...
	public static class Builder extends WithJsonObjectBuilderBase<Builder> implements ObjectBuilder<DanishAnalyzer> {
		@Nullable
		...
		private Builder(DanishAnalyzer instance) {
	 ...
	 */
	public static final JsonpDeserializer<DanishAnalyzer> _DESERIALIZER = ObjectBuilderDeserializer.lazy(Builder::new,
			DanishAnalyzer::setupDanishAnalyzerDeserializer);

	protected static void setupDanishAnalyzerDeserializer(ObjectDeserializer<DanishAnalyzer.Builder> op) {
