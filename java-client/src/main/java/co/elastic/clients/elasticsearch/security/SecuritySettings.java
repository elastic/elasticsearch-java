...
// typedef: security._types.SecuritySettings

/**
 *
 * @see <a href=
 *      "../doc-files/api-spec.html#security._types.SecuritySettings">API
 *      specification</a>
 */
@JsonpDeserializable
public class SecuritySettings implements JsonpSerializable {
	@Nullable
	...
	public static SecuritySettings of(Function<Builder, ObjectBuilder<SecuritySettings>> fn) {
	...
	/**
	 * Builder for {@link SecuritySettings}.
	 */

	public static class Builder extends WithJsonObjectBuilderBase<Builder> implements ObjectBuilder<SecuritySettings> {
		@Nullable
		...
		/**
		 * Builds a {@link SecuritySettings}.
		 *
	...
	/**
	 * Json deserializer for {@link SecuritySettings}
	 */
	public static final JsonpDeserializer<SecuritySettings> _DESERIALIZER = ObjectBuilderDeserializer.lazy(Builder::new,
			SecuritySettings::setupSecuritySettingsDeserializer);
