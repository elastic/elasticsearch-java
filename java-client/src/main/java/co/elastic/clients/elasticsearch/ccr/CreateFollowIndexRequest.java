...
// typedef: ccr.create_follow_index.Request
public final class CreateFollowIndexRequest extends RequestBase implements ToJsonp {
	...
	protected CreateFollowIndexRequest(Builder builder) {
	...
	/**
	 * Builder for {@link CreateFollowIndexRequest}.
	 */
	public static class Builder implements ObjectBuilder<CreateFollowIndexRequest> {
		...
		/**
		 * Builds a {@link CreateFollowIndexRequest}.
		 *
		 * @throws NullPointerException
		 *             if some of the required fields are null.
		 */
		public CreateFollowIndexRequest build() {

			return new CreateFollowIndexRequest(this);
		}
	}
	 ...
	 */
	public static final Endpoint<CreateFollowIndexRequest, CreateFollowIndexResponse, ElasticsearchError> ENDPOINT = new Endpoint.Simple<>(
			// Request method
			request -> {
				return "PUT";
