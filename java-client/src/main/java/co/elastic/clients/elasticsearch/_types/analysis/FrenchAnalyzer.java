 ...
 *
 * @see <a href=
 *      "../../doc-files/api-spec.html#_types.analysis.FrenchAnalyzer">API
 *      specification</a>
 */
@JsonpDeserializable
public class FrenchAnalyzer implements AnalyzerVariant, JsonpSerializable {
	...
	public static class Builder extends WithJsonObjectBuilderBase<Builder> implements ObjectBuilder<FrenchAnalyzer> {
		@Nullable
		...
		private Builder(FrenchAnalyzer instance) {
	 ...
	 */
	public static final JsonpDeserializer<FrenchAnalyzer> _DESERIALIZER = ObjectBuilderDeserializer.lazy(Builder::new,
			FrenchAnalyzer::setupFrenchAnalyzerDeserializer);

	protected static void setupFrenchAnalyzerDeserializer(ObjectDeserializer<FrenchAnalyzer.Builder> op) {
