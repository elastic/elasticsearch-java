 ...
 * dedicated class. Use {@link CategorizationAnalyzer}'s builder for these.
 * 
 */
public class CategorizationAnalyzerBuilders {
	...
	/**
	 * Creates a builder for the {@link CategorizationAnalyzerDefinition definition}
	 * {@code CategorizationAnalyzer} variant.
	 */
