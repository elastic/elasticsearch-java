 ...
 */
public class EqlApiClient extends ApiClient<EqlApiClient> {

	public EqlApiClient(Transport transport) {
		super(transport, null);
	}

	public EqlApiClient(Transport transport, RequestOptions options) {
	...
	/**
	 * Creates a new {@link #EqlApiClient} with specific request options.
	 */
	@Override
	public EqlApiClient withRequestOptions(@Nullable RequestOptions options) {
		return new EqlApiClient(transport, options);
	}

	/**
	 * Creates a new {@link #EqlApiClient} with specific request options, inheriting
	 * existing options.
	 *
	 * @param fn
	 ...
	 */
	public EqlApiClient withRequestOptions(Function<RequestOptions.Builder, RequestOptions.Builder> fn) {
