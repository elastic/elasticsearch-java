 ...
 */
public class LogstashAsyncClient extends ApiClient<LogstashAsyncClient> {

	public LogstashAsyncClient(Transport transport) {
		super(transport, null);
	}

	public LogstashAsyncClient(Transport transport, RequestOptions options) {
	...
	/**
	 * Creates a new {@link #LogstashAsyncClient} with specific request options.
	 */
	@Override
	public LogstashAsyncClient withRequestOptions(@Nullable RequestOptions options) {
		return new LogstashAsyncClient(transport, options);
	}
	 ...
	 */
	public LogstashAsyncClient withRequestOptions(Function<RequestOptions.Builder, RequestOptions.Builder> fn) {
