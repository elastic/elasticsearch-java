...
// typedef: _types.aggregations.AbstractChangePoint

/**
 *
 * @see <a href=
 *      "../../doc-files/api-spec.html#_types.aggregations.AbstractChangePoint">API
 *      specification</a>
 */

public abstract class AbstractChangePoint implements JsonpSerializable {
	...
	// ---------------------------------------------------------------------------------------------
	protected static <BuilderT extends AbstractBuilder<BuilderT>> void setupAbstractChangePointDeserializer(
