...
@JsonpDeserializable
public enum ClusterStatus implements JsonEnum {
	/**
	...
	ClusterStatus(String jsonValue) {
	...
	public static final JsonEnum.Deserializer<ClusterStatus> _DESERIALIZER = new JsonEnum.Deserializer<>(
