...
// typedef: text_structure.find_field_structure.Response

/**
 *
 * @see <a href=
 *      "../doc-files/api-spec.html#text_structure.find_field_structure.Response">API
 *      specification</a>
 */
@JsonpDeserializable
public class FindFieldStructureResponse implements JsonpSerializable {
	...
	/**
	 * Builder for {@link FindFieldStructureResponse}.
	 */

	public static class Builder extends WithJsonObjectBuilderBase<Builder>
			implements
				ObjectBuilder<FindFieldStructureResponse> {
		...
		/**
		 * Builds a {@link FindFieldStructureResponse}.
		 *
	...
	/**
	 * Json deserializer for {@link FindFieldStructureResponse}
	 */
	public static final JsonpDeserializer<FindFieldStructureResponse> _DESERIALIZER = ObjectBuilderDeserializer
			.lazy(Builder::new, FindFieldStructureResponse::setupFindFieldStructureResponseDeserializer);

	protected static void setupFindFieldStructureResponseDeserializer(
			ObjectDeserializer<FindFieldStructureResponse.Builder> op) {
