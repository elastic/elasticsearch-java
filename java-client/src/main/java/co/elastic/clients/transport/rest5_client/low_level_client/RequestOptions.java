...
import org.elasticsearch.client.consumer.HttpAsyncResponseConsumerFactory;
...
public final class RequestOptions {
    ...
    public Builder toBuilder() {
        return new Builder(headers, parameters, httpAsyncResponseConsumerFactory, warningsHandler,
            requestConfig);
    }
    ...
    public void updateToken(String token) {
        headers.stream()
            .filter(h -> "Bearer ".equalsIgnoreCase(h.getName()))
            .findAny().ifPresent(headers::remove);
        headers.add(new ReqHeader("Authorization", "Bearer " +token));
    }
     ...
     * {@link org.elasticsearch.client.RestClientBuilder#setStrictDeprecationMode}.
     * <p>
    ...
    @Override
    public int hashCode() {
        return Objects.hash(headers, warningsHandler, httpAsyncResponseConsumerFactory);
    }
    ...
    public static class Builder {
        ...
        public Builder addParameter(String key, String value) {
            ...
            this.parameters.merge(key, value, (existingValue, newValue) -> String.join(",", existingValue,
                newValue));
            return this;
        }
    ...
    static final class ReqHeader extends BasicHeader {
        ...
        public boolean equals(Object other) {
            ...
            if (other instanceof ReqHeader) {
                ...
                return Objects.equals(getName(), otherHeader.getName()) && Objects.equals(getValue(),
                    otherHeader.getValue());
            }
            return false;
        }
