...
public interface WithUriParameter {
     ...
     * @return {@code true} if the property was found, {@code false} if the property is unknown
     * @throws RuntimeException if the value cannot be parsed to a valid property value
     */
