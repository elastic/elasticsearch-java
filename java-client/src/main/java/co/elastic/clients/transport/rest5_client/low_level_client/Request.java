...
public final class Request {
    ...
    private org.elasticsearch.client.RequestOptions options = org.elasticsearch.client.RequestOptions.DEFAULT;
    ...
    public void setJsonEntity(String body) {
        setEntity(body == null ? null : new StringEntity(body, ContentType.APPLICATION_JSON));
    }
     ...
     */
    public void setOptions(org.elasticsearch.client.RequestOptions options) {
     ...
     * manipulated without changing Elasticsearch's behavior.
     */
    public void setOptions(org.elasticsearch.client.RequestOptions.Builder options) {
        Objects.requireNonNull(options, "options cannot be null");
