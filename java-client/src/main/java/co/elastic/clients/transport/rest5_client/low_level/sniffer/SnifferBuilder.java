...
public final class SnifferBuilder {
    ...
    /**
     * Creates a new builder instance by providing the {@link Rest5Client} that will be used to communicate with elasticsearch
     */
    SnifferBuilder(Rest5Client restClient) {
