...
ORG_GRADLE_PROJECT_sonatypeUsername=$(vault kv get --field="username" $vault_path/maven_central)
...
ossrhUsername=${ORG_GRADLE_PROJECT_sonatypeUsername}
ossrhPassword=${ORG_GRADLE_PROJECT_sonatypePassword}
EOF
