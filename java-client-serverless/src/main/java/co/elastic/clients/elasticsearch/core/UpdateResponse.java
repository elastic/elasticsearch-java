 ...
 */
@JsonpDeserializable
public class UpdateResponse<TDocument> extends UpdateWriteResponseBase<TDocument> {
	// ---------------------------------------------------------------------------------------------
	...
	public static class Builder<TDocument>
			extends
				UpdateWriteResponseBase.AbstractBuilder<TDocument, Builder<TDocument>>
			implements
	...
	protected static <TDocument> void setupUpdateResponseDeserializer(
			...
			JsonpDeserializer<TDocument> tDocumentDeserializer) {
		UpdateWriteResponseBase.setupUpdateWriteResponseBaseDeserializer(op, tDocumentDeserializer);
