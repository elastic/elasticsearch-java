 ...
 *
 * @see <a href=
 *      "../../doc-files/api-spec.html#_types.query_dsl.IntervalsPrefix">API
 *      specification</a>
 */
@JsonpDeserializable
public class IntervalsPrefix implements IntervalsQueryVariant, IntervalsVariant, JsonpSerializable {
	...
	public static class Builder extends WithJsonObjectBuilderBase<Builder> implements ObjectBuilder<IntervalsPrefix> {
		@Nullable
