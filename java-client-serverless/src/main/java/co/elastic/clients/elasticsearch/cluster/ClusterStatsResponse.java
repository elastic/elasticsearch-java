...
/**
 *
 * @see <a href="../doc-files/api-spec.html#cluster.stats.Response">API
 *      specification</a>
 */
@JsonpDeserializable
public class ClusterStatsResponse extends StatsResponseBase {
	...
	public static class Builder extends StatsResponseBase.AbstractBuilder<Builder>
			implements
	...
	protected static void setupClusterStatsResponseDeserializer(ObjectDeserializer<ClusterStatsResponse.Builder> op) {
		StatsResponseBase.setupStatsResponseBaseDeserializer(op);
