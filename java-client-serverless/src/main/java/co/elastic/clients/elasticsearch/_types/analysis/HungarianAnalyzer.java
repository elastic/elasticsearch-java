 ...
 *
 * @see <a href=
 *      "../../doc-files/api-spec.html#_types.analysis.HungarianAnalyzer">API
 *      specification</a>
 */
@JsonpDeserializable
public class HungarianAnalyzer implements AnalyzerVariant, JsonpSerializable {
	...
	public static class Builder extends WithJsonObjectBuilderBase<Builder> implements ObjectBuilder<HungarianAnalyzer> {
		@Nullable
	 ...
	 */
	public static final JsonpDeserializer<HungarianAnalyzer> _DESERIALIZER = ObjectBuilderDeserializer
			.lazy(Builder::new, HungarianAnalyzer::setupHungarianAnalyzerDeserializer);

	protected static void setupHungarianAnalyzerDeserializer(ObjectDeserializer<HungarianAnalyzer.Builder> op) {
