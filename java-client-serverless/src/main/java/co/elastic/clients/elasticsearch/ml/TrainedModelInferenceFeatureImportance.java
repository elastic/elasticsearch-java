 ...
 *
 * @see <a href=
 *      "../doc-files/api-spec.html#ml._types.TrainedModelInferenceFeatureImportance">API
 *      specification</a>
 */
@JsonpDeserializable
public class TrainedModelInferenceFeatureImportance implements JsonpSerializable {
	...
	public static TrainedModelInferenceFeatureImportance of(
			Function<Builder, ObjectBuilder<TrainedModelInferenceFeatureImportance>> fn) {
	...
	/**
	 * Builder for {@link TrainedModelInferenceFeatureImportance}.
	 */

	public static class Builder extends WithJsonObjectBuilderBase<Builder>
			implements
				ObjectBuilder<TrainedModelInferenceFeatureImportance> {
		 ...
		 */
		public final Builder classes(TrainedModelInferenceClassImportance value,
				TrainedModelInferenceClassImportance... values) {
		...
		public final Builder classes(
				Function<TrainedModelInferenceClassImportance.Builder, ObjectBuilder<TrainedModelInferenceClassImportance>> fn) {
			return classes(fn.apply(new TrainedModelInferenceClassImportance.Builder()).build());
		}
		...
		/**
		 * Builds a {@link TrainedModelInferenceFeatureImportance}.
		 *
	...
	/**
	 * Json deserializer for {@link TrainedModelInferenceFeatureImportance}
	 */
	public static final JsonpDeserializer<TrainedModelInferenceFeatureImportance> _DESERIALIZER = ObjectBuilderDeserializer
			.lazy(Builder::new,
					TrainedModelInferenceFeatureImportance::setupTrainedModelInferenceFeatureImportanceDeserializer);

	protected static void setupTrainedModelInferenceFeatureImportanceDeserializer(
			ObjectDeserializer<TrainedModelInferenceFeatureImportance.Builder> op) {
