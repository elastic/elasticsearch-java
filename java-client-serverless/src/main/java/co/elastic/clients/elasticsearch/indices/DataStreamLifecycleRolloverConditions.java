 ...
 *
 * @see <a href=
 *      "../doc-files/api-spec.html#indices._types.DataStreamLifecycleRolloverConditions">API
 *      specification</a>
 */
@JsonpDeserializable
public class DataStreamLifecycleRolloverConditions implements JsonpSerializable {
	...
	public static DataStreamLifecycleRolloverConditions of(
			Function<Builder, ObjectBuilder<DataStreamLifecycleRolloverConditions>> fn) {
	...
	/**
	 * Builder for {@link DataStreamLifecycleRolloverConditions}.
	 */

	public static class Builder extends WithJsonObjectBuilderBase<Builder>
			implements
				ObjectBuilder<DataStreamLifecycleRolloverConditions> {
		@Nullable
		private Time minAge;
		...
		/**
		 * Builds a {@link DataStreamLifecycleRolloverConditions}.
		 *
	...
	/**
	 * Json deserializer for {@link DataStreamLifecycleRolloverConditions}
	 */
	public static final JsonpDeserializer<DataStreamLifecycleRolloverConditions> _DESERIALIZER = ObjectBuilderDeserializer
			.lazy(Builder::new,
					DataStreamLifecycleRolloverConditions::setupDataStreamLifecycleRolloverConditionsDeserializer);

	protected static void setupDataStreamLifecycleRolloverConditionsDeserializer(
			ObjectDeserializer<DataStreamLifecycleRolloverConditions.Builder> op) {
