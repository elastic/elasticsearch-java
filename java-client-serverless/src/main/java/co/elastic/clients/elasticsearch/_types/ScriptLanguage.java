...
/**
 *
 * @see <a href="../doc-files/api-spec.html#_types.ScriptLanguage">API
 *      specification</a>
 */
@JsonpDeserializable
public enum ScriptLanguage implements JsonEnum {
	...
	ScriptLanguage(String jsonValue) {
	...
	public static final JsonEnum.Deserializer<ScriptLanguage> _DESERIALIZER = new JsonEnum.Deserializer<>(
