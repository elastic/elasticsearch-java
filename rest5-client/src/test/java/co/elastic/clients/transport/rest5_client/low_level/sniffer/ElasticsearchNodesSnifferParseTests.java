...
public class ElasticsearchNodesSnifferParseTests extends RestClientTestCase {
    ...
    private void checkFile(String file, Node... expected) throws IOException {
        ...
        try {
            ...
            List<Node> nodes = ElasticsearchNodesSniffer.readHosts(entity, ElasticsearchNodesSniffer.Scheme.HTTP, Json.createParserFactory(Map.of()));
            /*
    ...
    private Node node(int port, String name, String version, Set<String> roles) {
        ...
        return new Node(host, boundHosts, name, version, new Node.Roles(new TreeSet<>(roles)), attributes);
    }
